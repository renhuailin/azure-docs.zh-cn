...
借助 Azure Pipelines 中的内置 Azure IoT Edge 任务，可以轻松地在 Azure IoT Edge 应用程序中采用 DevOps。 本文演示了如何使用 Azure Pipelines 的持续集成和持续部署功能，通过 YAML 快速高效地生成和测试应用程序并将其部署到 Azure IoT Edge。 或者，可以[使用经典编辑器](how-to-continuous-integration-continuous-deployment-classic.md)。
...
6. 在“查看管道 YAML”页上，可以单击默认名称 `azure-pipelines.yml` 来重命名管道的配置文件。
...
* [适用于 IoT Edge 的 Azure DevOps 入门版](how-to-devops-starter.md)中的 IoT Edge DevOps 最佳做法示例
