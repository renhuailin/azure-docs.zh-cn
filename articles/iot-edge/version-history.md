...
| 发行说明和资产 | 类型 | Date | 亮点 |
| ------------------------ | ---- | ---- | ---------- |
| [1.2-rc4](https://github.com/Azure/azure-iotedge/releases/tag/1.2.0-rc1) | 预览 | 2021 年 3 月 | 引入了新的 IoT Edge 包，其中包含新的安装和配置步骤。 有关详细信息，请参阅[从 1.0 或 1.1 更新到 1.2](how-to-update-iot-edge.md#special-case-update-from-10-or-11-to-12)。
