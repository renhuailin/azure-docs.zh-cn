...
以下各节使用[流量管理器 PowerShell cmdlet](/powershell/module/az.trafficmanager/#traffic_manager)。
...
使用 **[New-AzResourceGroup](/powershell/module/az.resources/new-azresourcegroup)** cmdlet 创建资源组：
...
1. 使用 **[New-AzTrafficManagerProfile](/powershell/module/az.trafficmanager/new-aztrafficmanagerprofile)** cmdlet 创建配置文件
...
2. 使用 **[Add-AzTrafficManagerEndpointConfig](/powershell/module/az.trafficmanager/add-aztrafficmanagerendpointconfig)** cmdlet 添加美国东部终结点
...
3. 使用 **[Set-AzTrafficManagerProfile](/powershell/module/az.trafficmanager/set-aztrafficmanagerprofile)** cmdlet 设置美国东部终结点
...
2. 使用 **[Add-AzTrafficManagerEndpointConfig](/powershell/module/az.TrafficManager/Add-azTrafficManagerEndpointConfig)** cmdlet 添加美国西部终结点
...
3. 使用 **[Set-AzTrafficManagerProfile](/powershell/module/az.TrafficManager/Set-azTrafficManagerProfile)** cmdlet 设置美国西部终结点
...
1. 使用 **[New-AzTrafficManagerProfile](/powershell/module/az.TrafficManager/New-azTrafficManagerProfile)** cmdlet 创建父配置文件
...
2. 使用 **[Add-AzTrafficManagerEndpointConfig](/powershell/module/az.TrafficManager/Add-azTrafficManagerEndpointConfig)** 和 **NestedEndpoints** 类型将美国东部子配置文件添加到父级
    ...
    |-Type|NestedEndpoints|有关详细信息，请参阅 [Add-AzTrafficManagerEndpointConfig](/powershell/module/az.trafficmanager/Add-azTrafficManagerEndpointConfig)。 |
...
3. 使用 **[Add-AzTrafficManagerEndpointConfig](/powershell/module/az.TrafficManager/Add-azTrafficManagerEndpointConfig)** cmdlet 和 **NestedEndpoints** 类型将美国西部子配置文件添加到父级
...
4. 使用 **[Set-AzTrafficManagerProfile](/powershell/module/az.TrafficManager/Set-azTrafficManagerProfile)** cmdlet 设置终结点
...
在前面各节中，创建了三个 PowerShell 变量：`$eastprofile`、`$westprofile`、`$parentprofile`。 流量管理器配置要结束时会使用这些变量。 如果选择不创建变量或忘记创建变量，或者 PowerShell 窗口超时，则可以使用 PowerShell cmdlet **[Get-AzTrafficManagerProfile](/powershell/module/az.TrafficManager/Get-azTrafficManagerProfile)** 再次获取配置文件，并将其分配给变量。
