...
> [!NOTE]
> 如果要提取英语文本，请考虑使用新的[读取操作](../concept-recognizing-text.md)。 [Python 快速入门](./python-hand-text.md)可用。 
...
> [计算机视觉 API Python 教程](https://github.com/Microsoft/Cognitive-Vision-Python)
