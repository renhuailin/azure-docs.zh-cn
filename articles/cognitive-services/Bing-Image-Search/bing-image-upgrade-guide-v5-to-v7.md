...
- 终结点的版本号已从 v5 更改为 v7。 例如，https： \/ /api.cognitive.microsoft.com/bing/ \* \* 7.0 * */images/search。
...
- 现在，以下查询参数仅对 `/images/details` 终结点有效。  
    ...
    -   [模块](/rest/api/cognitiveservices-bingsearch/bing-images-api-v7-reference)  
