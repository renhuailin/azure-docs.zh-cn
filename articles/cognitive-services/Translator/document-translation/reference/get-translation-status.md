...
description: 获取翻译状态方法可返回文档翻译请求的状态。
...
ms.locfileid: "107864875"
---
# <a name="get-translation-status"></a>获取翻译状态

获取翻译状态方法可返回文档翻译请求的状态。 该状态包括总体请求状态以及请求中正在进行翻译的文档的状态。
...
## <a name="get-translation-status-response"></a>获取翻译状态响应

### <a name="successful-get-translation-status-response"></a>成功获取翻译状态响应
