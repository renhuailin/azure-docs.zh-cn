...
* 有关类和函数的详细信息，请参阅说话人识别[参考文档](/rest/api/speakerrecognition/)。

* 请参阅 GitHub 上的 [C#](https://github.com/Azure-Samples/cognitive-services-speech-sdk/tree/master/quickstart/csharp/dotnet/speaker-recognition) 和 [C++](https://github.com/Azure-Samples/cognitive-services-speech-sdk/tree/master/quickstart/cpp/windows/speaker-recognition) 示例。