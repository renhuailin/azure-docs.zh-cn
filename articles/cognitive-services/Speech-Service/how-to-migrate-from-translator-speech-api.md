...
| 全球终结点                                   | :heavy_check_mark:                                              | :heavy_minus_sign:                 | 语音服务不提供全球终结点。 全球终结点可以自动将流量定向到最近的区域终结点，从而减少应用程序中的延迟。                                                    |
...
| 语言 API                                     | :heavy_check_mark:                                              | :heavy_minus_sign:                 | 语音服务支持[语音翻译语言参考]()一文中所述的相同语言范围。 |
...
如果你或组织有处于开发或生产阶段且使用语音翻译 API 的应用程序，应将应用程序更新为使用语音服务。 有关可用 SDK、代码示例和教程，请参阅[语音服务文档](index.yml)。 迁移时请考虑以下事项：
