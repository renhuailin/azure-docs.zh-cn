...
答：通过 HTTP 请求可以使用超过 45 种语言的 80 多种标准语音模型。 首先，获取[订阅密钥](./overview.md#try-the-speech-service-for-free)。 若要对预部署的语音模型进行 REST 调用，请参阅 [REST API](./overview.md#reference-docs)。
