...
|服务名称|服务说明|
|:-----------|:------------------|
|[异常检测器](./anomaly-detector/index.yml "异常检测器") |使用异常检测器可以监视并检测时序数据中的异常。 请参阅[异常探测器快速入门](./anomaly-detector/quickstarts/client-libraries.md)，以开始使用该服务。|
