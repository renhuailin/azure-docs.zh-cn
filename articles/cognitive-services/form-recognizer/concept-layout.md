...
:::image type="content" source="./media/layout-select-pages.png" alt-text="布局选定页面输出":::
...
### <a name="tables-with-headers"></a>包含表头的表
...
![表示例](./media/layout-table-header-demo.gif)
