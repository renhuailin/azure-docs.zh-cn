...
## <a name="use-the-api-asynchronously-with-the-batch-analyze-operation"></a>使用批量分析操作异步使用 API

# <a name="version-31-preview"></a>[版本 3.1 预览](#tab/version-3-1)

[!INCLUDE [Analyze operation pricing](../analyze-operation-pricing-caution.md)]

创建一个名为 `analyze_batch_actions_example()` 的新函数，该函数采用客户端作为参数，然后调用 `begin_analyze_batch_actions()` 函数。 结果将是一个长期操作，将轮询该操作以获得结果。
...
你还可以使用批量分析操作检测 PII 和执行关键短语提取。 请参阅 GitHub 上的[批量分析示例](https://github.com/Azure/azure-sdk-for-python/tree/master/sdk/textanalytics/azure-ai-textanalytics/samples/sample_analyze_batch_actions.py)。
