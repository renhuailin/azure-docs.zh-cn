...
- 请参阅[尝试在 Web 上使用内容审查器](quick-start.md)以使用[内容审查器审阅工具](https://contentmoderator.cognitive.microsoft.com/)进行注册。
...
| **视频审查 API**<br /><br />扫描视频并检测潜在的成人和不雅内容。 <br /><br />使用此信息发布、拒绝或查看审查后工作流中的内容。<br /><br /> | [视频审查 API 概述](video-moderation-api.md "视频审查 API 参考")   |
