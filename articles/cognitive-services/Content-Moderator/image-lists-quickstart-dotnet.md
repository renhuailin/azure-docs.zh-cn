...
必须有 API 订阅密钥，才能通过 REST API 或 SDK 使用内容审查器服务。 在 [Azure 门户](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesContentModerator)中订阅内容审查器服务以获取它。
