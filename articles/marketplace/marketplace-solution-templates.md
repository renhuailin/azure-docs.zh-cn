...
|与 Azure 兼容的虚拟硬盘 (VHD)  |   必须基于 Windows 或 Linux 构建 VM。 有关详细信息，请参阅： <ul> <li>[创建 Azure 应用程序产品/服务](./create-new-azure-apps-offer.md)（针对 Windows VHD）。</li><li>[Azure 支持的 Linux 发行版](../virtual-machines/linux/endorsed-distros.md)（针对 Linux VHD）。</li></ul> |
