---
title: 在 Microsoft AppSource（Azure 市场）上配置 Dynamics 365 for Business Central 产品/服务列表详细信息
description: 在 Microsoft AppSource（Azure 市场）上配置 Dynamics 365 for Business Central 产品/服务列表详细信息。
...
ms.locfileid: "110616630"
---
# <a name="configure-dynamics-365-for-business-central-offer-listing-details"></a>配置 Dynamics 365 for Business Central 产品/服务列表详细信息
...
:::image type="content" source="media/dynamics-365/example-365-business-central.png" alt-text="说明了此产品/服务在 Microsoft AppSource 中的显示方式。":::
...
添加至少三张（最多五张）显示产品/服务工作方式的屏幕截图。 所有屏幕截图都必须为 1280 x 720 像素，并且为 PNG 格式。 为每张屏幕截图添加标题。
...
- [设置产品/服务可用性](dynamics-365-business-central-availability.md)
