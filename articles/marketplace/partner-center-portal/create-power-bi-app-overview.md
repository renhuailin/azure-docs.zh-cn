...
description: 本文介绍将 Power BI 应用发布到 Microsoft AppSource 的高级步骤。 本文还介绍了 Power BI 应用必须满足哪些技术和业务要求，才能发布到市场。
...
本文介绍如何将 Power BI 应用发布到 Microsoft [AppSource](https://appsource.microsoft.com/)。 Power BI 应用包含可自定义的内容，包括数据集、报表和仪表板。 然后，可以将应用与使用 AppSource 的其他 Power BI 平台一起使用，执行开发者允许的调整和自定义，并将其连接到你自己的数据。
...
在 Power BI 中创建并测试应用后，请保存应用安装 web 地址，因为你将需要它来[创建 Power BI 应用产品/服务](create-power-bi-app-offer.md)。
