---
title: 准备 IoT Edge 模块技术资产 - Azure 市场
description: 了解物联网 (IoT) Edge 模块技术资产在你将其发布到 Azure 市场之前必须满足的技术和配置要求。
...
:::image type="content" source="media/iot-edge-module-technical-assets-offer-listing.png" alt-text="这是合作伙伴中心内“产品/服务列表”部分的图像":::
