...
- 产品 ID 和发布者 ID 的组合长度必须在 40 个字符以内。
...
输入一个描述性名称，我们将仅在合作伙伴中心内使用该名称指代此产品/服务。 此名称（预先填充了在创建产品/服务时输入的内容）不会在市场中使用，并且与向客户显示的产品/服务名称不同。 如果以后要更新产品/服务名称，请转到[产品/服务列表](#offer-listing)页。
