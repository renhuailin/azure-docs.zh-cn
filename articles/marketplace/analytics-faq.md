...
- 你的套餐可能正在发布，但还没有上线。 客户只能获取已上线的产品/服务。 如果要检查套餐的状态，请参阅[分析仪表板](https://partner.microsoft.com/dashboard/commercial-marketplace/analytics/summary)中的“摘要”页面。 有关详细信息，请参阅[商业市场分析中的摘要仪表板](summary-dashboard.md)。
