...
* 以下路由器配置示例适用于 Azure 公共与 Microsoft 对等互连。 不要为 Azure 专用对等互连配置 NAT。 有关更多详细信息，请查看 [ExpressRoute 对等互连](expressroute-circuit-peerings.md)和 [ExpressRoute NAT 要求](expressroute-nat.md)。
