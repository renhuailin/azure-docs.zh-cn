...
是的。 如果采用 Azure 虚拟 WAN，则可以按照[这些步骤](../virtual-wan/vpn-over-expressroute.md)加密端到端连接。 如果有常规 Azure VNET，则可以按照[这些步骤](../vpn-gateway/site-to-site-vpn-private-peering.md)操作，在 Azure VPN 网关和本地 VPN 网关之间建立 IPsec 隧道。
