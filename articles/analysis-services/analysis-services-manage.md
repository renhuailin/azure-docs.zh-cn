...
![此屏幕截图显示了 Azure 门户，可以在其中创建和删除服务器、监视服务器资源、更改大小，并可管理有权访问服务器的人员。](./media/analysis-services-manage/aas-manage-portal.png)
...
[下载 SQL Server Management Studio](/sql/ssms/download-sql-server-management-studio-ssms)。
