---
title: 在 Application Insights 中使用队列 | Microsoft Docs
...
ms.locfileid: "121751421"
---
# <a name="application-insights-cohorts"></a>Application Insights 队列

队列是具有某种共性的用户、会话、事件或操作集。 在 Application Insights 中，队列由 Analytics 查询定义。 如果你要反复分析特定的用户或事件集，队列可让你更灵活地准确表达所需的集。
...
:::image type="content" source="./media/usage-cohorts/cohort-2.png" alt-text="屏幕截图：“显示下拉列表”，其中显示队列。":::
...
1. 打开“队列”工具，依次选择“模板库”选项卡、“空白用户队列”。
   ...
   :::image type="content" source="./media/usage-cohorts/cohort.png" alt-text="屏幕截图：队列模板库。" lightbox="./media/usage-cohorts/cohort.png":::
   ...
   * 一个查询部分，可在其中使用分析查询定义队列。
     ...
     > [!NOTE]
     > 如果看不到查询，请尝试调整部分的大小，以增加其高度并显示查询。 
