...
可通过筛选器选择 [Java Web 应用发送到 Application Insights](java-2x-get-started.md) 的遥测。 可使用现成的筛选器，也可编写自己的自定义筛选器。
...
[检查整套内置处理器](https://github.com/microsoft/ApplicationInsights-Java/tree/main/agent/agent-tooling/src/main/java/com/microsoft/applicationinsights/agent/internal)。
...
筛选日志跟踪（使用 [TrackTrace()](./api-custom-events-metrics.md#tracktrace) 或[记录框架收集器](java-2x-trace-logs.md)记录）。
