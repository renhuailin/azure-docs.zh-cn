...
* 是否已按照[配置 Java 代理](java-2x-agent.md)配置 Java 代理？
...
若要启用 JVM 代理日志记录，请更新 [AI-Agent.xml 文件](java-2x-agent.md)：
...
你可能需要[在服务器的防火墙中打开某些传出端口](./ip-addresses.md#outgoing-ports)，以允许 SDK 向门户发送数据。
