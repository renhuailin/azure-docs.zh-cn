...
|Microsoft.AVS/privateClouds | 否 | 否 | [Azure VMware 解决方案](../platform/metrics-supported.md#microsoftavsprivateclouds) |
...
|Microsoft.ClassicStorage/storageAccounts/fileServices | 是 | 否 | [存储帐户（经典）- 文件](../platform/metrics-supported.md#microsoftclassicstoragestorageaccountsfileservices) |
...
|Microsoft.DataShare/accounts | 是 | 否 | [数据共享](../platform/metrics-supported.md#microsoftdatashareaccounts) |
...
|Microsoft.DigitalTwins/digitalTwinsInstances | 是 | 否 | [数字孪生](../platform/metrics-supported.md#microsoftdigitaltwinsdigitaltwinsinstances) |
...
|Microsoft.NetApp/netAppAccounts/capacityPools | 是 | 是 | [Azure NetApp 容量池](../platform/metrics-supported.md#microsoftnetappnetappaccountscapacitypools) |
...
|Microsoft.Network/natGateways| 否 | 否 | [NAT 网关](../platform/metrics-supported.md#microsoftnetworknatgateways) |
|Microsoft.Network/privateEndpoints| 否 | 否 | [终结点](../platform/metrics-supported.md#microsoftnetworkprivateendpoints) |
|Microsoft.Network/privateLinkServices| 否 | 否 | [专用链接服务](../platform/metrics-supported.md#microsoftnetworkprivatelinkservices) |
...
|Microsoft.StorageCache/caches | 是 | 否 | [HPC 缓存](../platform/metrics-supported.md#microsoftstoragecachecaches) |
...
|Microsoft.Web/serverfarms | 是 | 否 | [应用服务计划](../platform/metrics-supported.md#microsoftwebserverfarms)|
