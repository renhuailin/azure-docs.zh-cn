...
Azure 门户中为使用经典警报规则并想要自行触发迁移的客户提供了一个迁移工具。 本文介绍如何使用此迁移工具。
...
1. 选择一个或多个订阅，然后选择“预览迁移”。
    ...
    ![屏幕截图显示“迁移警报规则”页，其中包含用于下载此订阅的迁移详细信息的链接。你可以指定用于接收迁移通知的电子邮件。](media/alerts-using-migration-tool/migration-preview.png "预览迁移")
...
1. 选择“开始迁移”。 阅读确认对话框中显示的信息，并确认已准备好开始迁移。
    ...
    ![屏幕截图显示有关迁移的确认提示，其中包含重要信息和链接，可以让你在继续操作之前了解更多信息。](media/alerts-using-migration-tool/migration-confirm.png "确认开始迁移")
...
在订阅级别拥有“监视参与者”角色的用户可以触发迁移。 [详细了解迁移过程的 Azure 基于角色的访问控制](alerts-understand-migration.md#who-can-trigger-the-migration)。
