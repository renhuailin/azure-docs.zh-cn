...
ms.locfileid: "113687526"
---
# <a name="resource-manager-template-samples-for-log-alert-rules-in-azure-monitor"></a>用于 Azure Monitor 日志警报规则的资源管理器模板示例
本文包含用于在 Azure Monitor 中创建和配置日志查询警报的 [Azure 资源管理器模板](../../azure-resource-manager/templates/syntax.md)示例。 每个示例都包含模板文件和参数文件，其中包含要提供给模板的示例值。

[!INCLUDE [azure-monitor-samples](../../../includes/azure-monitor-resource-manager-samples.md)]

## <a name="number-of-results-template-up-to-version-2018-04-16"></a>结果模板数（最高版本为 2018-04-16）
以下示例会创建一个[结果数警报规则](../alerts/alerts-unified-log.md#count-of-the-results-table-rows)。

### <a name="notes"></a>说明

- 此示例包含一个 [Webhook 有效负载](../alerts/alerts-log-webhook.md)。 如果警报规则不应触发 Webhook，则删除 customWebhookPayload 元素。
...
以下示例会创建一个[指标度量警报规则](../alerts/alerts-unified-log.md#calculation-of-measure-based-on-a-numeric-column-such-as-cpu-counter-value)。
...
## <a name="template-for-all-resource-types-from-version-2021-02-01-preview"></a>所有资源类型的模板（从版本 2021-02-01-preview 开始）
以下示例创建一条可针对任何资源的规则。
