...
1. [为客户端创建一个终结点以访问实例](https://docs.servicenow.com/bundle/rome-platform-administration/page/administer/security/task/t_CreateEndpointforExternalClients.html)。
