...
对于 Azure 资源，__SubscriptionId 的值是 [Azure 资源 ID URL](../../azure-resource-manager/templates/template-functions-resource.md) 的订阅部分。 此列仅限于 Azure 资源，包括 [Azure Arc](../../azure-arc/overview.md) 资源，或用于在引入过程中指明资源 ID 的自定义日志。
