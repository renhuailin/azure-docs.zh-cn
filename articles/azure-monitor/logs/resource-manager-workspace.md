...
本文包含用于在 Azure Monitor 中创建和配置 Log Analytics 工作区的 [Azure 资源管理器模板](../../azure-resource-manager/templates/syntax.md)示例。 每个示例都包含模板文件和参数文件，其中包含要提供给模板的示例值。
...
下面的示例将 [Windows 事件](../agents/data-sources-windows-events.md)的收集添加到现有工作区。
...
下面的示例将 [syslog 事件](../agents/data-sources-syslog.md)的收集添加到现有工作区。
...
下面的示例将 [Windows 性能计数器](../agents/data-sources-performance-counters.md)的收集添加到现有工作区。
...
下面的示例将 [Linux 性能计数器](../agents/data-sources-performance-counters.md)的收集添加到现有工作区。
...
下面的示例将[自定义日志](../agents/data-sources-custom-logs.md)的收集添加到现有工作区。
...
下面的示例将 [IIS 日志](../agents/data-sources-iis-logs.md)的收集添加到现有工作区。
...
* [了解有关 Log Analytics 工作区的详细信息](./quick-create-workspace.md)。
