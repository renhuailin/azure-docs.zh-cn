...
ms.locfileid: "111953149"
---
# <a name="resource-manager-template-samples-for-log-queries-in-azure-monitor"></a>用于 Azure Monitor 日志查询的资源管理器模板示例
本文包含用于在 Azure Monitor 中创建和配置日志查询的 [Azure 资源管理器模板](../../azure-resource-manager/templates/syntax.md)示例。 每个示例都包含模板文件和参数文件，其中包含要提供给模板的示例值。
...
* [详细了解日志查询](../logs/log-query-overview.md)。
* [详细了解函数](../logs/functions.md)。