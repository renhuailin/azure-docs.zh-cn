...
- 具有 Azure Monitor 代理的 Azure 虚拟机。 请参阅 [配置 Azure Monitor 代理的数据收集 (预览版) ](../agents/data-collection-rule-azure-monitor-agent.md)。
...
[![DCR 图](media/data-collection-rule-overview/data-collection-rule-components.png)](media/data-collection-rule-overview/data-collection-rule-components.png#lightbox)
...
- [使用 Azure 门户](../agents/data-collection-rule-azure-monitor-agent.md) 创建数据收集规则并将其与一个或多个虚拟机相关联。
