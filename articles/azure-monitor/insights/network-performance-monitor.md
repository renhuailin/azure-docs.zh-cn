...
使用[将 Windows 计算机连接到 Azure Monitor](../agents/agent-windows.md)、[将 Linux 计算机连接到 Azure Monitor（预览版）](../../virtual-machines/extensions/oms-linux.md)和[将 Operations Manager 连接到 Azure Monitor](../agents/om-agents.md) 中的基本过程安装代理。
