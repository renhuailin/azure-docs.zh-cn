...
1. 如果该服务器尚不受 System Center 2016 - Operations Manager 或 Operations Manager 2012 R2 的监视，请安装 [Microsoft Monitoring Agent (MMA)](../agents/agent-windows.md)。
...
* 参阅[日志查询](../logs/log-query-overview.md)，了解如何分析详细的 SQL 运行状况检查数据和建议。
