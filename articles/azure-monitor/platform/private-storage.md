...
使用 [Azure 门户](./diagnostics-extension-logs.md#collect-logs-from-azure-storage) 或通过调用 [存储见解 API](/rest/api/loganalytics/connectedsources/storage%20insights/createorupdate)将存储帐户作为存储数据源连接到 Log Analytics 工作区。
