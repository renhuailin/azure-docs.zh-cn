...
如果你计划使用 Azure 自动化混合 Runbook 辅助角色连接到自动化服务并向该服务注册以在你的环境中使用 runbook 或管理功能，则它必须能够访问为 [混合 Runbook 辅助角色配置网络](../../automation/automation-hybrid-runbook-worker.md#network-planning)中所述的端口号和 url。
