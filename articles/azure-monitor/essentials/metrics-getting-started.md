...
1. 单击“选择范围”按钮以打开资源范围选取器。 这将允许你选择要查看其指标的资源。 如果从资源的菜单中打开了指标资源管理器，则该资源应已填充完毕。 若要了解如何跨多个资源查看指标，请 [阅读此文](../platform/metrics-dynamic-scope.md)。
...
* [在指标资源管理器中查看多个资源](../platform/metrics-dynamic-scope.md)
