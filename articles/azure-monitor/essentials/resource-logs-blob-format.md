...
* 此更改会影响以下数据类型：
  ...
  * [由诊断设置导出的 Azure 资源指标](../essentials/diagnostic-settings.md)
...
![“Azure Monitor 诊断设置”边栏选项卡](media/resource-logs-blob-format/portal-diag-settings.png)

如果“诊断状态”设置为已启用，则该资源上具有活动诊断设置。 单击资源以查看是否有诊断设置将数据发送到存储帐户：

![已启用存储帐户](media/resource-logs-blob-format/portal-storage-enabled.png)
