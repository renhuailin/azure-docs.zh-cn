...
可以通过在本地运行脚本，在混合 Runbook 辅助角色上脱机使用故障排除。 可以在 GitHub 中找到 Python 脚本（ [UM_Linux_Troubleshooter_Offline py](https://github.com/Azure/updatemanagement/blob/main/UM_Linux_Troubleshooter_Offline.py)）。 以下示例显示了此脚本的输出示例：
