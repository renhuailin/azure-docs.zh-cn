...
> [!NOTE]
> **有关 Windows RS5 开发计算机上部署的已知问题：** RS5 Windows 计算机上的 Powershell cmdlet New-SmbGlobalMapping 存在一个尚未解决的 bug，会阻止装载 Azurefile 卷。 下面是在本地开发计算机上装载基于 AzureFile 的卷时遇到的示例错误。
```
