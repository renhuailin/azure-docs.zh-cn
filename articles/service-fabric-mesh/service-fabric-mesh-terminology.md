---
title: Azure Service Fabric 网格术语
description: 本文详细介绍了 Azure Service Fabric 网格所使用的术语，帮助更好地理解文档中使用的术语。
...
Azure Service Fabric 网格是一个完全托管的服务，由此开发者可部署微服务应用程序，而无需管理虚拟机、存储或网络。 本文详细介绍了 Azure Service Fabric 网格所使用的术语，帮助更好地理解文档中使用的术语。
