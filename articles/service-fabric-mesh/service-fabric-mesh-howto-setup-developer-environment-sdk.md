---
title: 为 Service Fabric Mesh 设置 Windows 开发环境
...
需有 Visual Studio 2017 才能部署 Service Fabric Mesh 应用程序。 [安装版本 15.6.0][download-visual-studio] 或更高版本，并启用以下工作负荷：
...
如果已安装 Docker，请确保具有最新版本。 当有新版本推出时，Docker 可能会提示用户，但请手动进行检查以确保有最新版本。
