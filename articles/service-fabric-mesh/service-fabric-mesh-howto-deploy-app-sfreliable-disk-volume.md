---
title: 采用 Service Fabric 网格的 Service Fabric 可靠磁盘卷
...
> 
> 该模板使用 Docker Hub 中的公共映像。 请注意，速率可能会受到限制。 有关更多详细信息，请参阅[通过 Docker Hub 进行身份验证](../container-registry/buffer-gate-public-content.md#authenticate-with-docker-hub)。
