---
title: 无法通过使用 Key Vault 证书来添加自定义域
...
- 无法更新 API 管理服务主机名。 对资源“https://vaultname.vault.azure.net/secrets/secretname/?api-version=7.0”的请求失败，出现的 StatusCode 为：已禁止，RequestId：。 异常消息：操作返回了无效的状态代码“已禁止”。
