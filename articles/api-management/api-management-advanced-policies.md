...
-   当 [Application Insights 集成](./api-management-howto-app-insights.md)已启用并且此策略中指定的 `severity` 等于或大于诊断设置中指定的 `verbosity` 时，此策略会在 Application Insights 中创建[跟踪](../azure-monitor/app/data-model-trace-telemetry.md)遥测。
