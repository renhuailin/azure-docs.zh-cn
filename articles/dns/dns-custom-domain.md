...
|Alias     | adatumfunction.azurewebsites.net        | 为其创建别名的 DNS 名称，在本示例中，为默认提供给函数应用的 adatumfunction.azurewebsites.net DNS 名称。        |
...
|TTL     | 1        | 1 表示 1 小时        |
|TTL 单位     | 小时        | 小时用作时间计量单位         |
|Alias     | webserver.azurewebsites.net        | 为其创建别名的 DNS 名称，在本示例中，为默认提供给 Web 应用的 webserver.azurewebsites.net DNS 名称。        |
...
|TTL     | 1        | 1 表示 1 小时        |
|TTL 单位     | 小时        | 小时用作时间计量单位         |
|Alias     | cdnverify.adatumcdnendpoint.azureedge.net        | 为其创建别名的 DNS 名称，在本示例中，为默认提供给存储帐户的 cdnverify.adatumcdnendpoint.azureedge.net DNS 名称。        |
