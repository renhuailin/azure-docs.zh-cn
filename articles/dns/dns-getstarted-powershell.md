...
:::image type="content" source="media/dns-getstarted-portal/environment-diagram.png" alt-text="使用 Azure PowerShell 的 DNS 部署环境示意图。" border="false":::
