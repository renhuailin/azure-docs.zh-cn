...
在本文中，你将了解如何使用 Azure 门户注册对等互连服务连接。
...
确保[连接服务提供商](location-partners.md)与 Microsoft 是合作伙伴。
...
1. 选择订阅以及与订阅关联的资源组。
   ...
   ![“注册对等互连”基本信息选项卡](./media/peering-service-portal/peering-servicebasics.png)
