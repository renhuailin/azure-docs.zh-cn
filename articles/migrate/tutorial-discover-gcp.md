...
本教程介绍如何使用 Azure Migrate 发现 Google Cloud Platform (GCP) 实例：服务器评估工具，使用轻型 Azure Migrate 设备。 在 GCP VM 实例上部署设备，以持续发现计算机和性能元数据。
...
3. 在“1: 生成 Azure Migrate 项目密钥”中，提供将为发现 GCP 虚拟服务器而设置的 Azure Migrate 设备的名称。 该名称应是字母数字，长度为 14 个或更少的字符。
4. 单击“生成密钥”，开始创建所需的 Azure 资源。 在创建资源期间，请不要关闭“发现计算机”页。
