...
1. 在“评估属性” > “目标属性”中 ：
    - 在“目标位置”中，选择要迁移到的 Azure 区域。
        - 大小和成本建议基于你指定的位置。 从默认值更改目标位置后，系统会提示指定 **保留实例** 和 **VM 系列**。
...
1. 在 " **选择或创建组** " > 选择 " **新建** "，然后指定组名称。 

    :::image type="content" source="./media/tutorial-assess-vmware-azure-vm/assess-group.png" alt-text="将 VM 添加到组":::
