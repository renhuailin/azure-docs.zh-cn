...
不是。 目前，Azure Migrate 和 Azure Site Recovery 均不支持迁移到超级磁盘。 在[此网站](../virtual-machines/disks-enable-ultra-ssd.md?tabs=azure-portal#deploy-an-ultra-disk)上查找部署超级磁盘的步骤。
