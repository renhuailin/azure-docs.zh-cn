---
title: 使用 Azure Migrate 评估要迁移到 Azure VM 的 Hyper-V VM
description: 了解如何使用 Azure Migrate 评估要迁移到 Azure VM 的 Hyper-V VM。
author: rashi-ms
ms.author: rajosh
ms.manager: abhemraj
ms.topic: tutorial
...
本文介绍如何使用“Azure Migrate: 发现和评估”工具来评估从您的 Hyper-V 环境中发现的要迁移到 Azure 的服务器。
...
- 在按照本教程来评估要迁移到 Azure VM 的服务器之前，请确保已发现要评估的服务器：
    - 若要使用 Azure Migrate 设备发现服务器，请[遵循本教程](tutorial-discover-hyper-v.md)。 
