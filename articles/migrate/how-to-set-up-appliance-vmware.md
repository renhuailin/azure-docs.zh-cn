...
1. 在开始发现之前，可以随时 **重新验证** 与 vCenter Server 之间的连接。
    ...
    :::image type="content" source="./media/tutorial-discover-vmware/appliance-manage-sources.png" alt-text="设备配置管理器上的面板，用于显示 vCenter Server 详细信息":::
