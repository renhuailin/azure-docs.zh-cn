...
ms.locfileid: "104674948"
---
# <a name="how-to-data-profile-data-sources-in-azure-data-catalog"></a>如何在 Azure 数据目录中对数据源进行数据分析
...
![“数据配置文件”选项卡](media/data-catalog-data-profile/data-catalog-view.png)
