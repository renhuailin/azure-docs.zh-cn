...
根据 [托管服务提供的认证要求](/legal/marketplace/certification-policies#700-managed-services)，你必须拥有 [银牌或金牌云平台资格认证级别](/partner-center/learn-about-competencies) ，或是 [Azure 专家 MSP](https://partner.microsoft.com/membership/azure-expert-msp) 才能发布托管服务产品/服务。 你还必须输入潜在客户目标，每次客户部署你的产品/服务时 [，它都会在 CRM 系统中创建一条记录](../../marketplace/plan-managed-service-offer.md#customer-leads) 。
...
有关如何创建产品/服务（包括需要提供的所有信息和资产）的详细说明，请参阅 [创建托管服务产品/服务](../../marketplace/create-managed-service-offer.md)。

若要了解常规发布过程，请查看 [商业 Marketplace 文档](../../marketplace/overview.md)。 还应查看[商业市场认证策略](/legal/marketplace/certification-policies)，特别是[托管服务](/legal/marketplace/certification-policies#700-managed-services)部分。
...
完成所有部分后，下一步就是将产品/服务发布到 Azure 市场。 选择“发布”按钮启动产品/服务上线过程。 可在 [此处](../../marketplace/review-publish-offer.md)找到有关此过程的详细信息。
...
- [链接你的合作伙伴 ID](partner-earned-credit.md) 以跟踪你对客户服务的影响。
