...
| **文件类型** | 字符串 | 文件类型的类型：<ul><li>扩展名</li><li>实例</li><li>NamedType</li></ul> |
| 
...
| EventMessage | string |  访问被拒绝 | 一般消息或说明，包括在记录中或从记录生成 | 事件 |
...
| EventUid | Guid (字符串)  | 516a64e3-8360-4f1e-a67c-d96b3d52df54 | Azure Sentinel 用于标记行的唯一标识符。 | 事件 |
