...
1. 在以下“配置”下，按照“说明”选项卡中的说明进行操作 ：
    ...
    1. “3. 验证连接”- 通过复制连接器页上的命令并在日志转发器上运行该命令来验证数据引入。 有关更详细的说明和介绍，请参阅 Azure Sentinel 文档中的“[验证 CEF 连接性](troubleshooting-cef-syslog.md#validate-cef-connectivity)”。
