...
对文件活动 ASIM 架构的支持还包括对以下内置分析规则和规范化身份验证分析程序的支持。 虽然下面提供了 Azure Sentinel GitHub 存储库的链接作为参考，但也可在 [Azure Sentinel Analytics 规则库](detect-threats-built-in.md)中找到这些规则。 使用链接的 GitHub 页复制所列规则的任何相关搜寻查询。
...
| **EventStartTime**      | 必需   | 日期/时间  |      如果源支持聚合并且记录表示多个事件，则此字段指定生成第一个事件的时间。 否则，此字段将别名化 [TimeGenerated](#timegenerated) 字段。 |
...
| **EventProductVersion** | 可选    | 字符串     | 生成事件的产品的版本。 <br><br>示例： `12.1`<br><br>注意：源记录中可能未提供此字段。 在这种情况下，此字段必须由分析器设置。           |
...
|SrcFileSHA1|可选 |SHA1 |源文件的 SHA-1 哈希。<br><br>例如：<br>`d55c5a4df19b46db8c54`<br>`c801c4665d3338acdab0` |
|SrcFileSHA256 | 可选|SHA256 |源文件的 SHA-256 哈希。 <br><br>例如：<br> `e81bb824c4a09a811af17deae22f22dd`<br>`2e1ec8cbb00b22629d2899f7c68da274`|
...
|TargetFileSHA1 |可选 |SHA1 |目标文件的 SHA-1 哈希。 <br><br>例如：<br> `d55c5a4df19b46db8c54`<br>`c801c4665d3338acdab0`|
|TargetFileSHA256 | 可选|SHA256 |目标文件的 SHA-256 哈希。 <br><br>例如：<br> `e81bb824c4a09a811af17deae22f22dd`<br>`2e1ec8cbb00b22629d2899f7c68da274`  |
