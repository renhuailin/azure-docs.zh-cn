...
ms.locfileid: "104586992"
---
# <a name="part-four-mount-a-file-share-from-a-domain-joined-vm"></a>第 4 部分：从加入域的 VM 装载文件共享

在开始本文之前，请确保已完成上一篇文章：[通过 SMB 配置目录和文件级别权限](storage-files-identity-ad-ds-configure-permissions.md)。
