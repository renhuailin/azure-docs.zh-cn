...
> [!Important]  
> 将 SMB Azure 文件共享限制为仅使用最安全的选项时，可能会导致某些客户端在不满足要求时无法连接。 例如，从 Windows Server 2022 和 Windows 11 开始，引入了 AES-256-GCM 作为 SMB 通道加密的一种选项。 这意味着不支持 AES-256-GCM 的旧客户端将无法连接。
