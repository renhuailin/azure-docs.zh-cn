...
1. 至少有一个受支持的 Windows Server 或 Windows Server 群集实例与 Azure 文件同步来同步。有关受支持的 Windows Server 版本和建议系统资源的详细信息，请参阅 [Windows 文件服务器注意事项](storage-sync-files-planning.md#windows-file-server-considerations)。
