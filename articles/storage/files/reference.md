...
下表列出了 Azure 文件存储 .NET API 的参考信息。
...
下表列出了 Azure 文件存储 Java API 的参考信息。
...
下表列出了 Azure 文件存储 Python API 的参考信息。
...
下表列出了 Azure 文件存储 JavaScript API 的参考信息。
...
下表列出了 Azure 文件存储 REST API 的参考信息。
