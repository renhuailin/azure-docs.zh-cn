...
- [有关 Azure 文件存储的 Microsoft Q&A 问题页](/answers/products/azure?product=storage)。
...
- 云存储故障
    - 暂时性存储服务可用性问题。 有关详细信息，请参阅 [Azure 存储的服务级别协议 (SLA)](https://azure.microsoft.com/support/legal/sla/storage/v1_5/)。
