...
> [!NOTE]
> 若要使用存储模拟器以编程方式访问次要副本，请使用适用于 .NET 的存储客户端库 3.2 版或更高版本。 请参阅[适用于 .NET 的 Microsoft Azure 存储客户端库](/previous-versions/azure/dn261237(v=azure.100))，获取详细信息。
>
>
