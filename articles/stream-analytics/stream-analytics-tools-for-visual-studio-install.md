...
可以卸载 Azure Data Lake 和流分析工具。 对于 Visual Studio 2019 或 Visual Studio 2017，请选择“工具” > “获取工具和功能”。 在“修改”中，取消选择“Azure Data Lake 和流分析工具”。 它显示在“数据存储和处理”工作负荷或“Azure 开发”工作负荷下。
