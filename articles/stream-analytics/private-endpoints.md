...
批准连接后，在流分析群集中运行的任何作业都可以通过专用终结点访问资源。 本文介绍如何在流分析群集中创建和删除专用终结点。 可以为 Azure SQL 数据库、Azure Synapse SQL 数据库、Azure Cosmos DB、Azure 存储、Azure Data Lake Storage Gen2、Azure 事件中心、Azure IoT 中心和 Azure 服务总线创建专用终结点。
