...
ms.locfileid: "104588114"
---
# <a name="azure-machine-learning-studio-classic-integration-in-stream-analytics"></a>流分析中的 Azure 机器学习工作室（经典）集成
...
Microsoft Azure 机器学习工作室（经典）提供一个协作型拖放式工具，可用于根据数据生成、测试和部署预测分析解决方案。 此工具称为“Azure 机器学习工作室（经典）”。 工作室（经典）用于与机器学习资源交互，能够轻松地生成、测试和反复调整设计。 这些资源及其定义如下：
