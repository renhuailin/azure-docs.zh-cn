...
description: 了解如何创建简单的 Node.js 控制台应用程序，该应用程序演示如何自动创建和管理 Azure CDN 的配置文件和终结点。
services: cdn
...
要查找有关适用于 JavaScript 的 Azure SDK 的其他文档，请查看[完整参考](/javascript/api/)。
