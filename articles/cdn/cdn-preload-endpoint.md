...
* [Azure CDN REST API 参考：预加载终结点上的内容](/rest/api/cdn/endpoints/load-content)
* [Azure CDN REST API 参考：清除终结点上的内容](/rest/api/cdn/endpoints/purge-content)
