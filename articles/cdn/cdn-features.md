...
| 支持的 TLS 版本 | TLS 1.2、TLS 1.0/1.1 - [可配置](/rest/api/cdn/custom-domains/enable-custom-https#usermanagedhttpsparameters) | TLS 1.2 | TLS 1.2 | TLS 1.2 |
||||
