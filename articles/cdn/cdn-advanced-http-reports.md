...
每个基于地图的报表都会对地理实体（即国家/地区）进行排名，并提供一张地图帮助直观显示请求内容的位置。 它能够根据在该区域中经历的需求量，通过对每个区域进行颜色编码来这样做。 较浅的阴影区域表示内容的需求较低，而较暗的区域表示内容有较高的需求量。
...
还有两个额外的根据地理位置提供统计信息的报告，这两个报告分别是热门城市和热门国家/地区报告。 这些报告分别根据源自这些国家/地区的命中数对城市和国家/地区进行排名。 生成此类型的报告后，条形图会显示通过特定平台请求内容的前 10 个城市或国家/地区。 此条形图可让你快速评估生成最多内容请求数的区域。
...
| 热门国家/地区 |此报告根据源自该国家/地区的命中数对国家/地区进行排名。 |
