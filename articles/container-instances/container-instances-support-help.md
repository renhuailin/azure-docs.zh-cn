---
title: Azure 容器实例支持和帮助选项
description: 在使用 Azure 容器实例创建解决方案过程中遇到问题时如何获得帮助和支持。
author: mimckitt
ms.author: mimckitt
...
下面是有关在开发 Azure 容器实例解决方案时如何获得帮助的建议。
...
请参阅 [Azure 容器实例中的常见问题](container-instances-troubleshooting.md)的列表，了解如何解决这些问题。 
...
如果通过搜索未找到你的问题的解答，请使用标记 [azure-container-instances](/answers/topics/azure-container-instances.html) 在 Microsoft Q&A 中提交新问题。
...
## <a name="check-the-stack-overflow-forum"></a>查看 Stack Overflow 论坛
<div class='icon is-large'>
    <img alt='Stack Overflow' src='./media/logos/stack-overflow-logo.png'>
</div>

[Stack Overflow](https://stackoverflow.com/) 上的 [azure-container-instances](https://stackoverflow.com/questions/tagged/azure-container-instances) 标记用于询问有关平台如何工作以及如何使用它来完成某些任务的一般问题。
...
如果需要有关用于开发和管理 Azure 容器实例的语言和工具的帮助，请在其在 GitHub 上的存储库中提出问题。
...
在 [Azure 更新](https://azure.microsoft.com/updates/?category=containers)中了解重要产品更新、路线图和公告。

[Azure 博客](https://azure.microsoft.com/blog)中分享了有关 Azure 容器实例的新闻和信息。

## <a name="next-steps"></a>后续步骤

详细了解 [Azure 容器实例](./index.yml)