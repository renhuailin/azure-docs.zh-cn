...
为虚拟阵列启用电子邮件通知后，每次发生关键警报时，通知列表成员都将收到电子邮件消息。 消息将从“storsimple-alerts-noreply\@mail.windowsazure.com”发送，并将描述警报条件。 收件人可以单击“取消订阅”将自己从电子邮件通知列表中删除。
...
2. 此时会打开“设置”边栏选项卡。 在“设备设置”部分中，选择“常规”。 此时会打开“常规设置”边栏选项卡。
    ...
    ![屏幕截图显示了调用“警报设置”区域的“设备设置”窗格。](./media/storsimple-virtual-array-manage-alerts/alerts4.png)
3. 在“常规设置”边栏选项卡中，转到“警报设置”部分，并设置以下项：
   
   1. 在“启用电子邮件通知”字段中，选择“是”。
   2. 如果希望服务管理员和所有协同管理员接收警报通知，请在“电子邮件服务管理员”字段中选择“是”。
   3. 在“其他电子邮件收件人”字段中，输入应接收警报通知的所有其他收件人的电子邮件地址。 用“someone\@somewhere.com”格式输入名称。 使用分号分隔电子邮件地址。 对于每个虚拟设备，最多可以配置 20 个电子邮件地址。
      
       ![屏幕截图显示“警报设置”详细信息以及此步骤中描述的设置。](./media/storsimple-virtual-array-manage-alerts/alerts6.png)
   4. 若要发送测试电子邮件通知，请单击“发送测试电子邮件”。 StorSimple Device Manager 服务在转发测试通知时会显示状态消息。
      
       ![屏幕截图显示验证测试电子邮件的信息对话框。](./media/storsimple-virtual-array-manage-alerts/alerts7.png)
   ...
   5. 在页面底部，单击“保存”保存配置。 当系统提示你进行确认时，单击 **“是”**。
      ...
      ![屏幕截图显示“设置”窗格，其中“保存”按钮处于选中状态。](./media/storsimple-virtual-array-manage-alerts/alerts10.png)
