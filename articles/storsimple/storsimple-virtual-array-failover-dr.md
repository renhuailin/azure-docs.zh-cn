...
本文仅适用于 StorSimple Virtual Arrays。 若要对 8000 系列设备进行故障转移，请转到 [StorSimple 设备的设备故障转移和灾难恢复](./storsimple-8000-device-failover-disaster-recovery.md)。
