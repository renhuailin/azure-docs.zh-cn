...
> * 如果要使用修补程序方法进行安装，请联系 [Microsoft 支持部门](mailto:support@microsoft.com)。
...
确保设备运行的是“StorSimple 8000 系列 Update 5.1 (6.3.9600.17885)”。 应修改“上次更新日期”。
<!-- 5.1 - KB 4542887-->
