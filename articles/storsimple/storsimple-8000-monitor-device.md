...
![所有本地固定卷的主容量使用量 2](./media/storsimple-8000-monitor-device/device-primary-storage-usage-by-volume.png)
...
* 了解如何[使用 StorSimple 设备管理器服务设备仪表板](./storsimple-8000-device-dashboard.md)。
