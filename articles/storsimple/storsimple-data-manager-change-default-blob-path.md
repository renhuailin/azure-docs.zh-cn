---
title: 更改默认路径的 blob 路径
description: 了解如何设置 Azure 函数以重命名默认 blob 文件路径，并将 blob 移动到不同的位置。
author: alkohli
...
10. 在“函数”窗口中，运行 _.csx_ 文件。
    ...
    ![创建新的 C# 函数 2](./media/storsimple-data-manager-change-default-blob-path/new-function-run-csx.png)
