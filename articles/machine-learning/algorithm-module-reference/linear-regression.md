...
3. 在“L2 正则化权重”中，键入用作 L2 正则化权重的值。 建议使用非零值以避免过度拟合。
     ...
     若要详细了解正则化如何影响模型拟合，请参阅以下文章：[机器学习的 L1 和 L2 正则化](/archive/msdn-magazine/2015/february/test-run-l1-and-l2-regularization-for-machine-learning)
