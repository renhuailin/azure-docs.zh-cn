...
本文探讨特定于高级分析和认知服务解决方案实施项目的开发人员运营 (DevOps) 功能。 这些培训材料实现了 Team Data Science Process (TDSP) 及 Microsoft 与开源代码软件和工具包，有助于构想、执行和交付数据科学解决方案。 其中参考了有关数据科学和 AI 项目与解决方案专用的 DevOps 工具链的主题。

## <a name="lesson-path"></a>课程路径
下表提供了基于级别的指导，以帮助完成在 Azure 上实现数据科学解决方案的 DevOps 目标。
...
|  | Intelligence | [此参考文章概述可用的认知服务（例如视觉、文本和搜索）及其用法入门](../../cognitive-services/what-are-cognitive-services.md) | 认知服务 | 有经验 | 普通的技术背景，熟悉数据解决方案和软件开发 |
|  |  | [此参考文章介绍 Microsoft Bot Framework 及其用法入门](/bot-framework/overview-introduction-bot-framework) | Bot 框架 | 有经验 | 普通的技术背景，熟悉数据解决方案 |
