...
[适用于 R 和 SQL Server 的数据科学演练](/sql/advanced-analytics/tutorials/walkthrough-data-science-end-to-end-walkthrough)向 SQL 程序员提供了通过 SQL Server R Services 使用 Transact-SQL 构建高级分析解决方案以使用 R 解决方案的体验。 


## <a name="predict-taxi-tips-using-python-in-sql-server-stored-procedures"></a>在 SQL Server 存储过程中使用 Python 预测出租车小费

[将 T-SQL 用于 SQL Server Python Services](/sql/advanced-analytics/tutorials/sqldev-in-database-python-for-sql-developers) 演练向 SQL 程序员介绍了如何在 SQL Server 中生成机器学习解决方案。 具体展示了如何将 Python 代码添加到存储过程，从而将 Python 合并到应用程序中。
