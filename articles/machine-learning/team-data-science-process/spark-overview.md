...
选择“PySpark”，查看包含数个使用 PySpark API 的预打包笔记本示例的目录。 [GitHub](https://github.com/Azure/Azure-MachineLearning-DataScience/tree/master/Misc/Spark/pySpark) 中提供包含 Spark 主题套件代码示例的笔记本
