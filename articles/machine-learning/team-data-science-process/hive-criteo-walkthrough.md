...
Col15 有 19M 个唯一值！ 使用类似“one-hot encoding”的 naive 技术来编码这种高维分类变量是不可行的。 特别是，我们解释和演示了一中功能强大且可靠的技术，称为[使用计数学习](/archive/blogs/machinelearning/big-learning-made-easy-with-counts)，以有效地解决这个问题。
