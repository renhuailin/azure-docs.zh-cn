...
[将 Azure Data Lake 用于数据科学](data-lake-walkthrough.md)演练介绍如何使用 Azure Data Lake 执行数据浏览和二元分类任务。  数据是 NYC 出租车数据集示例。  任务是预测客户是否支付小费。 
...
有关 Team Data Science Process 生命周期的讨论，请参阅 [Team Data Science Process 生命周期](lifecycle.md)。 此生命周期概述了项目执行时其通常遵循的步骤。 
