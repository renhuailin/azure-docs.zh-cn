---
title: CLI (v2) Azure Blob 数据存储 YAML 架构
titleSuffix: Azure Machine Learning
description: CLI (v2) Azure Blob 数据存储 YAML 架构的参考文档。
...
ms.locfileid: "121779743"
---
# <a name="cli-v2-azure-blob-datastore-yaml-schema"></a>CLI (v2) Azure Blob 数据存储 YAML 架构

[!INCLUDE [preview disclaimer](../../includes/machine-learning-preview-generic-disclaimer.md)]

## <a name="schema"></a>架构

可在 https://azuremlschemas.azureedge.net/latest/azureBlob.schema.json 中找到源 JSON 架构。 为方便起见，下面以 JSON 和 YAML 格式提供了架构。
