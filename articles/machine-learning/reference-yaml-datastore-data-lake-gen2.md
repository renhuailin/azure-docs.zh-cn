---
title: CLI (v2) Azure Data Lake Gen2 数据存储 YAML 架构
titleSuffix: Azure Machine Learning
description: CLI (v2) Azure Data Lake Gen2 数据存储 YAML 架构的参考文档。
...
ms.locfileid: "121778649"
---
# <a name="cli-v2-azure-data-lake-gen2-yaml-schema"></a>CLI (v2) Azure Data Lake Gen2 YAML 架构

[!INCLUDE [preview disclaimer](../../includes/machine-learning-preview-generic-disclaimer.md)]

## <a name="schema"></a>架构

可在 https://azuremlschemas.azureedge.net/latest/azureDataLakeGen2.schema.json 中找到源 JSON 架构。 为方便起见，下面将以 JSON 和 YAML 格式提供架构。
