...
2. 搜索“成本管理 + 计费”。
   ...
   ![显示如何在 Azure 门户中搜索“成本管理 + 计费”的屏幕截图。](./media/view-all-accounts/billing-search-cost-management-billing.png)
...
4. 选择要查看详细信息的范围。
   ...
   ![显示计费范围的屏幕截图，可以在其中进行选择以查看详细信息。](./media/view-all-accounts/list-of-scopes.png)
