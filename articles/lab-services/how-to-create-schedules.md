...
description: 了解如何在 Azure 实验室服务中创建实验室计划，以便实验室中的 VM 能够在指定时间启动和关闭。
ms.topic: article
ms.date: 06/26/2020
