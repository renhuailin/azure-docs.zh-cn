---
title: Azure 实验室服务中的实验室 - FAQ | Microsoft Docs
description: 本文提供有关 Azure 实验室服务中实验室的常见问题解答 (FAQ)。
ms.topic: article
ms.date: 06/26/2020
...
---
# <a name="labs-in-azure-lab-services--frequently-asked-questions-faq"></a>Azure 实验室服务中的实验室 - 常见问题解答 (FAQ)
获取关于 Azure 实验室服务中实验室的某些最常见问题的解答。 
...
在 Azure 门户中创建实验室帐户时，实验室可以在指定的 IP 地址范围内创建实验室 VM。 提供地址范围时，为实验室 VM 分配 512 IP 地址后将创建各个实验室。 实验室帐户的地址范围必须足够大，以容纳要在实验室帐户下创建的所有实验室。 
...
端口如下：49152–65535。 实验室位于负载均衡器后面。 每个实验室都有一个公共 IP 地址，并且实验室中的每个虚拟机都有一个唯一的端口。 
