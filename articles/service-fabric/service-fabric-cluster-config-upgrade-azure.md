...
2. 导航到订阅：展开“订阅” -> \<Your Subscription> -> “资源组” -> \<Your Resource Group> -> “提供程序” -> “Microsoft.ServiceFabric” -> “群集” ->  **\<Your Cluster Name>**
3. 选择右上角的“读/写”。
...
- 使用 Azure PowerShell [Set-AzServiceFabricSetting](/powershell/module/az.servicefabric/set-azservicefabricsetting) 和 [Remove-AzServiceFabricSetting](/powershell/module/az.servicefabric/remove-azservicefabricsetting) 命令直接修改这些设置。
