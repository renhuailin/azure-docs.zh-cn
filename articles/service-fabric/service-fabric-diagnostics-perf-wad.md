...
* 访问 [WadCfg 生成器](https://azure.github.io/azure-diagnostics-tools/config-builder/)以从头开始构建模板并确保语法正确（ https://azure.github.io/azure-diagnostics-tools/config-builder/) 以从头开始构建模板并确保语法正确。
