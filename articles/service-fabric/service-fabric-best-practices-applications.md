...
- 使执行组件状态[尽可能细粒度](./service-fabric-reliable-actors-state-management.md#best-practices)。
...
* 请访问 [Azure 体系结构中心](/azure/architecture/microservices/)，获取[在 Azure 中构建微服务](/azure/architecture/microservices/)的设计指导。

* 有关[在游戏服务中使用 Service Fabric](/gaming/azure/reference-architectures/multiplayer-synchronous-sf) 的设计指南，请访问 [Azure 游戏入门](/gaming/azure/)。
