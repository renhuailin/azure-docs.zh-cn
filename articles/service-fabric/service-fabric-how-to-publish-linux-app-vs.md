...
可以使用 Visual Studio 工具开发 .Net Core 应用程序并将其发布到 Linux Service Fabric 群集。 SDK 版本必须为 3.4 或更高版本才能在 Visual Studio 中将 .Net Core 应用程序部署到 Linux Service Fabric 群集。
...
* 了解[结合使用 Service Fabric 和 .Net Core 入门](https://azure.microsoft.com/resources/samples/service-fabric-dotnet-core-getting-started/)
