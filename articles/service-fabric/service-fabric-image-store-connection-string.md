...
description: 了解映像存储连接字符串，包括其对 Service Fabric 群集的使用和应用。
author: alexwun
ms.topic: conceptual
ms.date: 02/27/2018
ms.author: alexwun
