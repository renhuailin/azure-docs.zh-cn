...
description: 使用这些资源来获取有关 Avere vFXT for Azure 的其他信息，包括 Avere 群集文档和 vFXT 管理文档。
author: ekpgh
...
GitHub 上提供了使用 vfxt.py（基于脚本的云群集的创建和管理实用工具）的完整指南：[使用 vfxt.py 管理云群集](https://github.com/Azure/AvereSDK/blob/master/docs/README.md)。
