...
## <a name="install-the-required-modules"></a><a name="install-modules"></a>安装所需的模块
...
## <a name="connect-the-nodejs-application-to-azure-cosmos-db"></a><a name="connect-to-database"></a>将 Node.js 应用程序连接到 Azure Cosmos DB
...
## <a name="build-a-user-interface"></a><a name="build-ui"></a>生成用户界面
...
## <a name="run-your-application-locally"></a><a name="run-app-locally"></a>在本地运行应用程序
...
## <a name="deploy-your-application-to-web-apps"></a><a name="deploy-app"></a>将应用程序部署到 Web 应用
