...
ms.locfileid: "106443332"
---
# <a name="migrate-your-data-to-an-azure-cosmos-db-table-api-account"></a>将数据迁移到 Azure Cosmos DB 表 API 帐户
[!INCLUDE[appliesto-table-api](includes/appliesto-table-api.md)]

本教程说明如何导入要在 Azure Cosmos DB [表 API](table-introduction.md) 中使用的数据。 如果已将数据存储在 Azure 表存储中，可以使用数据迁移工具或 AzCopy 将数据导入 Azure Cosmos DB 表 API。 
