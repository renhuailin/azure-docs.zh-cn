...
description: 了解如何查询诊断日志，以排查 Azure Cosmos DB for Cassandra API 中存储的数据的问题
author: StefArroyo
services: cosmos-db
...
ms.locfileid: "112560898"
---
# <a name="troubleshoot-issues-with-advanced-diagnostics-queries-for-cassandra-api"></a>使用针对 Cassandra API 的高级诊断查询来排查问题
