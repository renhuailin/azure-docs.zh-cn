---
title: 将 Apache Spark 2 连接到 Azure Cosmos DB
description: 了解可将 Apache Spark 连接到 Azure Cosmos DB 的 Azure Cosmos DB Spark 2 OLTP 连接器。
author: anfeldma-ms
...
ms.locfileid: "110709186"
---
# <a name="accelerate-big-data-analytics-by-using-the-apache-spark-v2-to-azure-cosmos-db-oltp-connector"></a>使用 Apache Spark v2 到 Azure Cosmos DB OLTP 的连接器加速大数据分析
[!INCLUDE[appliesto-sql-api](includes/appliesto-sql-api.md)]

可以使用 Cosmos DB Spark 2 OLTP 连接器针对 Azure Cosmos DB 中存储的数据运行 [Spark v2](https://spark.apache.org/) 作业。 Cosmos 可用于批处理和流式处理，并可充当服务层来降低访问延迟。
...
> [!IMPORTANT]
> Azure Cosmos DB Spark OLTP 连接器目前不受[无服务器](serverless.md)帐户支持。 随着无服务器产品/服务正式发布，这一问题将得到解决。

## <a name="quickstart"></a>快速入门

* 遵循 [Java SDK 入门](./create-sql-api-java.md)中的步骤设置 Cosmos DB 帐户，并填充一些数据。
* 按照 [Azure Databricks 入门](/azure/databricks/scenarios/quickstart-create-databricks-workspace-portal)中的步骤设置 Azure Databricks 工作区和群集。
