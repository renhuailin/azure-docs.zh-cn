...
本文仅提供 Gremlin API 帐户的示例。若要查找其他 API 类型帐户的示例，请参阅以下文章：将 Azure 资源管理器模板与适用于 [Cassandra](../cassandra/templates-samples.md)、[SQL](../templates-samples-sql.md)、[MongoDB](../mongodb/resource-manager-template-samples.md)、[表](../table/resource-manager-templates.md)的 Azure Cosmos DB API 配合使用。
