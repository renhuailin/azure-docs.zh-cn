...
> * [Gremlin 控制台](create-graph-console.md)
...
:::image type="content" source="./media/create-graph-console/gremlin-console.png" alt-text="Apache Gremlin 控制台中的 Azure Cosmos DB":::
...
2. 根据下表中的定义，填写 *host*、*port*、*username*、*password*、*connectionPool* 和 *serializer* 配置：
   ...
   :::image type="content" source="./media/create-graph-console/gremlin-uri.png" alt-text="在 Azure 门户的“概览”页上查看和复制 Gremlin URI 值":::

   对于密码值，请从“密钥”页复制“主密钥” ：

   :::image type="content" source="./media/create-graph-console/keys.png" alt-text="在 Azure 门户的“密钥”页中查看和复制主密钥":::
