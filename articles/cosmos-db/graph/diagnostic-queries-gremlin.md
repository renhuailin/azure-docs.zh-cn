...
description: 了解如何查询诊断日志，以排除 Azure Cosmos DB for Gremlin API 中存储的数据故障问题。
author: StefArroyo
services: cosmos-db
...
ms.locfileid: "122608900"
---
# <a name="troubleshoot-issues-with-advanced-diagnostics-queries-for-the-gremlin-api"></a>使用针对 Gremlin API 的高级诊断查询排查问题
