...
如果使用的是其他 API，请参阅 [API for MongoDB](../mongodb/how-to-provision-throughput-mongodb.md)、[Cassandra API](../cassandra/how-to-provision-throughput-cassandra.md)、[Gremlin API](../graph/how-to-provision-throughput-gremlin.md) 这几篇文章来预配吞吐量。
