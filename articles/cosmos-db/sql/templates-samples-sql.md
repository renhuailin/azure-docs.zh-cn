...
ms.locfileid: "123113651"
---
# <a name="azure-resource-manager-templates-for-azure-cosmos-db"></a>用于 Azure Cosmos DB 的 Azure 资源管理器模板
[!INCLUDE[appliesto-sql-api](../includes/appliesto-sql-api.md)]

本文仅显示适用于 Core (SQL) API 帐户的 Azure 资源管理器模板示例。 你还可以查找 [Cassandra](../cassandra/templates-samples.md)、[Gremlin](../graph/resource-manager-template-samples.md)、[MongoDB](../mongodb/resource-manager-template-samples.md) 和[表](../table/resource-manager-templates.md) API 的模板示例。
