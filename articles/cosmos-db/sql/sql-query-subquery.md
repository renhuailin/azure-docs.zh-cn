...
本文介绍 Azure Cosmos DB 中的 SQL 子查询及其常见用例。 本文档中的所有示例查询是针对[示例营养数据集](https://github.com/AzureCosmosDB/labs/blob/master/dotnet/setup/NutritionData.json)运行的。
