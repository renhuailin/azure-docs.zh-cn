...
> [!IMPORTANT]  
> 2024 年 2 月 29 日，Azure Cosmos DB Sync Java SDK v2.x 将停用；此 SDK 和所有使用此 SDK 的应用程序将继续运行；Azure Cosmos DB 将仅停止为此 SDK 提供进一步的维护和支持。
