...
本教程的第 2 部分基于[简介](tutorial-develop-nodejs-part-1.md)，涵盖以下任务：
...
在开始教程的此部分之前，请确保已观看[简介视频](tutorial-develop-nodejs-part-1.md)。
...
8. 在 Visual Studio Code 中，单击“调试”按钮 :::image type="icon" source="./media/tutorial-develop-nodejs-part-2/debug-button.png":::，单击“齿轮”按钮 :::image type="icon" source="./media/tutorial-develop-nodejs-part-2/gear-button.png":::。 此时会在 Visual Studio Code 中打开新的 launch.json 文件。 

8. 在 launch.json 文件的第 11 行将 `"${workspaceFolder}\\server"` 更改为 `"program": "${workspaceRoot}/src/server/index.js"`，然后保存文件。

9. 单击“启动调试”按钮 :::image type="icon" source="./media/tutorial-develop-nodejs-part-2/start-debugging-button.png"::: 运行该应用。
...
2. 单击“发送”按钮，从应用获取 JSON 响应。 
    ...
    :::image type="content" source="./media/tutorial-develop-nodejs-part-2/azure-cosmos-db-postman.png" alt-text="显示请求和响应的 Postman":::
