...
若要部署此应用，可在 Azure 中创建新的 Web 应用，并使用此 GitHub 存储库分支启用持续部署。 按照此[教程](../app-service/deploy-continuous-deployment.md)，在 Azure 中使用 GitHub 设置持续部署。
