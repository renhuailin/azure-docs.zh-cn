...
>[!Note]
> Azure Cosmos DB 不托管 MongoDB 引擎。 它提供了 MongoDB [线路协议 4.0 版本](mongodb-feature-support-40.md)、[3.6 版本](mongodb-feature-support-36.md)的实现，以及对旧版[线路协议 3.2 版本](mongodb-feature-support.md)的支持。 因此，其中的一些错误仅出现在 Azure Cosmos DB API for MongoDB 中。
...
| 66 | ImmutableField | 请求试图更改不可变字段 | “_id”是不可变字段。 确保请求不会尝试更新该字段或分片键字段。 |
...
| 115 | CommandNotSupported | 不支持所尝试的请求。 | 错误中应当提供了更多详细信息。 如果此功能对你的部署很重要，请在 [Azure 门户](https://portal.azure.com/?#blade/Microsoft_Azure_Support/HelpAndSupportBlade)中创建支持工单，Azure Cosmos DB 团队将会回复你。 |
