...
>[!Note]
> Azure Cosmos DB 不托管 MongoDB 引擎。 它提供了 MongoDB [线路协议版本 4.0](mongodb-feature-support-40.md)、[3.6](mongodb-feature-support-36.md) 的实现，以及对[线路协议版本 3.2](mongodb-feature-support.md) 的旧版支持。 因此，其中的一些错误仅出现在 Azure Cosmos DB API for MongoDB 中。
