...
1. 使用屏幕右侧的 :::image type="icon" source="./media/manage-data-dotnet/copy.png"::: 按钮以复制“用户名”值。

   :::image type="content" source="./media/manage-data-dotnet/keys.png" alt-text="在 Azure 门户的“连接字符串”页面中查看并复制访问密钥":::
...
3. 按 CTRL + F5 运行应用程序。 应用将显示在控制台窗口中。 
    ...
    :::image type="content" source="./media/manage-data-dotnet/output.png" alt-text="查看并验证输出":::

    按 CTRL + C 停止执行程序并关闭控制台窗口。 
    
4. 在 Azure 门户中，打开数据资源管理器，以查询、修改和处理这些新数据。

    :::image type="content" source="./media/manage-data-dotnet/data-explorer.png" alt-text="在数据资源管理器中查看数据":::
