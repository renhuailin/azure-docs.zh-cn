...
1. 在 [Azure 门户](https://portal.azure.com/)的 Azure Cosmos DB 帐户中，选择“连接字符串”。 
    ...
    :::image type="content" source="./media/manage-data-go/copy-username-connection-string-azure-portal.png" alt-text="从 Azure 门户中的连接字符串页面查看和复制详细信息":::
...
4. 在 Azure 门户中，打开数据资源管理器，以查询、修改和处理这些新数据。 
    ...
    :::image type="content" source="./media/manage-data-go/view-data-explorer-go-app.png" alt-text="在数据资源管理器中查看数据 - Azure Cosmos DB":::
