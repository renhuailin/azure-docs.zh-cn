...
如果你使用的是其他 API，请参阅 [SQL API](../how-to-provision-container-throughput.md)、[适用于 MongoDB 的 API](../mongodb/how-to-provision-throughput-mongodb.md)、[Gremlin API](../how-to-provision-throughput-gremlin.md) 文章来预配置吞吐量。
...
Azure 资源管理器模板可用于在数据库或容器级资源上为所有 Azure Cosmos DB API 预配自动缩放吞吐量。 有关示例，请参阅 [Azure Cosmos DB 的 Azure 资源管理器模板](templates-samples.md)。
