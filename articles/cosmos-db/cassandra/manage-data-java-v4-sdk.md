...
1. 在 [Azure 门户](https://portal.azure.com/)的 Azure Cosmos DB 帐户中，选择“连接字符串”。 
    ...
    :::image type="content" source="./media/manage-data-java/copy-username-connection-string-azure-portal.png" alt-text="在 Azure 门户的“连接字符串”页面中查看并复制用户名":::

2. 使用屏幕右侧的 :::image type="icon" source="./media/manage-data-java/copy-button-azure-portal.png"::: 按钮复制“CONTACT POINT”值。
...
4. 在 Azure 门户中，打开数据资源管理器，以查询、修改和处理这些新数据。 
    ...
    :::image type="content" source="./media/manage-data-java/view-data-explorer-java-app.png" alt-text="在数据资源管理器中查看数据 - Azure Cosmos DB":::
