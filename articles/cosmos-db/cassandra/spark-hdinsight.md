...
* [预配 Azure Cosmos DB Cassandra API](manage-data-dotnet.md#create-a-database-account)
...
* [使用 Cassandra API 的代码示例完整列表](connect-spark-configuration.md)
