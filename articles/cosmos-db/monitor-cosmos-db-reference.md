...
Azure Cosmos DB 使用 Azure Monitor 日志中的 Kusto 表。 可以通过 Log analytics 查询这些表。 有关 Kusto 应变使用的列表，请参阅 [Azure Monitor 日志表参考](/azure-monitor/reference/tables/tables-resourcetype#azure-cosmos-db) 文章。
