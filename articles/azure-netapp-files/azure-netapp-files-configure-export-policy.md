...
2.  若要创建导出策略规则，请指定以下信息：   
    ...
    * **只读** 和 **读/写**：如果你将 Kerberos 加密与 nfsv 4.1 一起使用，请按照 [配置 nfsv 4.1 Kerberos 加密](configure-kerberos-encryption.md)中的说明进行操作。  对于 Kerberos 的性能影响，请参阅 [nfsv 4.1 卷上 Kerberos 的性能影响](performance-impact-kerberos.md)。 
