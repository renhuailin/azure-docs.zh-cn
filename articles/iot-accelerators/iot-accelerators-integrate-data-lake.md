...
1. 在数据资源管理器中，向下钻取到 **/streaming** 文件夹。 你将看到以 YYYY/MM/DD 格式创建的文件夹。

    ![屏幕截图，显示/streaming/YYYY/MM/DD/HH 文件夹的路径。](./media/iot-accelerators-integrate-data-lake/data-lake-store-data-explorer.png)
...
Azure Data Lake Analytics 可用于针对 Data Lake Store 数据集执行大数据分析。 请在 [Data Lake Analytics 文档](../data-lake-analytics/index.yml)中了解详细信息。