...
* IoT-Hub 管理器： `http://localhost:9002/v1/status`
* 设备遥测： `http://localhost:9004/v1/status`
* config.xml `http://localhost:9005/v1/status`
* 存储适配器： `http://localhost:9022/v1/status`
