...
详细了解[参数](/cli/azure/keyvault/certificate#az_keyvault_certificate_import)。

导入证书后，可以使用 [certificate show](/cli/azure/keyvault/certificate#az_keyvault_certificate_show) 来查看证书
