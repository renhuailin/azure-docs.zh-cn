...
达到配额限制时，则无法部署新群集，也无法通过添加更多工作节点来横向扩展现有群集。 唯一存在配额限制的是每个订阅的区域级别的 CPU 核心配额。 例如，订阅在美国东部区域的 CPU 内核限制可能是 30 个，而在美国东部中允许的内核数又增加了 30 个。
...
1. 选择页面左下方的“帮助 + 支持”。
    ...
    :::image type="content" source="./media/quota-increase-request/help-support-button.png" alt-text="“帮助和支持”按钮" border="true":::
...
1. 在“新建支持请求”页面的“基本信息”选项卡下，选择以下选项 ：
   ...
   - “配额类型”：**HDInsight**
     ...
     :::image type="content" source="./media/quota-increase-request/hdinsight-quota-support-request.png" alt-text="创建支持请求来增加 HDInsight 核心配额" border="true":::
...
1. 在“详细信息”页面，输入问题的说明，然后选择问题的严重性、首选联系方式和其他必填字段。 请使用下面列出的模板，确保你提供必需的信息。 增加配额请求由 Azure 容量团队进行评估，而非 HDInsight 产品团队。 提供的信息越完整，请求得到批准的可能性就越大。
   ...
   :::image type="content" source="./media/quota-increase-request/problem-details.png" alt-text="问题详细信息" border="true":::
