...
:::image type="content" source="./media/hdinsight-machine-learning-overview/training-for-prediction.png" alt-text="通过 R Server 进行预测训练" border="false":::

群集的边缘节点为连接到群集和运行 R 脚本提供了便捷的位置。  还可以使用 ScaleR 的 Hadoop Map Reduce 或 Spark 计算上下文，跨群集的节点运行 R 脚本。
