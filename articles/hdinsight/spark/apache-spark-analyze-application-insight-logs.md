...
:::image type="content" source="./media/apache-spark-analyze-application-insight-logs/application-insights.png" alt-text="数据从 Application Insights 流动到 Blob 存储，然后到 Spark" border="false":::
