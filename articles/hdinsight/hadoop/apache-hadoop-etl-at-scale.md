...
Apache Flume 无法与 Azure HDInsight 配合使用。 但是，本地 Hadoop 安装可以使用 Flume 将数据发送到 Azure Blob 存储或 Azure Data Lake Storage。 有关详细信息，请参阅[将 Apache Flume 与 HDInsight 配合使用](/archive/blogs/bigdatasupport/using-apache-flume-with-hdinsight)。
