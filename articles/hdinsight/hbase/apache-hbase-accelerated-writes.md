...
:::image type="content" source="./media/apache-hbase-accelerated-writes/azure-portal-create-hbase-wals.png" alt-text="启用 HDInsight Apache HBase 的加速写入选项" border="true":::
