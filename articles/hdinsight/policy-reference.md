...
ms.locfileid: "100098363"
---
# <a name="azure-policy-built-in-definitions-for-azure-hdinsight"></a>Azure HDInsight 的 azure 策略内置定义

此页是 azure HDInsight 的 [Azure 策略](../governance/policy/overview.md) 内置策略定义的索引。 有关其他服务的其他 Azure Policy 内置定义，请参阅 [Azure Policy 内置定义](../governance/policy/samples/built-in-policies.md)。
