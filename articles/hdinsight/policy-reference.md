...
description: 列出 Azure HDInsight 的 Azure Policy 内置策略定义。 这些内置的策略定义提供了管理 Azure 资源的常用方法。
ms.date: 08/13/2021
ms.topic: reference
...
ms.locfileid: "122182807"
---
# <a name="azure-policy-built-in-definitions-for-azure-hdinsight"></a>Azure HDInsight 的 Azure Policy 内置定义

本页是适用于 Azure HDInsight 的 [Azure Policy](../governance/policy/overview.md)内置策略定义的索引。 有关其他服务的其他 Azure Policy 内置定义，请参阅 [Azure Policy 内置定义](../governance/policy/samples/built-in-policies.md)。
