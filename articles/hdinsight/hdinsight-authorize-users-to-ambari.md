...
:::image type="content" source="./media/hdinsight-authorize-users-to-ambari/manage-apache-ambari.png" alt-text="Apache Ambari 仪表板管理":::
...
1. 在管理页中，选择“用户”。
    ...
    :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/apache-ambari-management-page-users.png" alt-text="Apache Ambari 管理页用户":::
...
1. 在管理页中，选择左侧“视图”菜单标题下面的“视图”链接。
    ...
    :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/apache-ambari-views-link.png" alt-text="Apache Ambari 视图的“视图”链接":::

2. 在“视图”页中，展开“HIVE”行。 有一个默认的 Hive 视图，它是在将 Hive 服务添加到群集时创建的。 还可以根据需要创建更多的 Hive 视图实例。 选择一个 Hive 视图：

    :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/views-apache-hive-view.png" alt-text="HDInsight 视图 - Apache Hive 视图":::

3. 滚动到“视图”页的底部。 在“权限”部分下面，可使用两个选项向域用户授予对该视图的权限：

**向这些用户授予权限** :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/hdi-add-user-to-view.png" alt-text="向这些用户授予权限":::

**向这些组授予权限** :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/add-group-to-view-permission.png" alt-text="向这些组授予权限":::

1. 若要添加用户，请选择“添加用户”按钮。

   * 开始键入用户名，随后会看到以前定义的名称的下拉列表。

     :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/ambari-user-autocomplete.png" alt-text="Apache Ambari 用户自动完成":::

   * 选择或完成键入用户名。 若要将此用户名添加为新用户，请选择“新建”按钮。

   * 若要保存更改，请选中 **蓝色复选框**。

     :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/user-entered-permissions.png" alt-text="Apache Ambari 授予用户权限":::
...
1. 若要添加组，请选择“添加组”按钮。
   ...
   * 若要保存更改，请选中 **蓝色复选框**。
     ...
     :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/ambari-group-entered.png" alt-text="Apache Ambari 授予权限":::
...
:::image type="content" source="./media/hdinsight-authorize-users-to-ambari/views-apache-tez-view.png" alt-text="HDInsight 视图 - Apache Tez 视图":::
...
:::image type="content" source="./media/hdinsight-authorize-users-to-ambari/cluster-roles-menu-link.png" alt-text="Apache Ambari“角色”菜单链接":::

若要查看授予每个角色的权限列表，请单击“角色”页上“角色”表标题旁边的蓝色问号。

:::image type="content" source="./media/hdinsight-authorize-users-to-ambari/roles-menu-permissions.png" alt-text="Apache Ambari 角色菜单链接权限":::
...
:::image type="content" source="./media/hdinsight-authorize-users-to-ambari/ambari-roles-block-view.png" alt-text="Apache Ambari 角色“块”视图":::
...
* “列表”视图的“用户”类别显示所有用户的列表，可让我们在下拉列表中选择每个用户的角色。
    ...
    :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/roles-list-view-users.png" alt-text="Apache Ambari 角色“列表”视图 - 用户":::
...
* “列表”视图的“组”类别显示所有组，以及分配给每个组的角色。 在本示例中，组列表已从群集“域”设置的“访问用户组”属性中指定的 Azure AD 组同步。 请参阅[在启用了 ESP 的情况下创建 HDInsight 群集](./domain-joined/apache-domain-joined-configure-using-azure-adds.md#create-an-hdinsight-cluster-with-esp)。
    ...
    :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/roles-list-view-groups.png" alt-text="Apache Ambari 角色“列表”视图 - 组":::
...
:::image type="content" source="./media/hdinsight-authorize-users-to-ambari/ambari-user-views-only.png" alt-text="仅具有视图的 Apache Ambari 用户":::
...
:::image type="content" source="./media/hdinsight-authorize-users-to-ambari/user-cluster-user-role.png" alt-text="Apache Ambari 仪表板显示":::
