---
title: 配置参数 - Azure Database for PostgreSQL（单一服务器）
description: 本文介绍如何使用 Azure CLI 在 Azure Database for PostgreSQL（单一服务器）中配置 Postgres 参数。
author: sunilagarwal
ms.author: sunila
