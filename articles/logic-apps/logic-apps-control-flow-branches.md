...
1. 在搜索框中，查找并选择所需的操作。
   ...
   ![屏幕截图显示逻辑应用设计器中的“选择操作”窗口。](media/logic-apps-control-flow-branches/find-select-parallel-action.png)
...
1. 在搜索框中，查找并选择所需的操作。
   ...
   ![屏幕截图显示逻辑应用设计器中的“选择操作”窗口和搜索框。](media/logic-apps-control-flow-branches/find-select-sequential-action.png)
