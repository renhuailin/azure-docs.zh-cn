...
本文介绍了如何通过使用“逻辑应用(预览版)”资源类型并执行以下重要任务，在 Azure 门户中构建逻辑应用和工作流：
...
1. 在“创建逻辑应用(预览版)”页面上，在“基本信息”选项卡上，提供有关你的逻辑应用的以下信息。 
...
1. 接下来，如果你的创建和部署设置支持使用 [Application Insights](../azure-monitor/app/app-insights-overview.md)，则可以选择为你的逻辑应用启用诊断日志记录和跟踪。
   ...
   1. 在“监视”选项卡上，在“Application Insights”下，将“启用 Application Insights”设置为“是”（如果尚未选择）。
