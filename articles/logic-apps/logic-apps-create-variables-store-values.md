...
* Azure 订阅。 如果没有订阅，可[注册免费的 Azure 帐户](https://azure.microsoft.com/free/)。
...
1. 在逻辑应用中要添加变量的步骤下，执行以下步骤之一： 
   ...
   * 若要在最后一个步骤下添加操作，请选择“新建步骤”。 
     ...
     ![屏幕截图显示“逻辑应用设计器”页中选中了“新建步骤”操作。](./media/logic-apps-create-variables-store-values/add-action.png)
