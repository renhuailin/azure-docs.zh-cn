---
title: 快速入门 - 在多租户 Azure 逻辑应用中使用 Azure CLI 创建和管理工作流
description: 使用 CLI 在多租户 Azure 逻辑应用中创建和管理逻辑应用工作流。
services: logic-apps
...
ms.locfileid: "110617253"
---
# <a name="quickstart-create-and-manage-workflows-using-azure-cli-in-multi-tenant-azure-logic-apps"></a>快速入门：在多租户 Azure 逻辑应用中使用 Azure CLI 创建和管理工作流
