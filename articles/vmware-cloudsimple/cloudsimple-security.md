...
CloudSimple 服务在逻辑上分离了第2层网络，限制了在私有云环境中对自己的专用网络的访问。 你可以使用防火墙进一步保护私有云网络。 通过 CloudSimple 门户，你可以为所有网络流量定义 "新建" 和 "NS 网络流量控制" 规则，包括私有云流量、私有云流量、到 Internet 的一般流量以及通过 IPsec VPN 或 ExpressRoute 连接到本地的网络流量。
