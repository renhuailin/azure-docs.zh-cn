...
可以通过 [Azure 时序见解资源管理器](./concepts-ux-panels.md)来创建和管理时序模型。 可以通过[模型设置 API](/rest/api/time-series-insights/reference-model-apis) 来管理时序模型设置。
