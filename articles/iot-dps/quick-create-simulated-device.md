...
在本部分，我们将准备一个用于生成 [Azure IoT C SDK](https://github.com/Azure/azure-iot-sdk-c) 和 [TPM](/windows/device-security/tpm/trusted-platform-module-overview) 设备模拟器示例的开发环境。
...
2. 导航到克隆的 git 存储库的根文件夹，并使用如下所示的路径运行 [TPM](/windows/device-security/tpm/trusted-platform-module-overview) 模拟器。 此模拟器通过端口 2321 和 2322 上的套接字进行侦听。 请勿关闭此命令窗口；本快速入门自始至终都需要让此模拟器保持运行。 
