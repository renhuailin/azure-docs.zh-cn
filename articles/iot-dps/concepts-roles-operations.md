...
由于制造时间、交货、报关等生产因素，开发 IoT 解决方案的阶段可能会跨数周或数月。此外，如果涉及到多种实体，这些阶段可能需要经历多个角色的活动。 本主题更深入地探讨与每个阶段相关的各种角色和操作，然后在顺序示意图中演示流程。 

预配还对设备制造商施加启用[证明机制](concepts-service.md#attestation-mechanism)方面的要求。 制造操作也可以独立于自动预配阶段的时间发生，尤其是在建立自动预配后采购新设备的情况下。
