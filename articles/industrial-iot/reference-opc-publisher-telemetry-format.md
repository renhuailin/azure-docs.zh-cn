---
title: Microsoft OPC 发布服务器遥测格式
description: 本文概述了配置设置文件
author: jehona-m
ms.author: jemorina
...
此外，所有版本的 OPC 发布服务器都支持非标准化的简单 JSON 遥测格式（与 [Azure 时序见解](https://azure.microsoft.com/services/time-series-insights/)兼容），如下所示：
```
[
   {
