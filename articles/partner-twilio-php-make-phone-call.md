...
1. 从 [Twilio 控制台][twilio_console]获取 Twilio 帐户和身份验证令牌。 若要开始使用 Twilio，请在 [https://www.twilio.com/pricing][twilio_pricing] 上评估定价。 你可通过 [https://www.twilio.com/try-twilio][try_twilio] 注册试用帐户。
...
* 阅读 [https://www.twilio.com/docs/security][twilio_docs_security] 中的 Twilio 安全准则。
