...
>[!NOTE]
> Windows 虚拟桌面仅支持发布其安装位置以 `C:\Program Files\WindowsApps` 开头的应用。
...
- 若要了解如何配置源以组织应用向用户显示的方式，请参阅[为 Windows 虚拟桌面用户自定义源](customize-feed-for-virtual-desktop-users.md)。
