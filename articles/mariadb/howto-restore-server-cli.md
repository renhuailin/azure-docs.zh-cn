...
- 本操作指南需要 Azure CLI 2.0 或更高版本。 如果使用 Azure Cloud Shell，则最新版本已安装。
...
若要还原服务器，请使用 Azure CLI [az mariadb server restore](/cli/azure/mariadb/server#az_mariadb_server_restore) 命令。
