---
title: 在 Azure Front Door 标准版/高级版中对域进行地区筛选 | Microsoft Docs
description: 本文介绍 Azure Front Door 标准版/高级版的地区筛选策略
services: frontdoor
documentationcenter: ''
author: duongau
editor: ''
...
ms.locfileid: "123439934"
---
# <a name="geo-filtering-on-a-domain-for-azure-front-door-standardpremium-preview"></a>在 Azure Front Door 标准版/高级版中对域进行地区筛选（预览）
...
可通过 [Azure 门户](../../web-application-firewall/afds/waf-front-door-create-portal.md)或[快速入门模板](https://github.com/Azure/azure-quickstart-templates/tree/master/quickstarts/microsoft.network/front-door-standard-premium-geo-filtering)为 Front Door 配置地区筛选策略。
...
- 了解如何[设置地区筛选 WAF 策略](../../web-application-firewall/afds/waf-front-door-create-portal.md)。
