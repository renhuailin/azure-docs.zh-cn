...
若要查看运行中的 Web 服务器，请使用 [az network public-ip show](/cli/azure/network/public-ip) 命令获取负载均衡器的公共 IP 地址。 以下示例获取创建为规模集一部分的 *myScaleSetPublicIP* 的 IP 地址：
