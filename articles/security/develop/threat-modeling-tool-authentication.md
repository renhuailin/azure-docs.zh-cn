...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **参考**              | [使用 Azure Active Directory 对 Web 应用程序执行新式身份验证](/archive/blogs/microsoft_press/new-book-modern-authentication-with-azure-active-directory-for-web-applications)、[使用 Redis 作为 ADAL 令牌缓存](https://blogs.msdn.microsoft.com/mrochon/2016/09/19/using-redis-as-adal-token-cache/)  |
