...
> [!NOTE]
> 若要改进 Azure 上 Linux VM 的安全性，可以与 Azure AD 身份验证集成。 使用[适用于 Linux VM 的 Azure AD 身份验证](../../virtual-machines/linux/login-using-aad.md)时，可以通过集中进行控制和强制实施策略来允许或拒绝对 VM 的访问。
>
>
...
**详细信息**：使用 [Azure 资源管理器](../../azure-resource-manager/templates/syntax.md)模板增强部署选项，使其更易理解并清点环境中的 VM。
...
**详细信息**：使用 [Azure 资源管理器模板](../../azure-resource-manager/templates/syntax.md)定义 VM，以便轻松地重新部署。 使用模板可在需要时提供已修补且安全的 VM。
