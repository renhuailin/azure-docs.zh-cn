...
[Azure AD 将本地 Active Directory 扩展到云中](../../active-directory/manage-apps/what-is-single-sign-on.md)，使用户能够使用其主组织帐户不仅登录到已加入域的设备和公司资源，而且还支持其工作所需的所有 Web 和 SaaS 应用程序。
...
[Azure 操作安全性](operational-security.md) 是指可供用户在 Microsoft Azure 中保护其数据、应用程序和其他资产的服务、控件和功能。
