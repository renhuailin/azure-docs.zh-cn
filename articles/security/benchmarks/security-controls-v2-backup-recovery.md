...
ms.locfileid: "102051542"
---
# <a name="security-control-v2-backup-and-recovery"></a>安全控制 V2：备份和恢复

备份和恢复包括用于确保在不同服务层执行、验证和保护数据和配置备份的控制措施。

若要查看适用的内置 Azure Policy，请参阅 [Azure 安全基准法规合规性内置计划：备份和恢复的详细信息](../../governance/policy/samples/azure-security-benchmark.md#backup-and-recovery)
