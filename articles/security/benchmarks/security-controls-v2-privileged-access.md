...
若要查看适用的内置 Azure Policy，请参阅 [Azure 安全基准法规符合性内置计划的详细信息：特权访问](../../governance/policy/samples/azure-security-benchmark.md#privileged-access)
...
在 Microsoft 需要访问客户数据的支持方案中，“客户密码箱”为你提供了显式审核和批准/拒绝每个客户数据访问请求的功能。
