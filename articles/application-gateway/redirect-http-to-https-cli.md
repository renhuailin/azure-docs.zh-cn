...
可以使用 [az network application-gateway frontend-port create](/cli/azure/network/application-gateway/frontend-port#az_network-application_gateway_frontend_port_create) 向应用程序网关添加 HTTP 端口。
