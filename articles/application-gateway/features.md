...
可以配置应用程序网关的 Standard_v2，以便进行自动缩放的或固定大小的部署。 v2 SKU 不提供不同的实例大小。 有关 v2 性能和定价的详细信息，请参阅[自动缩放 V2](application-gateway-autoscaling-zone-redundant.md) 和[了解定价](understanding-pricing.md)。
