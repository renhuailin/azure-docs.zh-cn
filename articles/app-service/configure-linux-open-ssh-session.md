...
使用 [az webapp create-remote-connection](/cli/azure/webapp#az_webapp_create_remote_connection) 命令打开到应用的远程连接。 为应用指定 \<subscription-id>、\<group-name> 和 \<app-name>。
