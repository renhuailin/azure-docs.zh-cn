...
1. 在 [Azure 门户](https://portal.azure.com/)中，单击“创建资源”>“Web + 移动”>“Web 应用”。 
    ...
    ![屏幕截图显示了在 Azure 门户中的何处创建 Web 应用。][1]
2. 选择订阅。  
   
    如果有多个订阅，请注意，若要在应用服务环境中创建应用，需要使用创建环境时所用的订阅来创建应用。 
3. 选择或创建资源组。
   
    资源组使你能够以单元形式管理相关的 Azure 资源，在为应用建立“Azure 基于角色的访问控制 (Azure RBAC)”规则时非常有用。 有关详细信息，请参阅 [Azure Resource Manager 概述][ResourceGroups]。 
4. 选择或创建应用服务计划。
...
![屏幕截图显示了“工作线程池”窗格，你可以在其中为 ASE 选择工作线程池。][4]
