...
若要创建应用服务环境 v1，可以在 Azure Marketplace 中搜索 ***应用服务环境 v1** _，或浏览 *创建资源**-> **Web + 移动**  ->  **应用服务环境**。 若要创建 ASEv1，请执行以下操作：
