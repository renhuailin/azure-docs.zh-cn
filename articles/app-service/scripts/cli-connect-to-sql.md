...
| [`az sql server create`](/cli/azure/sql/server?view=azure-cli-latest#az-sql-server-create) | 创建服务器。  |
| [`az sql db create`](/cli/azure/sql/db?view=azure-cli-latest#az-sql-db-create) | 创建新数据库。 |
