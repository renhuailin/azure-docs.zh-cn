...
:::image type="content" source="./media/app-gateway-with-service-endpoints/service-endpoints-appgw.png" alt-text="关系图显示了在 Azure 虚拟网络中流向应用程序网关的 Internet，并通过防火墙图标在应用服务中通过防火墙图标流向应用程序实例。":::
...
1. 使用应用服务文档中的快速入门之一创建应用服务，例如 [.Net Core 快速入门](../quickstart-dotnetcore.md)
...
![屏幕截图显示错误 403-禁止显示的文本。](./media/app-gateway-with-service-endpoints/website-403-forbidden.png)
