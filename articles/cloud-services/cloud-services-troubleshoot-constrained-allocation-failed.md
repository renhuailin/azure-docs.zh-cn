...
description: 本文介绍了如何在将云服务（经典）部署到 Azure 时解决 ConstrainedAllocationFailed 异常。
...
![展示了“操作日志(经典)”边栏选项卡的图。](./media/cloud-services-troubleshoot-constrained-allocation-failed/cloud-services-troubleshoot-allocation-logs.png)
...
随着时间的推移，群集中的资源可能会被完全利用。 当固定的群集中没有足够的资源可用时，如果云服务（经典）发出分配请求来请求更多资源，则该请求将导致分配失败。 有关详细信息，请参阅[导致分配失败的常见问题](cloud-services-allocation-failures.md#common-issues)。
