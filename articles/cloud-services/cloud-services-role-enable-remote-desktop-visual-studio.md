---
title: '使用 Visual Studio，为 (Azure 云服务的角色启用远程桌面) '
...
ms.locfileid: "98743230"
---
# <a name="enable-remote-desktop-connection-for-a-role-in-azure-cloud-services-classic-using-visual-studio"></a>使用 Visual Studio 为 Azure 云服务中的角色启用远程桌面连接 (经典) 
