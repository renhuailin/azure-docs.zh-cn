...
- 00-12、21-32、61-72 范围内的两位数字，或 80
- 2 位数字
- 1 个可选连字符
- 4 位数字
- 1 个可选连字符
...
- 1 个字母（N、E、D、F、A、C、U、X）后接 7 位数字或
- 2 个字母（PA、PB、PC、PD、PE、PF、PU、PW、PX、PZ）后接 7 位数字。
...
## <a name="austria-drivers-license-number"></a>奥地利驾照编号
...
## <a name="bulgaria-drivers-license-number"></a>保加利亚驾照编号
...
## <a name="bulgaria-uniform-civil-number"></a>保加利亚统一国民号码
此敏感信息类型仅供在以下场景中使用：
- 数据丢失防护策略
- 通信合规性策略
- 信息治理
...
有格式或无格式并且必须通过 Luhn 测试的 14 到 16 位数字。

### <a name="pattern"></a>模式

检测全球所有主要品牌的卡，包括维萨卡、万事达卡、发现卡、日财卡、美国运通卡、礼物卡、餐卡、Rupay 卡和中国银联卡。
...
此实体包含在欧盟国民身份证号码敏感信息类型中。 它是作为独立的敏感信息类型实体提供的。
...
## <a name="czech-national-identity-card-number"></a>捷克国民身份证号码

### <a name="format"></a>格式

包含可选正斜杠的 9 位数字（旧格式）；包含可选正斜杠的 10 位数字（新格式）
...
## <a name="drug-enforcement-agency-dea-number"></a>缉毒署 (DEA) 号码
...
模式必须包含下面所有的项：
- 以下一组可能的字母中的一个字母（不区分大小写的）：abcdefghjklmnprstux，为登记者代码
- 一个字母（不区分大小写，为登记者姓氏的第一个字母）或数字“9”
- 7 位数字，其中的最后一位数字是校验数字
...
## <a name="estonia-personal-identification-code"></a>爱沙尼亚个人身份代码
此敏感信息类型仅供在以下场景中使用：
- 数据丢失防护策略
- 通信合规性策略
- 信息治理
...
这些实体包含在欧盟驾照编号中，属于敏感信息类型。

- [奥地利](#austria-drivers-license-number)
- [比利时](#belgium-drivers-license-number)
- [保加利亚](#bulgaria-drivers-license-number)
- [克罗地亚](#croatia-drivers-license-number)
- [塞浦路斯](#cyprus-drivers-license-number)
- [捷克语](#czech-republic-drivers-license-number)
- [丹麦](#denmark-drivers-license-number)
- [爱沙尼亚](#estonia-drivers-license-number)
- [芬兰](#finland-drivers-license-number)
- [法国](#france-drivers-license-number)
- [德国](#germany-drivers-license-number)
...
这些实体包含在欧盟国民身份证号码中，属于敏感信息类型。

- [奥地利](#austria-identity-card)
- [比利时](#belgium-national-number)
- [保加利亚](#bulgaria-uniform-civil-number)
- [克罗地亚](#croatia-identity-card-number)
- [塞浦路斯](#cyprus-identity-card)
- [捷克语](#czech-national-identity-card-number)
- [丹麦](#denmark-personal-identification-number)
- [爱沙尼亚](#estonia-personal-identification-code)
- [芬兰](#finland-national-id)
- [法国](#france-national-id-card-cni)
- [德国](#germany-identity-card-number)
...
这些实体包含在欧盟护照号码中，属于敏感信息类型。 这些实体包含在欧盟护照号码组合中。

- [奥地利](#austria-passport-number)
- [比利时](#belgium-passport-number)
- [保加利亚](#bulgaria-passport-number)
- [克罗地亚](#croatia-passport-number)
- [塞浦路斯](#cyprus-passport-number)
- [捷克语](#czech-passport-number)
- [丹麦](#denmark-passport-number)
- [爱沙尼亚](#estonia-passport-number)
- [芬兰](#finland-passport-number)
- [法国](#france-passport-number)
- [德国](#germany-passport-number)
...
这些实体包含在欧盟社会安全号码或等效身份证号码中，属于敏感信息类型。

- [奥地利](#austria-social-security-number)
- [比利时](#belgium-national-number)
- [克罗地亚](#croatia-personal-identification-oib-number)
- [捷克语](#czech-national-identity-card-number)
- [丹麦](#denmark-personal-identification-number)
- [芬兰](#finland-national-id)
- [法国](#france-social-security-number-insee)
- [德国](#germany-identity-card-number)
- [希腊](#greece-national-id-card)
...
- [奥地利](#austria-tax-identification-number)
- [比利时](#belgium-national-number)
- [保加利亚](#bulgaria-uniform-civil-number)
- [克罗地亚](#croatia-identity-card-number)
...
- [爱沙尼亚](#estonia-personal-identification-code)
- [芬兰](#finland-national-id)
- [法国](#france-tax-identification-number)
- [德国](#germany-tax-identification-number)
...
此实体在欧盟护照号码敏感信息类型中提供，并作为独立的敏感信息类型实体提供。
...
此实体在欧盟驾照编号敏感信息类型中提供，并作为独立的敏感信息类型实体提供。
...
## <a name="france-national-id-card-cni"></a>法国国民身份证号码 (CNI)
...
此实体在欧盟护照号码敏感信息类型中提供。 它还作为独立的敏感信息类型实体提供。
...
## <a name="france-social-security-number-insee"></a>法国社会安全号码 (INSEE)
...
此敏感信息类型实体包含在欧盟驾照编号敏感信息类型中。 它还作为独立的敏感信息类型实体提供。
...
此实体包含在欧盟护照号码敏感信息类型中，作为独立的敏感信息类型实体提供。
...
此实体包含在是欧盟驾照编号敏感信息类型中。 它还作为独立的敏感信息类型实体提供。
...
## <a name="hungary-personal-identification-number"></a>匈牙利个人身份编号
此敏感信息类型仅供在以下场景中使用：
- 数据丢失防护策略
- 通信合规性策略
- 信息治理
...
字母和数字共 10 位：
- 3 个字母（不区分大小写）
- C、P、H、F、A、T、B、L、J、G 中的一个字母（不区分大小写）
- 1 个字母
- 四位数字
- 一个表示字母检验位的字母
...
国家/地区代码（2 个字母），加上校验数字（两位数），再加上 bban 号码（最多 30 个字符）
...
旧格式（截至 2012 年 12 月 31 日）：
- 7 位数字，后接 1 到 2 个字母

新格式（从 2013 年 1 月 1 日开始）：
- 7 位数字，后接 2 个字母
...
此类型实体包含在是欧盟驾照编号敏感信息类型中。 它还作为独立的敏感信息类型实体提供。
...
## <a name="italy-fiscal-code"></a>意大利财务代码
此敏感信息类型仅供在以下场景中使用：
- 数据丢失防护策略
- 通信合规性策略
- 信息治理
...
## <a name="japan-my-number---corporate"></a>日本个人编号 - 公司
此敏感信息类型仅供在以下场景中使用：
- 数据丢失防护策略
- 通信合规性策略
- 信息治理
...
## <a name="japan-my-number---personal"></a>日本个人编号 - 个人
此敏感信息类型仅供在以下场景中使用：
- 数据丢失防护策略
- 通信合规性策略
- 信息治理
...
## <a name="luxemburg-drivers-license-number"></a>卢森堡驾照编号
...
## <a name="new-zealand-drivers-license-number"></a>新西兰驾照编号
此敏感信息类型仅供在以下场景中使用：
- 数据丢失防护策略
- 通信合规性策略
- 信息治理
...
1 位数字或字母，后接 7 位数字，不带空格或分隔符

### <a name="pattern"></a>模式

1 位数字或字母（不区分大小写），后接 7 位数字
...
## <a name="thai-citizen-id"></a>泰国公民身份证号码
...
- 1 位数字。
- 表示出生日期（日期格式为 MMDDY）的 5 位数字。 如果驾驶员为女性，则第 7 个字符将加上 50；例如，将 01 到 12 更改为 51 到 62。
...
此敏感信息类型实体包含在欧盟国民身份证号码敏感信息类型中。 它还作为独立的敏感信息类型实体提供。
...
取决于所在的州 - 例如纽约州：
- 格式类似于 ddd ddd ddd 的 9 位数字与模式匹配。
...
四个函数分别以四种不同模式查找 SSN：
- Func_ssn 查找具有 2011 年前严格格式的、使用短划线或空格设置的 SSN（ddd-dd-dddd 或 ddd dd dddd）
- Func_unformatted_ssn 查找具有 2011 年前严格格式的、连续 9 位数字的无格式 SSN (ddddddddd)
- Func_randomized_formatted_ssn 查找 2011 年之后使用短划线或空格设置格式的 SSN（ddd-dd-dddd 或 ddd dd dddd）
- Func_randomized_unformatted_ssn 查找 2011 年之后连续 9 位数字的无格式 SSN (ddddddddd)
