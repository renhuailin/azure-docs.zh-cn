...
| 名称 | 类型 | 说明 |
| --- | --- | --- |
| **版本**<br/><br/> 必需 |**xs: decimal** |预设版本。 以下限制适用：xs:fractionDigits 值 =“1”和 xs:minInclusive 值 =“1”，例如，**版本 =“1.0”**。 |
...
| **Width**<br/><br/> minOccurs="0" |**xs: int** |输出视频帧的宽度，以像素为单位。<br/><br/> 目前必须指定“Width”和“Height”。 “宽度”和“高度”需为偶数。 |
| **Height**<br/><br/> minOccurs="0" |**xs:int** |输出视频帧的高度，以像素为单位。<br/><br/> 目前必须指定“Width”和“Height”。 “宽度”和“高度”需为偶数。|
...
## <a name="clip"></a><a name="Clip"></a>剪裁
### <a name="attributes"></a>属性
