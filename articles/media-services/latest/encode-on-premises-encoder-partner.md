...
2. 创建并启动直通直播活动（基本或标准）。 <br/> 有关详细信息，请参阅[直播活动状态和计费](live-event-states-billing-concept.md)。
...
1. 在媒体服务帐户中，确保 **流式处理终结点** 正在运行。 
2. 创建并启动实时编码直播活动。 <br/> 有关详细信息，请参阅[直播活动状态和计费](live-event-states-billing-concept.md)。
...
[经过测试的本地编码器](encode-recommended-on-premises-live-encoders.md)
