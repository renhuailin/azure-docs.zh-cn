...
description: 了解为 Azure 事件网格中的媒体服务事件提供的属性。
...
可在[实时事件错误代码](../live-event-error-codes-reference.md)中找到错误结果代码。
...
- [实时事件错误代码](../live-event-error-codes-reference.md)
