...
ms.locfileid: "106492284"
---
# <a name="standard-encoder-formats-and-codecs"></a>标准编码器格式和编解码器

[!INCLUDE [media services api v3 logo](./includes/v3-hr.md)]

本文包含可与 [StandardEncoderPreset](/rest/api/media/transforms/createorupdate#standardencoderpreset) 配合使用的最常见的导入和导出文件格式列表。 有关如何使用 **StandardEncoderPreset** 创建自定义预设的信息，请参阅 [使用自定义预设创建转换](transform-custom-presets-how-to.md)。
...
| 文件格式 | 视频编解码器 | 音频编解码器 |
| --- | --- | --- |
| MP4 <br/><br/>（包括多码率 MP4 容器） |H.264 (High, Main, and Baseline Profiles), HEVC (H.265) 8-bit |AAC-LC、HE-AAC v1、HE-AAC v2 |
| MPEG2-TS |H.264（High、Main 和 Baseline Profile） |AAC-LC、HE-AAC v1、HE-AAC v2 |

## <a name="next-steps"></a>后续步骤

[使用自定义预设创建转换](transform-custom-presets-how-to.md)
