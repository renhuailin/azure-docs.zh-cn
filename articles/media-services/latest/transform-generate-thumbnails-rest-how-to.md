---
title: 通过 REST 使用 Media Encoder Standard 生成缩略图
...
建议阅读[如何通过自定义转换进行编码 - REST](transform-custom-preset-rest-how-to.md)，以熟悉自定义转换。
...
可使用以下 JSON 预设基于输入视频的前几秒内容生成单个输出 PNG 文件，编码器会尽力尝试在其中查找“相关”帧。 请注意，输出图像尺寸已设置为 100%，这意味着，这些尺寸与输入视频的尺寸匹配。 另请注意需要如何指定“Outputs”中“Format”设置，以匹配“Codecs”节中“PngLayers”的用法。  
...
[使用 .NET 生成缩略图](transform-generate-thumbnails-dotnet-how-to.md)