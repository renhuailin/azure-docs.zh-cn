---
title: 配置脱机 PlayReady 流式处理
description: 本文介绍如何配置 Azure 媒体服务帐户 v3，以便对适用于 Windows 10 的 PlayReady 进行脱机流式处理。
...
- [适用于 iOS 的 FairPlay 脱机流式处理](drm-offline-fairplay-for-ios-concept.md)
- [适用于 Android 的 Widevine 脱机流式处理](drm-offline-widevine-for-android.md)
