---
title: 适用于 Android 的脱机 Widevine 流式处理
description: 本主题演示如何配置 Azure 媒体服务 v3 帐户，以对受 Widevine 保护的内容进行脱机流式处理。
...
对于某些较旧的 Android 设备，必须设置以下 policy_overrides 属性（在 [Widevine 许可证模板](drm-widevine-license-template-concept.md) 中定义）的值：rental_duration_seconds、playback_duration_seconds 和license_duration_seconds。 此外，也可以将它们设置为零，表示无限/无限制的持续时间。  
