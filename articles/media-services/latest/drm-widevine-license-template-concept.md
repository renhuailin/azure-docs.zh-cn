...
description: 了解 Azure 媒体服务 Widevine 许可证模板，以及如何使用它来配置 Widevine 许可证。
...
ms.locfileid: "106068406"
---
# <a name="media-services-v3-with-widevine-license-template-overview"></a>媒体服务 v3 Widevine 许可证模板概述
...
媒体服务提供了用于配置 Widevine 许可证的类。 若要构造许可证，请将 JSON 传递给 [WidevineTemplate](/dotnet/api/microsoft.azure.management.media.models.contentkeypolicywidevineconfiguration.widevinetemplate#Microsoft_Azure_Management_Media_Models_ContentKeyPolicyWidevineConfiguration_WidevineTemplate)。
...
使用上一部分中定义的类来创建用于配置 [WidevineTemplate](/dotnet/api/microsoft.azure.management.media.models.contentkeypolicywidevineconfiguration.widevinetemplate#Microsoft_Azure_Management_Media_Models_ContentKeyPolicyWidevineConfiguration_WidevineTemplate) 的 JSON：
...
了解如何[使用 DRM 提供保护](drm-protect-with-drm-tutorial.md)
