...
ms.date: 10/23/2020
ms.author: inhenkel
ms.openlocfilehash: 58dd7318c83a8ee49249093d290e86a9ba74a16d
ms.sourcegitcommit: 32e0fedb80b5a5ed0d2336cea18c3ec3b5015ca1
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/30/2021
ms.locfileid: "105729433"
---
...
* 创建活动时，可以选择打开“实时听录”。 默认情况下，将禁用“实时听录”。 有关实时转录的详细信息，请阅读[实时听录](live-transcription.md)。
...
* 访问令牌：使用静态主机名设置时，设置的有效 GUID 字符串。 例如，`"1fce2e4b-fb15-4718-8adc-68c6eb4c26a7"`。
...
## <a name="live-event-output-questions"></a>直播活动输出问题

请参阅[直播活动输出问题](questions-collection.md#live-streaming)一文。
