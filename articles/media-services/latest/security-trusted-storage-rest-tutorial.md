...
如果不知道如何获取租户 ID 和订阅 ID，请参阅[如何查找租户 ID](setup-azure-tenant-how-to.md) 和[查找租户 ID](setup-azure-tenant-how-to.md)。
...
[如何创建资产](asset-create-asset-how-to.md)
