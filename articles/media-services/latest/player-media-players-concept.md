...
请参阅 [Azure Media Player 文档](../azure-media-player/azure-media-player-overview.md)。
...
请参阅[如何将 Shaka Player 与 Azure 媒体服务一起使用](player-shaka-player-how-to.md)。
...
请参阅[如何将 Video.js 与 Azure 媒体服务一起使用](player-how-to-video-js-player.md)。
