...
若要在 Azure Active Directory B2C (Azure AD B2C) 中为用户启用使用 Facebook 帐户登录的功能，需要在 [Facebook 应用仪表板](https://developers.facebook.com/)中创建应用程序。 有关详细信息，请参阅[应用开发](https://developers.facebook.com/docs/development)。 如果还没有 Facebook 帐户，可以在 [https://www.facebook.com/](https://www.facebook.com/) 处注册。
...
1. 选择“设置” > “基本”。
    ...
    1. 为“服务条款 URL”输入一个 URL，例如 `http://www.contoso.com/tos`。 策略 URL 是你为应用程序继续提供条款和条件的页面。
