...
* 在“开发模式”下，使用 [Application Insights](troubleshoot-with-application-insights.md) 跟踪标识体验框架用户旅程的活动。 在“开发模式”下，可以观察标识体验框架与技术配置文件定义的各种声明提供程序（例如标识提供者、基于 API 的服务、Azure AD B2C 用户目录以及 Azure AD 多重身份验证等其他服务）之间的声明交换。
