...
若要详细了解[标识保护中的用户风险](../active-directory/identity-protection/concept-identity-protection-risks.md#user-risk)，请考虑使用[对 B2C 的标识保护检测的限制](identity-protection-investigate-risk.md#service-limitations-and-considerations)。
