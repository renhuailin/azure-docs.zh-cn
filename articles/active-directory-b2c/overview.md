...
* **合作伙伴** 和供应商是向该杂货店提供销售产品的个人。 合作伙伴标识由 [Azure Active Directory B2B](../active-directory/external-identities/what-is-b2b.md) 提供。
...
有关 Azure AD B2B 的详细信息，请参阅[什么是 Azure Active Directory B2B 中的来宾用户访问权限？](../active-directory/external-identities/what-is-b2b.md)。
