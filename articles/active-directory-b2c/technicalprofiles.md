...
用户旅程中的 [ClaimsProviderSelections](userjourneys.md#identity-provider-selection) 定义声明提供程序选项的列表及其顺序。 使用 **EnabledForUserJourneys** 元素可以筛选用户可用的声明提供程序。 **EnabledForUserJourneys** 元素包含以下值之一：
