...
1. 搜索“Azure Toolkit for IntelliJ”。 选择“安装”  。
...
1. 导航到 gs-spring-boot\complete 文件夹。
...
1. 如果应用 URL 未显示在输出窗口中，请从 Azure 门户获取它。 从资源组导航到 Azure Spring Cloud 实例。  然后选择“应用”。  将会列出正在运行的应用。
