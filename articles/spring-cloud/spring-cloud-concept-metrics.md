...
>| 第0代 GC 计数  | 第0代-gc 计数 | 计数        | 每秒0代垃圾回收数。 |
>| 第1代 GC 计数  | 第1代-gc 计数 | 计数        | 每秒1代垃圾回收数。 |
>| 第2代 GC 计数  | 第2代-gc 计数 | 计数        | 每秒第2代垃圾回收数。 |
...
>| 程序集计数  | 程序集计数 | 计数        | 已加载的程序集的数目。 |
>| 异常计数 | 异常-计数 | 计数       | 每秒的异常数。 |
>| 线程池线程计数      | threadpool 线程计数              | 计数 | 线程池线程数。 |
>| 监视器锁争用计数 | 监视-锁定争用计数        | 计数 | 尝试拍摄监视器锁时每秒发生争用的次数。 |
>| 线程池队列长度      | 线程池-队列长度              | 计数 | 线程池工作项队列长度。 |
>| 线程池已完成项计数 | threadpool-已完成项-计数 | 计数 | 线程池已完成工作项计数。 |
>| 活动计时器计数               | 活动计时器-计数               | 计数 | 当前处于活动状态的计时器的数目。 活动计时器是注册后要在将来某个时间点进行计时的计时器，尚未取消。 |
