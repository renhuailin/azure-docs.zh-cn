...
1. 选择“仪表板设置”并为仪表板输入名称，然后选择“保存”  。 

    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/dashboard-edit.png" alt-text="Azure IoT Central 编辑仪表板。":::

    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/new-dashboard.png" alt-text="Azure IoT Central 新建仪表板。":::
...
1. 在显示 Northwind 品牌图像的图像磁贴上选择“配置”  。 
    ...
    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/brand-image-edit.png" alt-text="Azure IoT Central 编辑品牌图像。":::
...
1. 选择“更新”
    ...
    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/brand-image-save.png" alt-text="Azure IoT Central 保存品牌图像。":::
...
1. 选择“更新”。
    ...
    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/store-map-save.png" alt-text="Azure IoT Central 保存商店地图。":::
...
1. 选择省略号和“删除”以删除以下磁贴：“返回到所有区域”、“访问商店仪表板”、“占用”、“预热结帐区域”、“冷却结帐区域”、“占用传感器设置”、“恒温器传感器设置”和“环境情况”以及与“结帐 3”关联的所有三个磁贴           。 Contoso 商店仪表板不使用这些磁贴。 

    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/delete-tiles.png" alt-text="Azure IoT Central 删除磁贴。":::
...
1. 查看布局更改。 
    ...
    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/firmware-battery-tiles.png" alt-text="Azure IoT Central 固件电池磁贴。":::
...
1. 选择“合并”  。 
    ...
    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/add-zone1-ruuvi.png" alt-text="Azure IoT Central 添加 RuuviTag 磁贴 1。":::
...
1. 选择“保存”。  仪表板显示两个新磁贴中的区域遥测数据。
    ...
    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/all-ruuvitag-tiles.png" alt-text="Azure IoT Central 所有 RuuviTag 磁贴。":::
...
1. 选择“保存”。   更新的仪表板仅显示两个结帐区域的计数，这些区域基于模拟占用传感器。
    ...
    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/people-traffic-two-lanes.png" alt-text="Azure IoT Central 人员流向两个通道。":::
...
1. 选择“保存”。   
    ...
    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/add-ruuvi-property-tiles.png" alt-text="Azure IoT Central RuuviTag 属性磁贴。":::
...
1. 查看已完成的 Contoso 仪表板。 
    ...
    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/completed-dashboard.png" alt-text="Azure IoT Central 完成仪表板自定义。":::
