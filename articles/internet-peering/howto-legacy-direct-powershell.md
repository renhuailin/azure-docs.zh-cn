...
如果需要，可以使用 Azure [门户](howto-legacy-direct-portal.md)完成本指南。
...
### <a name="get-a-legacy-direct-peering-for-conversion"></a><a name= get></a>获取用于转换的旧版直接对等互连
...
&nbsp;
> [!IMPORTANT]
> 将旧版直接对等互连转换为 Azure 资源时，不支持修改。 &nbsp;

使用这条命令可将旧版直接对等互连转换为 Azure 资源：
