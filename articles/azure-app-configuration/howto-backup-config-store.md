...
使用以下命令或 [Azure 门户](../storage/blobs/assign-azure-role-data-access.md#assign-an-azure-role)向函数应用的托管标识授予对队列的访问权限。 在队列中分配 `Storage Queue Data Contributor` 角色。
