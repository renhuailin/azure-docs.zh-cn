...
+ 丰富索引编制、[文本分析](search-analyzers.md)以及用于提取和转换高级内容的[可选 AI 扩充](cognitive-search-concept-intro.md)
