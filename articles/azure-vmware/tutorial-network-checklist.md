...
Azure VMware 解决方案私有云要求至少对子网使用 CIDR 网络地址块 `/22`，如下所示。 此网络将补充你的本地网络。 地址块不应与订阅和本地网络中的其他虚拟网络中使用的地址块重叠。 在此地址块中，管理、配置和 VMotion 网络会自动进行预配。
