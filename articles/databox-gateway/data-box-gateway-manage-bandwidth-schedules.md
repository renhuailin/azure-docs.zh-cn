...
3. 进行所需的更改并保存更改。
    ...
    ![修改用户 2](media/data-box-gateway-manage-bandwidth-schedules/modify-schedule-2.png)

4. 修改计划后，计划列表将会更新，以反映修改后的计划。

    ![修改用户 3](media/data-box-gateway-manage-bandwidth-schedules/modify-schedule-3.png)
