---
title: 跨可用性区域对 VM 进行负载均衡 - Azure CLI - Azure 负载均衡器
...
| [az network lb rule create](/cli/azure/network/lb/rule#az_network_lb_rule_create) | 创建负载均衡器规则。 在此示例中，为端口 80 创建一个规则。 HTTP 流量在到达负载均衡器时，会路由到已负载均衡的集中包括的 VM 的端口 80。 |
