...
1. 在源设备上访问 SMB 共享将使用 IP 地址，而在目标设备上，将使用设备名称。 请参阅[连接到 Azure Stack Edge Pro GPU 上的 SMB 共享](./azure-stack-edge-gpu-deploy-add-shares.md#connect-to-an-smb-share)。 若要在目标设备上连接到 NFS 共享，需要使用与该设备关联的新 IP 地址。 请参阅[连接到 Azure Stack Edge Pro GPU 上的 NFS 共享](./azure-stack-edge-gpu-deploy-add-shares.md#connect-to-an-nfs-share)。 
...
- [IoT Edge 运行时错误](azure-stack-edge-gpu-troubleshoot-iot-edge.md)。
