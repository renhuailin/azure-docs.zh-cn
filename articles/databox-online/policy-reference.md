---
title: Azure Stack 边缘的内置策略定义
description: 列出 Azure Stack Edge 的 Azure 策略内置策略定义。 这些内置的策略定义提供了管理 Azure 资源的常用方法。
ms.date: 02/09/2021
ms.topic: reference
...
ms.locfileid: "100099281"
---
# <a name="azure-policy-built-in-definitions-for-azure-stack-edge"></a>Azure Stack Edge 的 Azure 策略内置定义

此页是 Azure Stack 边缘的 [Azure 策略](../governance/policy/overview.md) 内置策略定义的索引。 有关其他服务的其他 Azure Policy 内置定义，请参阅 [Azure Policy 内置定义](../governance/policy/samples/built-in-policies.md)。
