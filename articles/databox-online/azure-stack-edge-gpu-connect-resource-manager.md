...
在开始之前，请确保用于通过 Azure 资源管理器连接到设备的客户端使用的是 TLS 1.2。 有关详细信息，请转到[在访问 Azure Stack Edge Pro 设备的 Windows 客户端上配置 TLS 1.2](azure-stack-edge-gpu-configure-tls-settings.md)。
