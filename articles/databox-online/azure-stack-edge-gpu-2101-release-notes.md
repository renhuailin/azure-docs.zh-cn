...
- **正式发布 Azure Stack Edge Pro R 和 Azure Stack Edge Mini R 设备** - 从此发布版本开始，将可以使用 Azure Stack Edge pro R 和 Azure Stack Edge Mini R 设备。 有关详细信息，请参阅[什么是 Azure Stack Edge Pro R](azure-stack-edge-j-series-overview.md) 以及[什么是 Azure Stack Edge Mini R](azure-stack-edge-k-series-overview.md)。  
