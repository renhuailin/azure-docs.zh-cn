---
title: Azure Stack Edge Pro FPGA 限制 | Microsoft Docs
description: 了解部署和操作 Azure Stack Edge Pro FPGA 时的限制和建议大小，包括服务限制、设备限制和存储限制。
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
ms.locfileid: "110080949"
---
# <a name="azure-stack-edge-pro-fpga-limits"></a>Azure Stack Edge Pro FPGA 限制

在部署和操作 Microsoft Azure Stack Edge Pro FPGA 解决方案时请考虑这些限制。 
...
下表介绍了 Azure Stack Edge Pro FPGA 设备的限制。 
