...
description: 了解如何通过 Azure Cloud Shell 在浏览器中使用 Bash 命令行。
author: maertendMSFT
manager: timlt
...
![展示了如何在 Azure 门户中启动 Azure Cloud Shell 的屏幕截图。](media/quickstart/shell-icon.png)
...
![展示了如何为 Azure Cloud Shell 选择 Bash 环境的屏幕截图。](media/quickstart/env-selector.png)
...
2. 单击“连接”以获取 VM 名称和公共 IP 地址。 <br>
   ![展示了如何使用 SSH 连接到 Linux VM 的屏幕截图。](media/quickstart/sshcmd-copy.png)
...
![展示了在建立 SSH 连接后显示的 Ubuntu 初始化和欢迎提示的屏幕截图。](media/quickstart/ubuntu-welcome.png)
