...
-   若要注册新应用程序，请导航到 <a href="https://portal.azure.com/" target="_blank">Azure 门户</a>。
...
| 支持的帐户类型| 选择希望应用程序支持的帐户：仅限此组织目录中的帐户、任何组织目录中的帐户，或者任何组织目录中的帐户和 Microsoft 个人帐户。  |
