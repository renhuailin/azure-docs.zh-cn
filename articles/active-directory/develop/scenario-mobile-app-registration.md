...
1. 在 <a href="https://portal.azure.com/" target="_blank">Azure 门户 <span class="docon docon-navigate-external x-hidden-focus"></span></a>中，选择你的应用程序，**应用注册**"，然后选择"**身份验证**"。
