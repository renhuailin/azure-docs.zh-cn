---
title: 快速入门：使用授权代码在 JavaScript React 单页应用 (SPA) 中让用户登录并调用 Microsoft Graph | Azure
titleSuffix: Microsoft identity platform
description: 在本快速入门中，学习 JavaScript React 单页应用程序 (SPA) 如何通过授权代码流让用户使用个人帐户、工作帐户和学校帐户登录，以及如何调用 Microsoft Graph。
...
>
> 1. 转到 <a href="https://portal.azure.com/#blade/Microsoft_AAD_RegisteredApps/ApplicationsListBlade/quickStartType/ReactSpaQuickstartPage/sourceType/docs" target="_blank">Azure 门户 - 应用注册</a>快速入门体验。
> 1. 输入应用程序的名称。
...
> [!div renderon="docs"]
> 若要使用 Node.js 在 Web 服务器中运行项目，请[下载核心项目文件](https://github.com/Azure-Samples/ms-identity-javascript-react-spa/archive/main.zip)。

> [!div renderon="portal" class="sxs-lookup"]
> 使用 Node.js 在 Web 服务器中运行项目

> [!div renderon="portal" class="sxs-lookup" id="autoupdate" class="nextstepaction"]
> [下载代码示例](https://github.com/Azure-Samples/ms-identity-javascript-react-spa/archive/main.zip)

> [!div renderon="docs"]
> #### <a name="step-3-configure-your-javascript-app"></a>步骤 3：配置 JavaScript 应用
>
> 在 src 文件夹中打开 authConfig.js 文件，并更新 `msalConfig` 对象中的 `clientID`、`authority` 和 `redirectUri` 值 。
>
> ```javascript
> /**
...
1. 选择“登录”以启动登录过程，然后调用该 Microsoft Graph API。
    ...
    首次登录时，系统会提示你允许应用程序访问你的个人资料并将你登录。 成功登录后，单击“请求个人资料信息”，在页面上调出你的个人资料信息。
