...
| 前通道注销 URL | 允许 https://localhost <br><br> 不允许 `http` 方案 <br><br> 最大长度为 255 个字符 | 允许 https://localhost <br><br> 不允许 `http` 方案 <br><br> 最大长度为 255 个字符 | <br><br> 允许使用 https://localhost ，对于 MSA， http://localhost 失败 <br><br> 最大长度为 255 个字符 <br><br> 不允许 `http` 方案 <br><br> 不支持通配符 | 
