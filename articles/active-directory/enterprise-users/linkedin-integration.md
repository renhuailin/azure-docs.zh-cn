...
> 异常：
>
> * 此设置不适用于使用美国政府、Microsoft 云德国或 Azure 的 Microsoft 云的客户，以及中国世纪互联运营的 Microsoft 365。
...
此组策略只会影响本地计算机上的 Office 2016 应用。 如果用户在其 Office 2016 应用中禁用 LinkedIn，它们仍可在 Microsoft 365 中看到 LinkedIn 功能。
