...
### <a name="step-2-configure-the-proxy-server-manually-using-netsh-command"></a>步骤 2：使用 netsh 命令手动配置代理服务器
...
> [!NOTE]
> 在操作系统中配置 internet 代理有多种方法。 通过 NETSH WINHTTP 配置的代理设置 (运行 `NETSH WINHTTP SHOW PROXY` 来验证) 是否替代在步骤2中配置的代理设置。 
