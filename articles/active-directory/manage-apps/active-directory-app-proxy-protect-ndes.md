...
1. 在安装期间，系统会提示将连接器注册到 Azure AD 目录的应用程序代理。
   ...
   * 如果为安装连接器的服务器启用“IE 增强安全配置”，则可能无法显示注册屏幕。 那么，请按照错误消息中的说明进行操作，或在安装过程中关闭“IE 增强安全性”设置，方可显示注册屏幕。
...
1. 将提供的 NDES URL（通过 Microsoft Intune）更改为设备。 此更改可能在 Microsoft Endpoint Configuration Manager 或 Microsoft Endpoint Manager 管理中心中。
