...
description: 了解如何重定向使用 Azure AD 应用程序代理发布的应用的硬编码链接。
...
ms.locfileid: "108169004"
---
# <a name="redirect-hard-coded-links-for-apps-published-with-azure-ad-application-proxy"></a>重定向使用 Azure AD 应用程序代理发布的应用的硬编码链接
