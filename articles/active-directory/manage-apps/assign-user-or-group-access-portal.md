...
- 适用于基于组的分配的 Azure Active Directory Premium P1 或 P2 版。 有关本文中讨论的功能的其他许可要求，请参阅 [Azure Active Directory 定价页](https://azure.microsoft.com/pricing/details/active-directory)。
...
1. 以提升的权限打开 Windows PowerShell 命令提示符。
1. 运行 `Connect-AzureAD` 并使用全局管理员用户帐户登录。 使用以下脚本将用户和角色从应用程序中删除：
