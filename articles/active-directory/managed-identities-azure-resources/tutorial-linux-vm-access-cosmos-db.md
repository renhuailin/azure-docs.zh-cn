...
- 若要运行示例脚本，有两个选项：
    ...
    - 通过安装最新版的 [Azure CLI](/cli/azure/install-azure-cli) 在本地运行脚本，然后使用 [az login](/cli/azure/reference-index#az_login) 登录到 Azure。 使用与要在其中创建资源的 Azure 订阅关联的帐户。
