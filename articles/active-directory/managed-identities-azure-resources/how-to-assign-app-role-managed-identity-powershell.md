...
## <a name="use-azure-ad-to-assign-a-managed-identity-access-to-another-applications-app-role"></a>使用 Azure AD 将托管标识访问权限分配给另一个应用程序的应用程序角色
...
1. 将应用程序角色分配给托管标识。 你将需要以下信息来分配应用程序角色：
    ...
    * `serverApplicationObjectId`：在步骤4中找到的服务器应用程序服务主体的对象 ID。
