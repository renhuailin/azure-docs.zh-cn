...
## <a name="perform-access-review-using-my-access-new"></a>使用“我的访问权限”（新）执行访问评审

可通过以下几种不同的方式，使用更新的“我的访问权限”用户界面来获取新的审阅者体验：

### <a name="my-apps-portal"></a>“我的应用”门户

1. 在 [https://myapps.microsoft.com](https://myapps.microsoft.com) 登录“我的应用”。
...
![应用和组的待处理访问评审列表，其中显示预览版期间“新体验现在可用”横幅](./media/perform-access-review/banner.png)

3. 单击页面顶部横幅中的“试用！” 。 这会将你转到新的“我的访问权限”体验。
...
### <a name="navigate-to-my-access-directly"></a>直接导航到“我的访问权限”
...
打开后，你将看到访问评审范围内的用户列表。 如果请求是评审你自己的访问权限，则页面内容会有所不同。 有关详细信息，请参阅[评审自己对组或应用程序的访问权限](review-your-access.md)。
...
3. 在上方的栏中选择“批准”或“拒绝” 。
    ...
    ![打开访问评审，其中会列出需要评审的用户](./media/perform-access-review/user-list-preview.png)
