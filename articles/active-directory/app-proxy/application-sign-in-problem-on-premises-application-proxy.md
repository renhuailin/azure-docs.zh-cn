---
title: 使用 Azure Active Directory 应用程序代理登录本地应用时出现问题
description: 排查无法使用 Azure Active Directory 应用程序代理登录集成的本地应用程序时所遇到的常见问题
...
ms.locfileid: "108227085"
---
# <a name="problems-signing-in-to-an-on-premises-application-using-the-azure-active-directory-application-proxy"></a>使用 Azure Active Directory 应用程序代理登录本地应用程序时遇到问题
