---
title: Azure Active Directory 应用程序代理的安全注意事项
...
ms.locfileid: "108185811"
---
# <a name="security-considerations-for-accessing-apps-remotely-with-azure-active-directory-application-proxy"></a>使用 Azure Active Directory 应用程序代理远程访问应用时的安全注意事项
...
通过应用程序代理发布的应用程序受到保护，以免遭分布式拒绝服务 (DDoS) 攻击。 此防护由 Microsoft 管理，并在我们的所有数据中心中自动启用。 Azure DDoS 防护服务提供始终可用的流量监视以及对常见网络级别攻击的实时缓解功能。 
