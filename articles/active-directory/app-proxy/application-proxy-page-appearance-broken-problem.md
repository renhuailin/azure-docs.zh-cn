---
title: 应用程序代理应用的应用页无法正确显示
description: 已与 Azure Active Directory 集成的应用程序代理中的页面未正确显示时的相关指导
...
[使用 Azure AD 应用程序代理发布应用程序](../app-proxy/application-proxy-add-on-premises-application.md)
