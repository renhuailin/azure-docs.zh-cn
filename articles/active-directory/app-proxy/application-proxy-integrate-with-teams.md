---
title: 通过 Teams 访问 Azure Active Directory 应用程序代理应用程序
description: 使用 Azure Active Directory 应用程序代理通过 Microsoft Teams 访问本地应用程序。
...
ms.locfileid: "108229822"
---
# <a name="access-your-on-premises-applications-through-microsoft-teams-with-azure-active-directory-application-proxy"></a>使用 Azure Active Directory 应用程序代理通过 Microsoft Teams 访问本地应用程序
...
如果尚未执行，请[为租户配置应用程序代理并安装连接器](../app-proxy/application-proxy-add-on-premises-application.md)。 然后发布进行远程访问的本地应用程序。 发布应用时，请记下外部 URL，用于将应用添加到 Teams。
...
1. 导航到想要添加此应用的 Teams 通道，并选择“+”添加选项卡。
   ...
   ![选择“+”以在 Teams 中添加选项卡](./media/application-proxy-integrate-with-teams/add-tab.png)

1. 从选项卡选项中选择“网站”。

   ![在“添加选项卡”屏幕中选择“网站”](./media/application-proxy-integrate-with-teams/website.png)
