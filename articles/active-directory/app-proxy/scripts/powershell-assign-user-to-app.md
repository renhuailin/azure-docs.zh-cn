---
title: PowerShell 示例 - 将用户分配给 Azure Active Directory 应用程序代理应用
...
ms.locfileid: "108293631"
---
# <a name="assign-a-user-to-a-specific-azure-active-directory-application-proxy-application"></a>将用户分配给特定的 Azure Active Directory 应用程序代理应用程序
