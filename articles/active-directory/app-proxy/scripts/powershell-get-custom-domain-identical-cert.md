---
title: PowerShell 示例 - 具有相同证书的 Azure Active Directory 应用程序代理应用
...
ms.locfileid: "108293635"
---
# <a name="get-all-azure-active-directory-application-proxy-apps-that-are-published-with-the-identical-certificate"></a>获取使用相同证书发布的所有 Azure Active Directory 应用程序代理应用
