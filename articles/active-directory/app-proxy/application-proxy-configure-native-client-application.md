---
title: 发布本机客户端应用 - Azure Active Directory
description: 介绍如何使本机客户端应用能够与 Azure Active Directory 应用程序代理连接器通信，来提供对本地应用的安全远程访问。
...
ms.author: kenwith
ms.reviewer: japere
ms.openlocfilehash: 9208a36e3fa863dc7c9577f93f4614d8c4c1839f
ms.sourcegitcommit: 516eb79d62b8dbb2c324dff2048d01ea50715aa1
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/28/2021
ms.locfileid: "108186106"
---
...
像发布任何其他应用程序一样发布代理应用程序，并分配可访问该应用程序的用户。 有关详细信息，请参阅[使用应用程序代理发布应用程序](../app-proxy/application-proxy-add-on-premises-application.md)。
...
了解如何[在 Azure Active Directory 中设置应用程序的单一登录](../manage-apps/sso-options.md#choosing-a-single-sign-on-method)。