---
title: 声明感知应用 - Azure Active Directory 应用程序代理
description: 如何发布接受 AD FS 声明允许用户进行安全远程访问的本地 ASP.NET 应用程序。
...
1. 根据[使用应用程序代理发布应用程序](../app-proxy/application-proxy-add-on-premises-application.md)中的说明发布应用程序。
