...
使用内置策略的 B2C 手机注册和登录可让组织的 IT 管理员和开发人员允许最终用户使用用户流中的电话号码进行登录和注册。 有关详细信息，请参阅为 [用户流 (预览设置电话注册和登录) ](../../active-directory-b2c/phone-authentication-user-flows.md) 。
