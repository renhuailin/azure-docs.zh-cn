...
你现在可以直接从我的访问门户启动团队。 为此，请登录到 ["我的访问](https://myaccess.microsoft.com/)"，导航到 " **访问包**"，然后转到 " **活动** " 选项卡以查看你有权访问的所有访问包。 展开访问包并将鼠标悬停在团队中时，可以通过单击 " **打开** " 按钮启动该访问包。 
