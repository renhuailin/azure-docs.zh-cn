...
- 如果用户的电子邮件地址 (通常是 @outlook.com ，但并非始终) ，则无法注册 Azure AD 多重身份验证。 如果想要将角色分配给使用 Microsoft 帐户的用户，应将其设置为永久管理员，或者为该角色禁用多重身份验证。
- 对于 Azure AD 和 Microsoft 365，不能禁用高特权角色 Azure AD 多重身份验证。 此安全功能有助于保护以下角色：  
