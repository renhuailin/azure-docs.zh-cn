...
2. 在“管理选项”下选择“首选项”。  
    ...
    ![显示选择了“首选项”的“管理选项”的屏幕截图。](./media/timelive-tutorial/configure1.png)

3. 在“应用程序首选项”  部分中，执行以下步骤：
    
    ![显示可以在其中输入所述值“应用程序首选项”部分的屏幕截图。](./media/timelive-tutorial/configure2.png)
...
在访问面板中单击“TimeLive”磁贴时，应会自动登录到设置了 SSO 的 TimeLive。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)（访问面板简介）。
