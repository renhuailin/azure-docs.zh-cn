---
title: 教程：Azure Active Directory 与 Stormboard 的集成 | Microsoft Docs
description: 了解如何在 Azure Active Directory 与 Stormboard 之间配置单一登录。
...
本教程介绍如何将 Stormboard 与 Azure Active Directory (Azure AD) 集成。
将 Stormboard 与 Azure AD 集成可提供以下优势：

* 可以在 Azure AD 中控制谁有权访问 Stormboard。
...
若要配置 Azure AD 与 Stormboard 的集成，需要准备好以下各项：

* 一个 Azure AD 订阅。 如果你没有 Azure AD 环境，可以在[此处](https://azure.microsoft.com/pricing/free-trial/)获取一个月的试用版。
* 已启用 Stormboard 单一登录的订阅
...
若要配置 Stormboard 与 Azure AD 的集成，需要从库中将 Stormboard 添加到托管 SaaS 应用列表。

**若要从库中添加 Stormboard，请执行以下步骤：**
...
在本部分，我们基于名为 **Britta Simon** 的测试用户来配置并测试 Stormboard 的 Azure AD 单一登录。
若要正常使用单一登录，需要在 Azure AD 用户与 Stormboard 相关用户之间建立链接关系。

若要配置并测试 Stormboard 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[配置 Stormboard 单一登录](#configure-stormboard-single-sign-on)** - 在应用程序端配置单一登录。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[创建 Stormboard 测试用户](#create-stormboard-test-user)** - 在 Stormboard 中创建 Britta Simon 的对应用户，并将其关联到其在 Azure AD 中的表示形式。
...
若要配置 Stormboard 的 Azure AD 单一登录，请执行以下步骤：

1. 在 [Azure 门户](https://portal.azure.com/)中的“Stormboard”应用程序集成页上，选择“单一登录”。  
...
7. 在“设置 Stormboard”部分，根据要求复制相应的 URL  。
...
### <a name="configure-stormboard-single-sign-on"></a>配置 Stormboard 单一登录

若要在 **Stormboard** 端配置单一登录，需要将下载的“证书(Base64)”以及从 Azure 门户复制的相应 URL 发送给 [Stormboard 支持团队](mailto:support@stormboard.com)。  他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
...
在本部分，我们通过授予 Britta Simon 访问 Stormboard 的权限，使其能够使用 Azure 单一登录。

1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”、“Stormboard”。   

    ![“企业应用程序”边栏选项卡](common/enterprise-applications.png)

2. 在“应用程序”列表中，选择“Stormboard”  。

    ![“应用程序”列表中的“Stormboard”链接](common/all-applications.png)
