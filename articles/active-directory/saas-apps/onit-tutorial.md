...
## <a name="add-onit-from-the-gallery"></a>从库中添加 Onit
...
## <a name="configure-and-test-azure-ad-sso-for-onit"></a>配置并测试 Onit 的 Azure AD SSO

使用名为 **B.Simon** 的测试用户配置和测试 Onit 的 Azure AD SSO。 若要运行 SSO，需要在 Azure AD 用户与 Onit 相关用户之间建立链接关系。

若要配置并测试 Onit 的 Azure AD SSO，请执行以下步骤：
...
1. 在 Azure 门户的“Onit”应用程序集成页上，找到“管理”部分，选择“单一登录”。
...
1. 在“基本 SAML 配置”部分中，按照以下步骤操作：
    ...
    a. 在“标识符(实体 ID)”文本框中，使用以下模式键入 URL：`https://<SUBDOMAIN>.onit.com`

    b. 在“登录 URL”文本框中，使用以下模式键入 URL：`https://<SUBDOMAIN>.onit.com` 
...
3. 单击“编辑公司”。 
    ...
    ![编辑公司](./media/onit-tutorial/corporation.png "编辑公司")
   
4. 单击“安全”选项卡。 
    
    ![编辑公司信息](./media/onit-tutorial/security.png "编辑公司信息")

5. 在“安全”选项卡中，执行以下步骤： 

    ![单一登录](./media/onit-tutorial/configuration.png "单一登录")
...
3. 在“添加用户”对话框页上，执行以下步骤： 
    ...
    ![添加用户](./media/onit-tutorial/create-user.png "添加用户")
...
* 在 Azure 门户中单击“测试此应用程序”。 这会重定向到 Onit 登录 URL，并从那里启动登录流。 
