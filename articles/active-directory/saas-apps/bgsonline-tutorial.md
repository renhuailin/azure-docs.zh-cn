...
* 可以让用户使用其 Azure AD 帐户自动登录到 BGS Online（单一登录）。
...
### <a name="configure-bgs-online-single-sign-on"></a>配置 BGS Online 单一登录

若要在 **BGS Online** 端配置单一登录，需要将下载的“联合元数据 XML”以及从 Azure 门户复制的相应 URL 发送给 [BGS Online 支持团队](mailto:bgsdashboardteam@millwardbrown.com)。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
...
### <a name="create-bgs-online-test-user"></a>创建 BGS Online 测试用户

在本部分中，在 BGS Online 中创建名为 Britta Simon 的用户。 与 [BGS Online 支持团队](mailto:bgsdashboardteam@millwardbrown.com)协作，将此用户添加到 BGS Online 平台中。 使用单一登录前，必须先创建并激活用户。

### <a name="test-single-sign-on"></a>测试单一登录

在本部分中，使用访问面板测试 Azure AD 单一登录配置。

单击访问面板中的 BGS Online 磁贴时，应会自动登录到为其设置了 SSO 的 BGS Online。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)（访问面板简介）。
