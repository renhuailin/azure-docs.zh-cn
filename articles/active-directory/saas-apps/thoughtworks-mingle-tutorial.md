...
单击访问面板中的 Thoughtworks Mingle 磁贴时，应当会自动登录到为其设置了 SSO 的 Thoughtworks Mingle。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)（访问面板简介）。
