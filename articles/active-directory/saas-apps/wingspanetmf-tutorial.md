...
在本部分中，会在 Wingspan eTMF 中创建一个名为 Britta Simon 的用户。 与 [Wingspan eTMF 支持团队](https://www.wingspan.com/contact-us/)协作，在 Wingspan eTMF 平台中添加用户。 使用单一登录前，必须先创建并激活用户。
