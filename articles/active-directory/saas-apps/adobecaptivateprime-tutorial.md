...
本教程介绍了如何将 Adobe Captivate Prime 与 Azure Active Directory (Azure AD) 集成。 将 Adobe Captivate Prime 与 Azure AD 集成后，你可以：

* 在 Azure AD 中控制谁有权访问 Adobe Captivate Prime。
...
* Adobe Captivate Prime 单一登录 (SSO) 启用的订阅。
...
## <a name="add-adobe-captivate-prime-from-the-gallery"></a>从库中添加 Adobe Captivate Prime
...
1. 在“从库中添加”部分的搜索框中，键入“Adobe Captivate Prime” 。
1. 从结果面板中选择“Adobe Captivate Prime”，然后添加该应用程序。 在该应用添加到租户时等待几秒钟。

## <a name="configure-and-test-azure-ad-sso-for-adobe-captivate-prime"></a>配置和测试 Adobe Captivate Prime 的 Azure AD SSO

使用名为 B.Simon 的测试用户配置和测试 Adobe Captivate Prime 的 Azure AD SSO。 若要正常运行 SSO，你需要在 Azure AD 用户与 Adobe Captivate Prime 相关用户之间建立链接关系。

若要配置并测试 Adobe Captivate Prime 的 Azure AD SSO，请执行以下步骤：

1. **[配置 Azure AD SSO](#configure-azure-ad-sso)** - 使用户能够使用此功能。
    1. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 B. Simon 测试 Azure AD 单一登录。
    1. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 B. Simon 能够使用 Azure AD 单一登录。
1. [配置 Adobe Captivate Prime SSO](#configure-adobe-captivate-prime-sso)：在应用程序端配置单一登录设置。
    1. [创建 Adobe Captivate Prime 测试用户](#create-adobe-captivate-prime-test-user)：在 Adobe Captivate Prime 中创建 B.Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
1. 在 Azure 门户的“Adobe Captivate Prime”应用程序集成页上，找到“管理”部分，选择“单一登录”。  
...
7. 转到“属性”选项卡，复制“用户访问 URL”并将其粘贴在记事本中。
    ...
    ![用户访问链接](./media/adobecaptivateprime-tutorial/adobe.png)
...
在本部分中，通过向 B.Simon 授予对 Adobe Captivate Prime 的访问权限，允许对方使用 Azure 单一登录。

1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”。 
1. 在应用程序列表中，选择“Adobe Captivate Prime”。
...
## <a name="configure-adobe-captivate-prime-sso"></a>配置 Adobe Captivate Prime SSO
