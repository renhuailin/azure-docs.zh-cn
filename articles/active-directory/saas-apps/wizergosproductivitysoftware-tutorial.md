...
2. 从汉堡菜单上，选择“管理员”  。
    ...
    ![屏幕截图显示从菜单选择了“管理员”图标。](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_000.png)

3. 在左侧菜单的“管理员”页中，选择“身份验证”  ，并单击“Azure AD”  。

    ![屏幕截图显示从“身份验证”选择了“Azure AD”。](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_002.png)

4. 在“身份验证”  部分执行以下步骤。

    ![屏幕截图显示了“身份验证”页，可在其中输入所述值。](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_003.png)
...
在访问面板中单击“Wizergos Productivity Software”磁贴时，应会自动登录到设置了 SSO 的 Wizergos Productivity Software。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)（访问面板简介）。
