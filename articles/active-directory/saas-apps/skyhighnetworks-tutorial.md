...
## <a name="add-mvision-cloud-azure-ad-sso-configuration-from-the-gallery"></a>从库中添加 MVISION Cloud Azure AD SSO 配置
...
## <a name="configure-and-test-azure-ad-sso-for-mvision-cloud-azure-ad-sso-configuration"></a>配置并测试 MVISION Cloud Azure AD SSO 配置的 Azure AD SSO
...
若要配置并测试 MVISION Cloud Azure AD SSO 配置的 Azure AD SSO，请执行以下步骤：
...
在本部分中，通过授予 B.Simon 访问 MVISION Cloud Azure AD SSO 配置的权限，允许对方使用 Azure 单一登录。

1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”。 
1. 在应用程序列表中，选择“MVISION Cloud Azure AD SSO 配置”。
...
* 在 Azure 门户中单击“测试此应用程序”。 这会重定向到 MVISION Cloud Azure AD SSO 配置登录 URL，你可以从此处启动登录流。  

* 直接转到 MVISION Cloud Azure AD SSO 配置登录 URL，并从此次启动登录流。

#### <a name="idp-initiated"></a>IDP 启动的：

* 在 Azure 门户中单击“测试此应用程序”后，应自动登录到为其设置 SSO 的 MVISION Cloud Azure AD SSO 配置。 

还可以使用 Microsoft“我的应用”在任何模式下测试此应用程序。 在“我的应用”中单击“MVISION Cloud Azure AD SSO 配置”磁贴时，如果是在 SP 模式下进行配置，系统会重定向到应用程序登录页面来启动登录流；如果是在 IDP 模式下进行配置，则应会自动登录到为其设置 SSO 的 MVISION Cloud Azure AD SSO 配置。 有关“我的应用”的详细信息，请参阅[“我的应用”简介](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)。
