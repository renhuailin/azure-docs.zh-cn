...
1. 在“E Sales Manager Remix 域和 URL”下，执行以下操作：
    ...
    a. 在“登录 URL”框中，键入采用以下格式的 URL： https://\<Server-Based-URL>/\<sub-domain>/esales-pc。

    b. 在“标识符”框中，键入采用以下格式的 URL： https://\<Server-Based-URL>/\<sub-domain>/。
...
1. 在“E Sales Manager Remix 配置”下，选择“配置 E Sales Manager Remix”。
    ...
    ![屏幕截图显示选中了“配置 E Sales Manager Remix”的“E Sales Manager Remix 配置”部分。](./media/esalesmanagerremix-tutorial/tutorial_esalesmanagerremix_configure.png) 
