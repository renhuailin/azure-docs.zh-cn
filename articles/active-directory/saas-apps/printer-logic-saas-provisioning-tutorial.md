...
### <a name="to-configure-automatic-user-provisioning-for-printerlogic-saas-in-azure-ad"></a>若要在 Azure AD 中配置 PrinterLogic SaaS 的自动用户预配：
...
10. 在 " **映射** " 部分下，选择 " **将 Azure Active Directory 组同步到 PrinterLogic SaaS**"。
