...
## <a name="configure-and-test-azure-ad-sso-for-appneta-performance-monitor"></a>配置并测试 AppNeta Performance Monitor 的 Azure AD SSO
...
若要配置并测试 AppNeta Performance Monitor 的 Azure AD SSO，请执行以下步骤：
...
1. 在 Azure 门户中的 AppNeta Performance Monitor 应用程序集成页上，找到“管理”部分，并选择“单一登录”  。
...
* 在 Azure 门户中单击“测试此应用程序”。 此操作会重定向到 AppNeta Performance Monitor 登录 URL，你可在其中启动登录流。 
