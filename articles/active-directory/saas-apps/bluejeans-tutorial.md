...
* 你可使用 Microsoft 的“我的应用”。 单击“我的应用”中的 BlueJeans for Azure AD 磁贴时，将会重定向到 BlueJeans for Azure AD 登录 URL。 有关“我的应用”的详细信息，请参阅[“我的应用”简介](../user-help/my-apps-portal-end-user-access.md)。
