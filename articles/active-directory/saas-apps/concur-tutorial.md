...
若要配置并测试 Concur 的 Azure AD SSO，请执行以下步骤：
...
1. 在 Azure 门户的“Concur”应用程序集成页上，找到“管理”部分，选择“单一登录”  。
...
* 在 Azure 门户中单击“测试此应用程序”。 这会重定向到 Concur 登录 URL，可在其中启动登录流。 

* 直接转到 Concur 登录 URL，并从那里启动登录流。

* 你可使用 Microsoft 的“我的应用”。 单击“我的应用”中的 Concur 磁贴时，会重定向到 Concur 登录 URL。 有关“我的应用”的详细信息，请参阅[“我的应用”简介](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)。
