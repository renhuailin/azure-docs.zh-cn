---
title: 教程：用户预配 - LinkedIn Sales Navigator，Azure AD
...
4. 单击“+ 添加新的 SCIM 配置”并填写每个字段来完成该过程。
    ...
    ![屏幕截图显示 SCIM 设置页。](./media/linkedinsalesnavigator-provisioning-tutorial/linkedin_2.PNG)
...
10. 将“预配模式”  设置为“自动”  。
    ...
    ![屏幕截图显示 LinkedIn Elevate 预配页面。](./media/linkedinsalesnavigator-provisioning-tutorial/linkedin_3.PNG)

11. 在“管理员凭据”下填写以下字段：

    * 在“租户 URL”字段中，输入 https://developer.linkedin.com。
...
14. 在“属性映射”部分中，查看将从 Azure AD 同步到 LinkedIn Sales Navigator 的用户和组属性。 请注意，选为“匹配”属性的属性将用于匹配 LinkedIn Sales Navigator 中的用户帐户和组以执行更新操作。 选择“保存”按钮以提交任何更改。
    ...
    ![屏幕截图显示“映射”，包括“属性映射”。](./media/linkedinsalesnavigator-provisioning-tutorial/linkedin_4.PNG)
