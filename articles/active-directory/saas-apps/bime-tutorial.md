...
description: 了解如何在 Azure Active Directory 和 Bime 之间配置单一登录。
...
本教程介绍如何将 Bime 与 Azure Active Directory (Azure AD) 集成。
将 Bime 与 Azure AD 集成提供以下优势：

* 可在 Azure AD 中控制谁有权访问 Bime。
...
## <a name="adding-bime-from-the-gallery"></a>从库中添加 Bime

若要配置 Bime 与 Azure AD 的集成，需要从库中将 Bime 添加到托管 SaaS 应用列表。

**若要从库中添加 Bime，请执行以下步骤：**
...
在本部分中，基于名为“Britta Simon”的测试用户配置和测试 Bime 的 Azure AD 单一登录。 
若要运行单一登录，需要在 Azure AD 用户与 Bime 相关用户之间建立链接关系。

若要配置和测试 Bime 的 Azure AD 单一登录，需要完成以下构建基块：
...
若要配置 Bime 的 Azure AD 单一登录，请执行以下步骤：

1. 在 [Azure 门户](https://portal.azure.com/) Bime 应用程序集成页上，选择“单一登录”。
...
在本部分中，通过授予 Britta Simon 访问 Bime 的权限，允许她使用 Azure 单一登录。

1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”和“Bime”    。

    ![“企业应用程序”边栏选项卡](common/enterprise-applications.png)

2. 在应用程序列表中，选择“Bime”  。

    ![应用程序列表中的 Bime 链接](common/all-applications.png)
...
3. 在“用户列表”  中，单击“添加新用户”  (“+”)。
    ...
    ![用户](./media/bime-tutorial/ic775562.png "用户")

4. 在“用户详细信息”  对话框页上，执行以下步骤：

    ![用户详细信息](./media/bime-tutorial/ic775563.png "用户详细信息")
