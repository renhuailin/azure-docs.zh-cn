...
* 你可使用 Microsoft 的“我的应用”。 在“我的应用”中单击“Ungerboeck Software”磁贴时，会重定向到 Ungerboeck Software 登录 URL。 有关“我的应用”的详细信息，请参阅[“我的应用”简介](../user-help/my-apps-portal-end-user-access.md)。
