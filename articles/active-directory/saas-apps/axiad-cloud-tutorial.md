...
* 配置 Axiad Cloud 后，可以强制实施会话控制，实时防止组织的敏感数据外泄和渗透。 会话控制从条件访问扩展而来。 [了解如何通过 Microsoft Cloud App Security 强制实施会话控制](/cloud-app-security/proxy-deployment-any-app)。
...
在访问面板中单击“Axiad Cloud”磁贴时，应会自动登录到设置了 SSO 的 Axiad Cloud。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)（访问面板简介）。
...
- [如何使用高级可见性和控制保护 Axiad Cloud](/cloud-app-security/proxy-intro-aad)