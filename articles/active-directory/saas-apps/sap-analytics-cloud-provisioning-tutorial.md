...
从 Azure AD 应用程序库添加 SAP Analytics Cloud，开始管理 SAP Analytics Cloud 的预配。 如果以前为 SSO 设置过 SAP Analytics Cloud，则可以使用同一应用程序。 但建议你在最初测试集成时创建一个单独的应用。 可在[此处](../manage-apps/add-application-portal.md)详细了解如何从库中添加应用程序。 
