---
title: 教程：Azure Active Directory 单一登录 (SSO) 与 Resource Central 的集成 | Microsoft Docs
description: 了解如何在 Azure Active Directory 和 Resource Central 之间配置单一登录。
...
本教程介绍如何将 Resource Central 与 Azure Active Directory (Azure AD) 集成。 将 Resource Central 与 Azure AD 集成后，可以：

* 在 Azure AD 中控制谁有权访问 Resource Central。
* 支持用户使用其 Azure AD 帐户自动登录到 Resource Central。
...
* 已启用 Resource Central 单一登录 (SSO) 的订阅。

## <a name="scenario-description"></a>方案描述

本教程在测试环境中配置并测试 Azure AD SSO。

* Resource Central 支持 SP 发起的 SSO
...
使用名为 B.Simon 的测试用户配置和测试 Resource Central 的 Azure AD SSO。 若要使 SSO 有效，需要在 Azure AD 用户与 Resource Central 相关用户之间建立关联。

若要配置并测试 Resource Central 的 Azure AD SSO，请执行以下步骤：
...
1. 在 Azure 门户中的 Resource Central 应用程序集成页上，找到“管理”部分并选择“单一登录”  。
...
在本部分，你将通过授予 B.Simon 访问 Resource Central 的权限，使其能够使用 Azure 单一登录。
