---
title: 教程：Azure Active Directory 单一登录 (SSO) 与 Cornerstone Single Sign-On 集成 | Microsoft Docs
...
本教程介绍如何将 Cornerstone Single Sign-On 与 Azure Active Directory (Azure AD) 相集成。 将 Cornerstone Single Sign-On 与 Azure AD 集成后，可以：

* 在 Azure AD 中控制谁有权访问 Cornerstone Single Sign-On。
...
若要配置 Cornerstone Single Sign-On 与 Azure AD 的集成，需要从库中将 Cornerstone Single Sign-On 添加到托管 SaaS 应用列表。
...
## <a name="configure-and-test-azure-ad-sso-for-cornerstone-single-sign-on"></a>为 Cornerstone Single Sign-On 配置和测试 Azure AD SSO

使用名为 **B.Simon** 的测试用户配置并测试具有 Cornerstone Single Sign-On 的 Azure AD SSO。 若要运行 SSO，需要在 Azure AD 用户与 Cornerstone Single Sign-On 相关用户之间建立链接关系。

若要配置并测试具有 Cornerstone Single Sign-On 的 Azure AD SSO，请执行以下步骤：
...
在本部分中，通过授予 B.Simon 访问 Cornerstone Single Sign-On 的权限，允许其使用 Azure 单一登录。
...
* 在 Azure 门户中单击“测试此应用程序”。 这会重定向到 Cornerstone Single Sign-On 登录 URL，可在其中启动登录流。 

* 直接转到 Cornerstone Single Sign-On 登录 URL，并从中启动登录流。

* 你可使用 Microsoft 的“我的应用”。 在“我的应用”中单击“Cornerstone Single Sign-On”磁贴时，会重定向到“Cornerstone Single Sign-On 登录 URL”。 有关“我的应用”的详细信息，请参阅[“我的应用”简介](../user-help/my-apps-portal-end-user-access.md)。
