...
4. 如果要在 **IDP** 发起的模式下配置应用程序，请在“基本 SAML 配置”部分执行以下步骤：
    ...
    ![显示可在其中输入所述值的“基本 SAML 配置”的屏幕截图。](common/idp-relay.png)
...
在访问面板中单击“Zscaler Private Access Administrator”磁贴时，应该会自动登录到设置了 SSO 的 Zscaler Private Access Administrator 中。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md)（访问面板简介）。
