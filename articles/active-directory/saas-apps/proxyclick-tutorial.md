...
在访问面板中选择“Proxyclick”磁贴时，应会自动登录到设置了 SSO 的 Proxyclick 实例。 有关访问面板的详细信息，请参阅[在“我的应用”门户中访问和使用应用](../user-help/my-apps-portal-end-user-access.md)。
