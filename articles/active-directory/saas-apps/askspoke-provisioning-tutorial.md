...
### <a name="to-configure-automatic-user-provisioning-for-askspoke-in-azure-ad"></a>在 Azure AD 中为 askSpoke 配置自动用户预配：
...
10.   在“映射”部分下，选择“将 Azure Active Directory 组同步到 askSpoke” 。
