...
## <a name="add-surveymonkey-enterprise-from-the-gallery"></a>从库中添加 SurveyMonkey Enterprise
...
## <a name="configure-and-test-azure-ad-sso-for-surveymonkey-enterprise"></a>配置并测试 SurveyMonkey Enterprise 的 Azure AD SSO
...
若要配置并测试 SurveyMonkey Enterprise 的 Azure AD SSO，请执行以下步骤：
...
1. 在 Azure 门户的 SurveyMonkey Enterprise 应用程序集成页上，找到“管理”部分，然后选择“单一登录”  。
...
* 你可使用 Microsoft 的“我的应用”。 在“我的应用”中单击 SurveyMonkey Enterprise 磁贴时，应当会自动登录到已为其设置了 SSO 的 SurveyMonkey Enterprise。 有关“我的应用”的详细信息，请参阅[“我的应用”简介](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)。
