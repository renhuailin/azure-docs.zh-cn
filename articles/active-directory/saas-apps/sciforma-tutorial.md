...
在本教程中，了解如何将 Sciforma 与 Azure Active Directory (Azure AD) 集成。
将 Sciforma 与 Azure AD 集成具有以下优势：

* 可在 Azure AD 中控制谁有权访问 Sciforma。
* 可让用户使用其 Azure AD 帐户自动登录到 Sciforma（单一登录）。
...
若要配置 Azure AD 与 Sciforma 的集成，需要具有以下项：

* 一个 Azure AD 订阅。 如果你没有 Azure AD 环境，可以在[此处](https://azure.microsoft.com/pricing/free-trial/)获取一个月的试用版。
* 已启用 Sciforma 单一登录的订阅
...
4. 在“基本 SAML 配置”  部分中，按照以下步骤操作：
    ...
    > [!NOTE]
    > 这些不是实际值。 使用实际登录 URL 和标识符更新这些值。 请联系 [Sciforma 客户端支持团队](https://www.sciforma.com/about/contact)获取这些值。 还可以参考 Azure 门户中的“基本 SAML 配置”  部分中显示的模式。
...
单击访问面板中的 Sciforma 磁贴时，应会自动登录到为其设置了 SSO 的 Sciforma。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md)（访问面板简介）。
