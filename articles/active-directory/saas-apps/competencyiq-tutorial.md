...
在本部分，我们将在 CompetencyIQ 中创建名为 Britta Simon 的用户。 请与 [CompetencyIQ 支持团队](https://www.competencyiq.com/)协作，在 CompetencyIQ 平台中添加这些用户。 使用单一登录前，必须先创建并激活用户。

### <a name="test-single-sign-on"></a>测试单一登录 

在本部分中，使用访问面板测试 Azure AD 单一登录配置。

在访问面板中单击“CompetencyIQ”磁贴时，应会自动登录到设置了 SSO 的 CompetencyIQ。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)（访问面板简介）。
