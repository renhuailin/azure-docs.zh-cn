...
* 你可使用 Microsoft 的“我的应用”。 单击“我的应用”中的“Parkalot - Car park management”磁贴时，会重定向到 Parkalot - Car park management 登录 URL。 有关“我的应用”的详细信息，请参阅[“我的应用”简介](../user-help/my-apps-portal-end-user-access.md)。
