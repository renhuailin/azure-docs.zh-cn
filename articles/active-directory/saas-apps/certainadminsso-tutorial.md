...
* Certain Admin SSO 支持 **SP** 发起的 SSO
...
2. **[配置 Certain Admin SSO 单一登录](#configure-certain-admin-sso-single-sign-on)** - 在应用程序端配置单一登录设置。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[创建 Certain Admin SSO 测试用户](#create-certain-admin-sso-test-user)** - 在 Certain Admin SSO 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
4. 在“基本 SAML 配置”部分中，按照以下步骤操作：
    ...
    > [!NOTE]
    > 这些不是实际值。 使用实际登录 URL 和标识符更新这些值。 请联系 [Certain Admin SSO 客户端支持团队](mailto:integrations@certain.com)获取这些值。 还可以参考 Azure 门户中的“基本 SAML 配置”  部分中显示的模式。
...
### <a name="configure-certain-admin-sso-single-sign-on"></a>配置 Certain Admin SSO 单一登录

若要在 **Certain Admin SSO** 端配置单一登录，需要将下载的“证书(原始)”以及从 Azure 门户复制的相应 URL 发送给 [Certain Admin SSO 支持团队](mailto:integrations@certain.com)。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
...
### <a name="create-certain-admin-sso-test-user"></a>创建 Certain Admin SSO 测试用户
...
单击访问面板中的“Certain Admin SSO”磁贴时，应当会自动登录到已为其设置了 SSO 的 Certain Admin SSO。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)（访问面板简介）。
