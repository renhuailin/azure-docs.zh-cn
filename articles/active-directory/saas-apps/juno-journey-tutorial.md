---
title: 教程：Azure Active Directory 单一登录 (SSO) 与 Juno Journey 集成 | Microsoft Docs
...
ms.locfileid: "92459261"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-juno-journey"></a>教程：Azure Active Directory 单一登录 (SSO) 与 Juno Journey 集成
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-juno-journey"></a>配置并测试 Juno Journey 的 Azure AD 单一登录

使用名为 B.Simon 的测试用户配置和测试 Juno Journey 的 Azure AD SSO。 若要运行 SSO，需要在 Azure AD 用户与 Juno Journey 相关用户之间建立链接关系。

若要配置和测试 Juno Journey 的 Azure AD SSO，请完成以下构建基块：
...
1. 在 [Azure 门户](https://portal.azure.com/)的“Juno Journey”应用程序集成页上，找到“管理”部分，选择“单一登录”。
...
单击访问面板中的 Juno Journey 磁贴时，应会自动登录到设置了 SSO 的 Juno Journey。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md)（访问面板简介）。
...
- [通过 Azure AD 试用 Juno Journey](https://aad.portal.azure.com/)