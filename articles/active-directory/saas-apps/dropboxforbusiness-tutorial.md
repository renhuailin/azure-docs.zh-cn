...
若要配置和测试 Dropbox Business 的 Azure AD SSO，请完成以下构建基块：
...
1. 在 [Azure 门户](https://portal.azure.com/)的“Dropbox Business”应用程序集成页上，找到“管理”部分，选择“单一登录”  。
...
在本部分中，通过授予 Britta Simon 访问 Dropbox Business 的权限，允许她使用 Azure 单一登录。
