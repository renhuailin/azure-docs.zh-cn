...
* 可以在 Azure AD 中控制谁有权访问 Reward Gateway。
* 可让用户使用其 Azure AD 帐户自动登录到 Reward Gateway（单一登录）。
...
## <a name="adding-reward-gateway-from-the-gallery"></a>从库中添加 Reward Gateway
...
4. 在搜索框中键入 **Reward Gateway**，在结果面板中选择“Reward Gateway”，然后单击“添加”按钮添加该应用程序。  

     ![结果列表中的“Reward Gateway”](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录

在本部分，我们基于名为 **Britta Simon** 的测试用户来配置并测试 Reward Gateway 的 Azure AD 单一登录。
若要正常使用单一登录，需要在 Azure AD 用户与 Reward Gateway 相关用户之间建立链接关系。

若要配置和测试 Reward Gateway 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[配置 Reward Gateway 单一登录](#configure-reward-gateway-single-sign-on)** - 在应用程序端配置单一登录设置。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[创建 Reward Gateway 测试用户](#create-reward-gateway-test-user)** - 在 Reward Gateway 中创建 Britta Simon 的对应用户，并将其关联到其在 Azure AD 中的表示形式。
...
1. 在 [Azure 门户](https://portal.azure.com/)中的“Reward Gateway”应用程序集成页上，选择“单一登录”。  
...
1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”、“Reward Gateway”。   
...
在访问面板中单击“Reward Gateway”磁贴时，应会自动登录到设置了 SSO 的 Reward Gateway。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md)（访问面板简介）。
