...
* 可以让用户使用其 Azure AD 帐户自动登录到 eLuminate（单一登录）。
...
2. **[配置 eLuminate 单一登录](#configure-eluminate-single-sign-on)** - 在应用程序端配置单一登录设置。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[创建 eLuminate 测试用户](#create-eluminate-test-user)** - 在 eLuminate 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 表示形式。
...
4. 在“基本 SAML 配置”部分中，按照以下步骤操作：
    ...
    > [!NOTE]
    > 这些不是实际值。 使用实际登录 URL 和标识符更新这些值。 请联系 [eLuminate 客户端支持团队](mailto:support@intellimedia.ca)获取这些值。 还可以参考 Azure 门户中的“基本 SAML 配置”  部分中显示的模式。

4. 在“设置 SAML 单一登录”  页的“SAML 签名证书”  部分中，单击“复制”按钮，以复制“应用联合元数据 URL”  ，并将它保存在计算机上。

    ![证书下载链接](common/copy-metadataurl.png)

### <a name="configure-eluminate-single-sign-on"></a>配置 eLuminate 单一登录

若要在 **eLuminate** 端配置单一登录，需要将 **应用联合元数据 URL** 发送给 [eLuminate 支持团队](mailto:support@intellimedia.ca)。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
...
### <a name="create-eluminate-test-user"></a>创建 eLuminate 测试用户
...
单击访问面板中的 eLuminate 磁贴时，应当会自动登录到为其设置了 SSO 的 eLuminate。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)（访问面板简介）。
