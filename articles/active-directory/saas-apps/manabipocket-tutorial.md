...
* 可以让用户使用其 Azure AD 帐户自动登录到 Manabi Pocket（单一登录）。
...
* 启用了单一登录的 Manabi Pocket 订阅

## <a name="scenario-description"></a>方案描述

本教程会在测试环境中配置和测试 Azure AD 单一登录。

* Manabi Pocket 支持 **SP** 发起的 SSO
...
4. 在搜索框中，键入“Manabi Pocket”，在结果面板中选择“Manabi Pocket”，然后单击“添加”按钮添加该应用程序。
     ...
     ![结果列表中的 Manabi Pocket](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录

在本部分中，我们基于名为“Britta Simon”的测试用户为 Manabi Pocket 配置和测试 Azure AD 单一登录。
若要使单一登录有效，需要在 Azure AD 用户与 Manabi Pocket 相关用户之间建立关联。

若要使用 Manabi Pocket 配置和测试 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[配置 Manabi Pocket 单一登录](#configure-manabi-pocket-single-sign-on)** - 在应用程序端配置单一登录设置。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[创建 Manabi Pocket 测试用户](#create-manabi-pocket-test-user)** - 在 Manabi Pocket 中创建 Britta Simon 的对应用户，并将其关联到用户的 Azure AD 表示形式。
...
要为 Manabi Pocket 配置 Azure AD 单一登录，请执行以下步骤：

1. 在 [Azure 门户](https://portal.azure.com/)中的“Manabi Pocket”应用程序集成页上，选择“单一登录”。
...
6. 在“设置 Manabi Pocket”部分，根据要求复制相应 URL。
...
1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”、“Manabi Pocket”。

    ![“企业应用程序”边栏选项卡](common/enterprise-applications.png)

2. 在应用程序列表中，选择“Manabi Pocket”。

    ![应用程序列表中的 Manabi Pocket 链接](common/all-applications.png)
...
### <a name="create-manabi-pocket-test-user"></a>创建 Manabi Pocket 测试用户
...
单击访问面板中的 Manabi Pocket 磁贴时，应会自动登录到为其设置了 SSO 的 Manabi Pocket。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)（访问面板简介）。
