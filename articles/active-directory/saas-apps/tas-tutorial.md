...
2. 在菜单左侧，单击“设置”，然后转到“管理员”，然后单击“管理单一登录”    。
    ...
    ![显示选择了“管理单一登录”的屏幕截图。](./media/tas-tutorial/configure01.png)

3. 在“管理单一登录”页上，执行以下步骤  ：

    ![显示“管理单一登录”页的屏幕截图，你可在其中输入所述值。](./media/tas-tutorial/configure02.png)
...
单击访问面板中的 TAS 磁贴时，应当会自动登录到已为其设置了 SSO 的 TAS。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md)（访问面板简介）。
