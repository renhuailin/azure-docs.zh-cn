...
## <a name="configure-and-test-azure-ad-single-sign-on-for-paylocity"></a>配置和测试 Paylocity 的 Azure AD 单一登录

使用名为 B. Simon 的测试用户配置和测试 Paylocity 的 Azure AD SSO  。 若要运行 SSO，需要在 Azure AD 用户与 Paylocity 相关用户之间建立链接关系。

若要配置和测试 Paylocity 的 Azure AD SSO，请完成以下构建基块：
...
1. 在 [Azure 门户](https://portal.azure.com/)的“Paylocity”应用程序集成页上，找到“管理”部分，选择“单一登录”    。
