...
在本教程中，了解如何将 SciQuest Spend Director 与 Azure Active Directory (Azure AD) 集成。
...
### <a name="create-sciquest-spend-director-test-user"></a>创建 SciQuest Spend Director 测试用户

本部分的目的是在 SciQuest Spend Director 中创建名为“Britta Simon”的用户。

需要联系 [SciQuest Spend Director 支持团队](https://www.jaggaer.com/contact-us/)，向他们提供有关测试帐户的详细信息，以便他们创建测试帐户。
...
若要启用实时预配，需要联系 [SciQuest Spend Director 支持团队](https://www.jaggaer.com/contact-us/)。

### <a name="test-single-sign-on"></a>测试单一登录 

在本部分中，使用访问面板测试 Azure AD 单一登录配置。

单击访问面板中的 SciQuest Spend Director 磁贴时，应自动登录到为其设置了 SSO 的 SciQuest Spend Director。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)（访问面板简介）。
