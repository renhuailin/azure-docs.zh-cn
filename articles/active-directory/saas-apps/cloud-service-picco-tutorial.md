...
* 可以在 Azure AD 中控制谁有权访问云服务 PICCO。
* 可以让用户使用其 Azure AD 帐户自动登录到云服务 PICCO（单一登录）。
...
若要配置云服务 PICCO 与 Azure AD 的集成，需要从库中将云服务 PICCO 添加到托管 SaaS 应用列表。

**若要从库中添加云服务 PICCO，请执行以下步骤：**
...
2. **[配置云服务 PICCO 单一登录](#configure-cloud-service-picco-single-sign-on)** - 在应用程序端配置单一登录设置。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[创建云服务 PICCO 测试用户](#create-cloud-service-picco-test-user)** - 在云服务 PICCO 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
### <a name="create-cloud-service-picco-test-user"></a>创建云服务 PICCO 测试用户

在本部分，我们会在云服务 PICCO 中创建一个名为 Britta Simon 的用户。 云服务 PICCO 支持在默认情况下保持启用的实时用户预配。 此部分不存在任何操作项。 如果云服务 PICCO 中不存在用户，则会在身份验证后创建一个新用户。

### <a name="test-single-sign-on"></a>测试单一登录

在本部分中，使用访问面板测试 Azure AD 单一登录配置。

单击访问面板中的云服务 PICCO 磁贴时，应当会自动登录到你为其设置了 SSO 的云服务 PICCO。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)（访问面板简介）。
