...
* 配置 Field iD 后，可以强制实施会话控制。 这可以实时保护组织的敏感数据免于外泄和渗透。 会话控制从条件访问扩展而来。 [了解如何通过 Microsoft Cloud App Security 强制实施会话控制](/cloud-app-security/proxy-deployment-any-app)。
...
- [如何通过高级可见性和控制保护 Field iD](/cloud-app-security/proxy-intro-aad)