...
## <a name="add-gotomeeting-from-the-gallery"></a>从库添加 GoToMeeting
...
## <a name="configure-and-test-azure-ad-sso-for-gotomeeting"></a>配置并测试 GoToMeeting 的 Azure AD SSO

使用名为 **B.Simon** 的测试用户配置并测试 GoToMeeting 的 Azure AD SSO。 若要正常使用 SSO，需要在 Azure AD 用户与 GoToMeeting 中的相关用户之间建立链接关系。

若要配置并测试 GoToMeeting 的 Azure AD SSO，请执行以下步骤：

1. **[配置 Azure AD SSO](#configure-azure-ad-sso)** - 使用户能够使用此功能。
    1. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 B. Simon 测试 Azure AD 单一登录。
    1. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 B. Simon 能够使用 Azure AD 单一登录。
1. **[配置 GoToMeeting SSO](#configure-gotomeeting-sso)** - 在应用程序端配置单一登录设置。
    1. **[创建 GoToMeeting 测试用户](#create-gotomeeting-test-user)** - 在 GoToMeeting 中创建 B.Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
1. 在 Azure 门户中的“GoToMeeting”应用程序集成页面上，找到“管理”部分，然后选择“单一登录”  。
...
1. 在“基本 SAML 配置”部分中，按照以下步骤操作：
    ...
    a. 在“标识符”文本框中键入 URL：`https://authentication.logmeininc.com/saml/sp`

    b. 在“回复 URL”文本框中键入 URL：`https://authentication.logmeininc.com/saml/acs`

    c. 单击“设置其他 URL”  并配置以下 URL

    d. **登录 URL**（保留为空白）

    e. 在“RelayState”文本框中，键入以下 URL 之一：
