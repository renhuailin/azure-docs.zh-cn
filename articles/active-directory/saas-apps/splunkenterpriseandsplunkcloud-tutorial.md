...
本教程介绍如何将 Splunk Enterprise and Splunk Cloud 与 Azure Active Directory (Azure AD) 集成。 将 Splunk Enterprise and Splunk Cloud 与 Azure AD 集成后，可以：

* 在 Azure AD 中控制谁有权访问 Splunk Enterprise and Splunk Cloud。
* 让用户使用其 Azure AD 帐户自动登录到 Splunk Enterprise and Splunk Cloud。
...
* Splunk Enterprise and Splunk Cloud 支持 SP 发起的 SSO
...
1. 在“从库中添加”部分的搜索框中，键入 Splunk Enterprise and Splunk Cloud 。
1. 从结果面板中选择 Splunk Enterprise and Splunk Cloud，然后添加该应用。 在该应用添加到租户时等待几秒钟。

## <a name="configure-and-test-azure-ad-sso-for-splunk-enterprise-and-splunk-cloud"></a>配置并测试 Splunk Enterprise and Splunk Cloud 的 Azure AD SSO

使用名为 B.Simon 的测试用户配置并测试 Splunk Enterprise and Splunk Cloud 的 Azure AD SSO。 若要使 SSO 正常运行，需要在 Azure AD 用户与 Splunk Enterprise and Splunk Cloud 中的相关用户之间建立链接关系。

若要配置并测试 Splunk Enterprise and Splunk Cloud 的 Azure AD SSO，请执行以下步骤：

1. **[配置 Azure AD SSO](#configure-azure-ad-sso)** - 使用户能够使用此功能。
    1. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 B. Simon 测试 Azure AD 单一登录。
    1. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 B. Simon 能够使用 Azure AD 单一登录。
1. **[配置 Splunk Enterprise and Splunk Cloud SSO](#configure-splunk-enterprise-and-splunk-cloud-sso)** - 在应用程序端配置单一登录设置。
...
1. 在 Azure 门户的 Splunk Enterprise and Splunk Cloud 应用程序集成页上，找到“管理”部分，选择“单一登录”  。
...
本部分将通过授予 B.Simon 访问 Splunk Enterprise and Splunk Cloud 的权限，允许其使用 Azure 单一登录。

1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”。  
1. 在应用程序列表中，选择“Splunk Enterprise and Splunk Cloud”。
...
* 在 Azure 门户中单击“测试此应用程序”。 这会重定向到 Splunk Enterprise and Splunk Cloud 登录 URL，你可以从此处启动登录流。 

* 直接转到 Splunk Enterprise and Splunk Cloud 登陆 URL，并从此处启动登录流。

* 你可使用 Microsoft 的“我的应用”。 单击“我的应用”中的 Splunk Enterprise and Splunk Cloud 磁贴时，将会重定向到 Splunk Enterprise and Splunk Cloud 登录 URL。 有关“我的应用”的详细信息，请参阅[“我的应用”简介](https://docs.microsoft.com/azure/active-directory/user-help/my-apps-portal-end-user-access)。

## <a name="next-steps"></a>后续步骤

配置 Splunk Enterprise and Splunk Cloud 后，就可以强制实施会话控制，实时防止组织的敏感数据外泄和渗透。 会话控制从条件访问扩展而来。 [了解如何通过 Microsoft Cloud App Security 强制实施会话控制](https://docs.microsoft.com/cloud-app-security/proxy-deployment-any-app)