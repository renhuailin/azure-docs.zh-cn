---
title: 教程：Azure Active Directory 单一登录 (SSO) 与 Tribeloo 集成 | Microsoft Docs
description: 了解如何在 Azure Active Directory 和 Tribeloo 之间配置单一登录。
...
本教程介绍如何将 Tribeloo 与 Azure Active Directory (Azure AD) 集成。 将 Tribeloo 与 Azure AD 集成后，可以：

* 在 Azure AD 中控制谁有权访问 Tribeloo。
* 让用户使用其 Azure AD 帐户自动登录到 Tribeloo。
...
若要配置 Tribeloo 与 Azure AD 的集成，需从库中将 Tribeloo 添加到托管的 SaaS 应用列表。
...
使用名为 **B.Simon** 的测试用户配置和测试 Tribeloo 的 Azure AD SSO。 若要运行 SSO，需要在 Azure AD 用户与 Tribeloo 相关用户之间建立链接关系。

若要配置并测试 Tribeloo 的 Azure AD SSO，请执行以下步骤：

1. **[配置 Azure AD SSO](#configure-azure-ad-sso)** - 使用户能够使用此功能。
    1. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 B. Simon 测试 Azure AD 单一登录。
    1. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 B. Simon 能够使用 Azure AD 单一登录。
1. **[配置 Tribeloo SSO](#configure-tribeloo-sso)** - 在应用程序端配置单一登录设置。
    1. **[创建 Tribeloo 测试用户](#create-tribeloo-test-user)** - 在 Tribeloo 中创建 B.Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
1. 在“基本 SAML 配置”部分，输入以下字段的值：
    ...
    在“登录 URL”文本框中，键入 URL：  `https://app.tribeloo.com/login`
...
在本部分中，将通过授予 B.Simon 访问 Tribeloo 的权限，允许其使用 Azure 单一登录。
...
## <a name="configure-tribeloo-sso"></a>配置 Tribeloo SSO

若要在 **Tribeloo** 端配置单一登录，需要将下载的 **证书 (Base64)** 以及从 Azure 门户复制的相应 URL 发送给 [Tribeloo 支持团队](mailto:support@tribeloo.com)。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。

### <a name="create-tribeloo-test-user"></a>创建 Tribeloo 测试用户
...
* 在 Azure 门户中单击“测试此应用程序”。 这会重定向到 Tribeloo 登录 URL，可以在其中启动登录流。 
