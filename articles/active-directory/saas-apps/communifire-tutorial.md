...
若要使单一登录有效，需要在 Azure AD 用户与 Communifire 相关用户之间建立链接关系。

若要配置和测试 Communifire 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[配置 Communifire 单一登录](#configure-communifire-single-sign-on)** - 在应用程序端配置单一登录设置。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[创建 Communifire 测试用户](#create-communifire-test-user)** - 在 Communifire 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 表示形式。
...
1. 在 [Azure 门户](https://portal.azure.com/)中的“Communifire”应用程序集成页上，选择“单一登录”。  
...
5. 如果要在 SP 发起的模式下配置应用程序，请单击“设置其他 URL”，并执行以下步骤：
    ...
    ![Communifire 域和 URL 单一登录信息](common/metadata-upload-additional-signon.png)
...
### <a name="configure-communifire-single-sign-on"></a>配置 Communifire 单一登录
...
1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”和“Communifire”    。

    ![“企业应用程序”边栏选项卡](common/enterprise-applications.png)

2. 在应用程序列表中，选择“Communifire”。 

    ![应用程序列表中的 Communifire 链接](common/all-applications.png)
...
单击访问面板中的 Communifire 磁贴时，应当会自动登录到为其设置了 SSO 的 Communifire。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)（访问面板简介）。
