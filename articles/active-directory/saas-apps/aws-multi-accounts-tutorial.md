...
1. 在“用户属性”窗格的“用户声明”部分，使用下表中的值配置 SAML 令牌属性 ：
   ...
   >[!NOTE]
   >有关 Azure AD 中的角色的更多信息，请参阅[在应用程序中添加应用角色并在令牌中接收它们](../develop/howto-add-app-roles-in-azure-ad-apps.md#app-roles-ui--preview)。
