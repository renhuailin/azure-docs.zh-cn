...
本部分将基于名为“Britta Simon”的测试用户配置和测试 Direct 的 Azure AD 单一登录  。
若要运行单一登录，需要在 Azure AD 用户与 Direct 中的相关用户之间建立链接关系。

若要配置和测试 direct 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[配置 Direct 单一登录](#configure-direct-single-sign-on)** - 在应用程序端配置单一登录设置。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[创建 Direct 测试用户](#create-direct-test-user)** - 在 direct 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
1. 在 [Azure 门户](https://portal.azure.com/)中的 Direct 应用程序集成页上，选择“单一登录”   。
...
4. 如果要在 IDP 发起的模式下配置应用程序，请在“基本 SAML 配置部分”中执行以下步骤   ：
    ...
    ![Direct 域和 URL 单一登录信息](common/idp-identifier.png)

    在“标识符”  文本框中，键入一个 URL：`https://direct4b.com/`
...
### <a name="configure-direct-single-sign-on"></a>配置 Direct 单一登录
...
1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”和“Direct”    。

    ![“企业应用程序”边栏选项卡](common/enterprise-applications.png)

2. 在应用程序列表中，选择“direct”  。

    ![应用程序列表中的 Direct 链接](common/all-applications.png)
