...
* 你可使用 Microsoft 的“我的应用”。 单击“我的应用”中的“TextExpander”磁贴时，你应该会自动登录到为其设置了 SSO 的 TextExpander。 有关“我的应用”的详细信息，请参阅[“我的应用”简介](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)。
