...
* 配置 TextExpander 后，就可以强制实施会话控制，实时防止组织的敏感数据外泄和渗透。 会话控制从条件访问扩展而来。 [了解如何通过 Microsoft Cloud App Security 强制实施会话控制](/cloud-app-security/proxy-deployment-any-app)。

## <a name="adding-textexpander-from-the-gallery"></a>从库中添加 TextExpander
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-textexpander"></a>配置并测试 TextExpander 的 Azure AD 单一登录

使用名为 B.Simon 的测试用户配置并测试 TextExpander 的 Azure AD SSO。 若要使 SSO 有效，需要在 Azure AD 用户与 TextExpander 相关用户之间建立关联。

若要配置并测试 TextExpander 的 Azure AD SSO，请完成以下构建基块：
...
1. 在 [Azure 门户](https://portal.azure.com/)的“TextExpander”应用程序集成页上，找到“管理”部分并选择“单一登录”  。
...
单击访问面板中的 TextExpander 磁贴时，应当会自动登录到为其设置了 SSO 的 TextExpander。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md)（访问面板简介）。
...
- [在 Azure AD 中试用 TextExpander](https://aad.portal.azure.com/)

- [Microsoft Cloud App Security 中的会话控制是什么？](/cloud-app-security/proxy-intro-aad)

- [如何通过高级可见性和控制保护 TextExpander](/cloud-app-security/proxy-intro-aad)