---
title: 教程：Azure AD SSO 与 EAB Navigate Strategic Care 的集成
...
ms.locfileid: "128661375"
---
# <a name="tutorial-azure-ad-sso-integration-with-eab-navigate-strategic-care"></a>教程：Azure AD SSO 与 EAB Navigate Strategic Care 的集成
...
## <a name="add-eab-navigate-strategic-care-from-the-gallery"></a>从库中添加 EAB Navigate Strategic Care
...
## <a name="configure-and-test-azure-ad-sso-for-eab-navigate-strategic-care"></a>配置并测试 EAB Navigate Strategic Care 的 Azure AD SSO
...
若要配置并测试 EAB Navigate Strategic Care 的 Azure AD SSO，请执行以下步骤：
...
1. 在 Azure 门户中的 EAB Navigate Strategic Care 应用程序集成页上，找到“管理”部分，然后选择“单一登录”  。
...
* 在 Azure 门户中单击“测试此应用程序”。 这会重定向到 EAB Navigate Strategic Care 登录 URL，可在其中启动登录流。 

* 直接转到 EAB Navigate Strategic Care 登录 URL，并从那里启动登录流。

* 你可使用 Microsoft 的“我的应用”。 在“我的应用”中单击 EAB Navigate Strategic Care 磁贴后，会重定向到 EAB Navigate Strategic Care 登录 URL。 有关“我的应用”的详细信息，请参阅[“我的应用”简介](../user-help/my-apps-portal-end-user-access.md)。

## <a name="next-steps"></a>后续步骤

配置 EAB Navigate Strategic Care 后，可以强制实施会话控制，实时防止组织的敏感数据外泄和渗透。 会话控制从条件访问扩展而来。 [了解如何通过 Microsoft Cloud App Security 强制实施会话控制](/cloud-app-security/proxy-deployment-aad)。