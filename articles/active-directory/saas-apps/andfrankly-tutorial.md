...
在本教程中，了解如何将 &frankly 与 Azure Active Directory (Azure AD) 进行集成。
将 &frankly 与 Azure AD 集成具有以下优势：

* 可在 Azure AD 中控制谁有权访问 &frankly。
* 可以让用户使用其 Azure AD 帐户自动登录到 &frankly（单一登录）。
...
在本部分中，根据名为“Britta Simon”的测试用户的指示配置和测试 &frankly 的 Azure AD 单一登录。 
若要运行单一登录，需要在 Azure AD 用户与 &frankly 相关用户之间建立链接关系。

若要配置和测试 &frankly 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[配置 &frankly 单一登录](#configure-frankly-single-sign-on)** - 在应用程序端配置单一登录设置。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[创建 &frankly 测试用户](#create-frankly-test-user)** - 在 &frankly 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
若要配置 &frankly 的 Azure AD 单一登录，请执行以下步骤：

1. 在 [Azure 门户](https://portal.azure.com/)中的 **&frankly** 应用程序集成页上，选择“单一登录”。 
...
在本部分中，通过授予 Britta Simon 访问 &frankly 的权限，以支持其使用 Azure 单一登录。

1. 在 Azure 门户中，依次选择“企业应用程序”  、“所有应用程序”  和“&frankly”  。

    ![“企业应用程序”边栏选项卡](common/enterprise-applications.png)

2. 在应用程序列表中，选择“&frankly”  。

    ![应用程序列表中的 &frankly 链接](common/all-applications.png)
...
单击访问面板中的 &frankly 磁贴时，应当会自动登录到为其设置了 SSO 的 &frankly。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md)（访问面板简介）。
