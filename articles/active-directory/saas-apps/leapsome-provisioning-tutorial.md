...
### <a name="to-configure-automatic-user-provisioning-for-leapsome-in-azure-ad"></a>若要在 Azure AD 中为 Leapsome 配置自动用户预配：
...
14. 通过在“设置”部分的“范围”中选择所需的值，定义要预配到 Leapsome 的用户和/或组 。
