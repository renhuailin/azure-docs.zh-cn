...
## <a name="add-perforce-helix-core---helix-authentication-service-from-the-gallery"></a>从库中添加 Perforce Helix Core - Helix Authentication Service
...
## <a name="configure-and-test-azure-ad-sso-for-perforce-helix-core---helix-authentication-service"></a>配置并测试 Perforce Helix Core - Helix Authentication Service 的 Azure AD SSO
...
若要配置并测试 Perforce Helix Core - Helix Authentication Service 的 Azure AD SSO，请执行以下步骤：
...
1. 在 Azure 门户的“Perforce Helix Core - Helix Authentication Service”应用程序集成页上，找到“管理”部分，然后选择“单一登录”。  
...
* 在 Azure 门户中单击“测试此应用程序”。 这将重定向到 Perforce Helix Core - Helix Authentication Service 登录 URL，你可以在其中启动登录流。 

* 直接转到 Perforce Helix Core - Helix Authentication Service 登录 URL，从那里启动登录流。

* 你可使用 Microsoft 的“我的应用”。 单击“我的应用”中的 Perforce Helix Core - Helix Authentication Service 磁贴时，将会重定向到 Perforce Helix Core - Helix Authentication Service 登录 URL。 有关“我的应用”的详细信息，请参阅[“我的应用”简介](../user-help/my-apps-portal-end-user-access.md)。

## <a name="next-steps"></a>后续步骤

配置 Perforce Helix Core - Helix Authentication Service 后，就可以强制实施会话控制，从而实时防止组织的敏感数据遭受外泄和渗透。 会话控制从条件访问扩展而来。 [了解如何通过 Microsoft Cloud App Security 强制实施会话控制](/cloud-app-security/proxy-deployment-aad)。
