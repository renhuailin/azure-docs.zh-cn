...
从 Azure AD 应用程序库添加 iProva，开始管理 iProva 的预配。 如果之前为 iProva 设置过 SSO，则可使用同一应用程序。 但建议你在最初测试集成时创建一个单独的应用。 可在[此处](../manage-apps/add-application-portal.md)详细了解如何从库中添加应用程序。 
