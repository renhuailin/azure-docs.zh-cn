...
2. 单击“菜单”图标并选择“管理”。  
    ...
    ![显示 Microsoft Digital Enterprise Server 中的“管理”图标的屏幕截图。](./media/trisotechdigitalenterpriseserver-tutorial/user1.png)

3. 选择“用户提供程序”。 

    ![显示从菜单选择了“用户提供程序”的屏幕截图。](./media/trisotechdigitalenterpriseserver-tutorial/user2.png)

4. 在“用户提供程序配置”部分执行以下步骤： 

    ![显示可在其中输入所述值的“用户提供程序配置”的屏幕截图。](./media/trisotechdigitalenterpriseserver-tutorial/user3.png)
...
在访问面板中单击“Trisotech Digital Enterprise Server”磁贴时，应会自动登录到设置了 SSO 的 Trisotech Digital Enterprise Server。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)（访问面板简介）。
