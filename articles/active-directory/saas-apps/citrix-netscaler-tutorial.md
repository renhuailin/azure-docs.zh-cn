...
* 你可使用 Microsoft 的“我的应用”。 在“我的应用”中单击“Azure AD”磁贴的 Citrix ADC SAML 连接器时，会重定向到用于 Azure AD 登录 URL 的 Citrix ADC SAML 连接器。 有关“我的应用”的详细信息，请参阅[“我的应用”简介](../user-help/my-apps-portal-end-user-access.md)。
