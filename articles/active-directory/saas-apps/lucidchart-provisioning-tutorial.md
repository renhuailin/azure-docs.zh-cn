...
从 Azure AD 应用程序库添加 Lucidchart，开始管理 Lucidchart 的预配。 如果以前为 SSO 设置过 Lucidchart，则可以使用同一应用程序。 但建议你在最初测试集成时创建一个单独的应用。 若要详细了解如何从库中添加应用，可以单击[此处](../manage-apps/add-application-portal.md)。 
