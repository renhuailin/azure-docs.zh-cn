...
单击访问面板中的 ThirdPartyTrust 磁贴时，应会自动登录到为其设置了 SSO 的 ThirdPartyTrust。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md)（访问面板简介）。
