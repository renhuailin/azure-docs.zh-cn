...
* 你可使用 Microsoft 的“我的应用”。 单击“我的应用”中的 Clarity 磁贴时，你会自动登录到为其设置了 SSO 的 Clarity。 有关“我的应用”的详细信息，请参阅[“我的应用”简介](../user-help/my-apps-portal-end-user-access.md)。
