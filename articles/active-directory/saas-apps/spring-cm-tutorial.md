...
ms.locfileid: "124800985"
---
# <a name="tutorial-azure-active-directory-integration-with-springcm"></a>教程：Azure Active Directory 与 SpringCM 集成

本教程介绍如何将 SpringCM 与 Azure Active Directory (Azure AD) 相集成。 将 SpringCM 与 Azure AD 集成后，可以：

* 在 Azure AD 中控制谁有权访问 SpringCM。
* 让用户使用其 Azure AD 帐户自动登录到 SpringCM。
...
## <a name="add-springcm-from-the-gallery"></a>从库中添加 SpringCM
...
1. 在“从库中添加”部分的搜索框中，键入 SpringCM 。
1. 在结果面板中选择“SpringCM”，然后添加该应用。 在该应用添加到租户时等待几秒钟。

## <a name="configure-and-test-azure-ad-sso-for-springcm"></a>配置并测试 SpringCM 的 Azure AD SSO

使用名为 B.Simon 的测试用户配置并测试 SpringCM 的 Azure AD SSO。 若要正常使用 SSO，需要在 Azure AD 用户与 SpringCM 中的相关用户之间建立链接关系。

若要配置并测试 SpringCM 的 Azure AD SSO，请执行以下步骤：

1. **[配置 Azure AD SSO](#configure-azure-ad-sso)** - 使用户能够使用此功能。
    1. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 B. Simon 测试 Azure AD 单一登录。
    1. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 B. Simon 能够使用 Azure AD 单一登录。
1. [配置 SpringCM SSO](#configure-springcm-sso) - 在应用程序端配置单一登录设置。
    1. [创建 SpringCM 测试用户](#create-springcm-test-user) - 在 SpringCM 中创建 B.Simon 的对应用户，并将其链接到其在 Azure AD 中的表示形式。
...
1. 在 Azure 门户中的“SpringCM”应用程序集成页上，找到“管理”部分并选择“单一登录”  。
...
在本部分，你将通过授予 B.Simon 访问 SpringCM 的权限，使其能够使用 Azure 单一登录。
...
## <a name=&quot;configure-springcm-sso&quot;></a>配置 SpringCM SSO
...
1. 在“标识提供者配置”部分执行以下步骤：
    ...
    ![标识提供者配置](./media/spring-cm-tutorial/configuration.png "标识提供者配置")
...
1. 单击“转到”，然后单击“通讯簿”。
    ...
    ![创建用户](./media/spring-cm-tutorial/user.png "创建用户")
...
* 在 Azure 门户中单击“测试此应用程序”。 这会重定向到 SpringCM 登录 URL，可从中启动登录流。 

* 直接转到 SpringCM 登录 URL，并从中启动登录流。

* 你可使用 Microsoft 的“我的应用”。 在“我的应用”中单击“SpringCM”磁贴时，会重定向到 SpringCM 登录 URL。 有关“我的应用”的详细信息，请参阅[“我的应用”简介](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)。

## <a name="next-steps"></a>后续步骤

配置 SpringCM 后，可以强制实施会话控制，实时防止组织的敏感数据外泄和渗透。 会话控制从条件访问扩展而来。 [了解如何通过 Microsoft Cloud App Security 强制实施会话控制](/cloud-app-security/proxy-deployment-aad)。