...
若要配置并测试 Kemp LoadMaster Azure AD integration 的 Azure AD SSO，请执行以下步骤：
...
1. 在 Azure 门户中的“Kemp LoadMaster Azure AD integration”应用程序集成页上，找到“管理”部分并选择“单一登录”。  
...
* 你可使用 Microsoft 的“我的应用”。 在“我的应用”中单击“Kemp LoadMaster Azure AD integration”磁贴时，应会自动登录到设置了 SSO 的 Kemp LoadMaster Azure AD integration。 有关“我的应用”的详细信息，请参阅[“我的应用”简介](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)。
