---
title: 教程：Azure Active Directory 单一登录 (SSO) 与 MyVR 集成 | Microsoft Docs
...
ms.locfileid: "124741855"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-myvr"></a>教程：Azure Active Directory 单一登录 (SSO) 与 MyVR 集成
...
单击访问面板中的“MyVR”磁贴时，应会自动登录到为其设置了 SSO 的 MyVR。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)（访问面板简介）。
