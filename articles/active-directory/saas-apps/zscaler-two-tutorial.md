...
本教程介绍如何将 Zscaler Two 与 Azure Active Directory (Azure AD) 集成。
将 Zscaler Two 与 Azure AD 集成提供以下优势：

* 可以在 Azure AD 中控制谁有权访问 Zscaler Two。
...
在本部分中，我们基于名为“Britta Simon”的测试用户为 Zscaler Two 配置和测试 Azure AD 单一登录。 
若要使单一登录有效，需要在 Azure AD 用户与 Zscaler Two 相关用户之间建立关联。

若要配置和测试 Zscaler Two 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[配置 Zscaler Two 单一登录](#configure-zscaler-two-single-sign-on)** - 在应用程序端配置单一登录设置。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[创建 Zscaler Two 测试用户](#create-zscaler-two-test-user)** - 在 Zscaler Two 中创建 Britta Simon 的对应用户，并将其关联到用户的 Azure AD 表示形式。
...
要为 Zscaler Two 配置 Azure AD 单一登录，请执行以下步骤：

1. 在 [Azure 门户](https://portal.azure.com/)中的 Zscaler Two 应用程序集成页上，选择“单一登录”  。 
...
4. 在“基本 SAML 配置”  部分中，按照以下步骤操作：
    ...
    ![Zscaler Two 域和 URL 单一登录信息](common/sp-signonurl.png)
...
### <a name="configure-zscaler-two-single-sign-on"></a>配置 Zscaler Two 单一登录
