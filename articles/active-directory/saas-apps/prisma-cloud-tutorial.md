...
* Prisma Cloud SSO 支持实时用户预配。

## <a name="add-prisma-cloud-sso-from-the-gallery"></a>从库中添加 Prisma Cloud SSO
...
## <a name="configure-and-test-azure-ad-sso-for-prisma-cloud-sso"></a>配置并测试 Prisma Cloud SSO 的 Azure AD SSO

使用名为 **B.Simon** 的测试用户配置并测试 Prisma Cloud SSO 的 Azure AD SSO。 若要正常使用 SSO，需要在 Azure AD 用户与 Prisma Cloud SSO 中的相关用户之间建立链接关系。

若要配置并测试 Prisma Cloud SSO 的 Azure AD SSO，请执行以下步骤：
...
1. 在 Azure 门户中，在 Prisma Cloud SSO 应用程序集成页上，找到“管理”部分并选择“单一登录”  。
...
* 你可使用 Microsoft 的“我的应用”。 在“我的应用”中单击“Prisma Cloud SSO”磁贴时，你应会自动登录到设置了 SSO 的 Prisma Cloud SSO。 有关“我的应用”的详细信息，请参阅[“我的应用”简介](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)。

## <a name="next-steps"></a>后续步骤

配置 Prisma Cloud SSO 后，即可强制实施会话控制，实时防止组织的敏感数据发生外泄和渗透。 会话控制从条件访问扩展而来。 [了解如何通过 Microsoft Cloud App Security 强制实施会话控制](https://docs.microsoft.com/cloud-app-security/proxy-deployment-any-app)。
