...
2. 转到“系统设置”  。 在“安全管理”  部分中，单击“公司 SAML 设置”  。
    ...
    ![屏幕截图显示了“系统设置”页，其中突出显示了“安全管理”部分，并选择了“公司 SAML 设置”操作。](./media/planmyleave-tutorial/tutorial_planmyleave_002.png) 

3. 在“SAML 设置”  部分，单击编辑器图标。

    ![屏幕截图显示了“SAML 设置”部分，其中选择了该部分右上方的“编辑”图标。](./media/planmyleave-tutorial/tutorial_planmyleave_003.png)
...
单击访问面板中的 PlanMyLeave 磁贴时，应当会自动登录到为其设置了 SSO 的 PlanMyLeave。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)（访问面板简介）。
