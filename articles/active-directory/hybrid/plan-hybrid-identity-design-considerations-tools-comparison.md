...
- [Azure AD Connect 云预配](../cloud-sync/what-is-cloud-sync.md) 是用于从 AD DS 同步到 Azure AD 的新 Microsoft 代理，适用于合并和收购等方案，其中获取的公司的 ad 林与父公司的 ad 林相隔离。

若要详细了解 Azure AD Connect 同步和 Azure AD Connect 云预配之间的差异，请参阅 [什么是 Azure AD Connect 云预配？](../cloud-sync/what-is-cloud-sync.md)
