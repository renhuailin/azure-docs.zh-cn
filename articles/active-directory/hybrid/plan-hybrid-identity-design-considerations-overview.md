...
![示例](media/plan-hybrid-identity-design-considerations/hybridID-example.png)
...
| 混合标识阶段 | 主题列表 |
| --- | --- |
| 确定标识要求 |[确定业务需求](plan-hybrid-identity-design-considerations-business-needs.md)<br> [确定目录同步要求](plan-hybrid-identity-design-considerations-directory-sync-requirements.md)<br> [确定多重身份验证要求](plan-hybrid-identity-design-considerations-multifactor-auth-requirements.md)<br> [定义混合标识采用策略](plan-hybrid-identity-design-considerations-identity-adoption-strategy.md) |
