---
title: 教程：使用 PHS 将单个 AD 林集成到 Azure
description: 演示如何使用密码哈希同步设置混合标识环境。
...
![创建](media/tutorial-password-hash-sync/diagram.png)

以下教程将引导你使用密码哈希同步创建混合标识环境。然后，可以使用此环境进行测试或更熟悉混合标识的工作方式。
