...
- [Azure Active Directory B2B 协作常见问题解答](faq.yml)
...
- [启用 B2B 外部协作并管理可以邀请来宾的人员](delegate-invitations.md)
- [Azure AD External Identities 的计费模型](external-identities-pricing.md)
- [示例：使用 Active Directory 联合身份验证服务 (AD FS) 配置 SAML/WS-Fed IdP 联合（预览版）](direct-federation-adfs.md)
- [与适用于来宾用户的 SAML/WS-Fed 标识提供者联合（预览版）](direct-federation.md)
- [将 Google 添加为 B2B 来宾用户的标识提供者](google-federation.md)
- [外部标识的标识提供者](identity-providers.md)
- [以来宾用户身份离开组织](leave-the-organization.md)
- [Azure Active Directory 外部标识：新增功能](whats-new-docs.md)
- [在 Azure 门户中添加 Azure Active Directory B2B 协作用户](add-users-administrator.md)
- [邀请内部用户参与 B2B 协作](invite-internal-users.md)
...
- [将 Google 添加为 B2B 来宾用户的标识提供者](google-federation.md)
- [示例：用 Active Directory 联合身份验证服务 (AD FS) 进行直接联合（预览版）](direct-federation-adfs.md)
- [与面向来宾用户的 AD FS 和第三方提供者的直接联合（预览）](direct-federation.md)
- [电子邮件一次性密码身份验证](one-time-passcode.md)
- [重置来宾用户的邀请兑换状态（预览版）](reset-redemption-status.md)
- [B2B 协作邀请电子邮件的元素 - Azure Active Directory](invitation-email-elements.md)
- [Azure Active Directory B2B 协作疑难解答](troubleshoot.md)
- [快速入门：使用 PowerShell 添加来宾用户](b2b-quickstart-invite-powershell.md)
- [B2B 协作用户的条件访问](conditional-access.md)
...
- [Azure Active Directory B2B 协作 API 和自定义](customize-invitation-api.md)
- [邀请内部用户参与 B2B 协作](invite-internal-users.md)
