...
>[!Important]
>本文适用于尝试使用自助服务密码重置注册的用户。 这意味着无需管理员的帮助即可重置自己的工作或学校密码（如 alain@contoso.com）。 如果你是管理员，并且正在查找有关如何为员工或其他用户打开自助式密码重置的详细信息，请参阅[部署 Azure AD 自助式密码重置](../authentication/howto-sspr-deployment.md)以及其他文章。
