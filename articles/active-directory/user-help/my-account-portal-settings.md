---
title: 在“我的帐户”门户中更改设置 - Azure AD
description: 了解如何通过“我的帐户”门户的“设置和隐私”页更改语言或区域设置。
...
---
# <a name="view-or-change-your-settings-in-the-my-account-portal"></a>在“我的帐户”门户中查看或更改设置

可以在“我的帐户”门户中，从“我的帐户”门户的“设置和隐私”页查看或更改帐户设置，如语言或时区。 
...
1. 登录到工作或学校帐户，然后转到 https://myaccount.microsoft.com/ 页。 如果你使用个人 Microsoft 帐户登录，你仍可以使用组织的域名（例如 contoso.com）登录，也可以以管理员身份使用组织的“租户 ID”通过以下 URL 之一登录：

   - https://myaccount.microsoft.com?tenantId= your_domain_name
   - https://myaccount.microsoft.com?tenant= your_tenant_ID

1. 从左侧导航窗格中选择“设置和隐私”，或从“设置和隐私”块中选择“查看设置和隐私”链接  。

    ![“我的帐户”页，其中突出显示了“设置和隐私”链接](media/my-account-portal/my-account-portal-privacy.png)

1. 在“语言和区域(预览)”下，查看或更改以下设置：
    * 显示语言：按钮、菜单和 Microsoft 网站中的某些内容所使用的语言。
    * 首选语言：你了解并用于创建或使用内容的语言。
    * 区域格式：Microsoft 网站使用此设置对日期和时间的格式进行设置。
    * 时区：用于高效地在 Microsoft 日历中计划会议。

更改显示语言后，建议注销并登录到你的工作或学校帐户，以确保刷新了显示语言。

> [!NOTE]
> 在某些组织中，无法管理“显示语言”设置。 如果显示语言已禁用，如以下示例屏幕截图所示，请联系 IT 管理员寻求帮助：
>
> ![“我的帐户”页，其中显示组织已禁用“显示语言”设置](media/my-account-portal/my-account-portal-managed-language-settings.png)
