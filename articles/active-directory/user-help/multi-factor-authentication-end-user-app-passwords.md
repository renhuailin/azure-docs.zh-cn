...
- 你的组织使用了双重验证和 Office 365 门户。 如果在组织中使用工作或学校帐户（例如 alain@contoso.com）、双重验证和 Microsoft 365 应用，则可以在[“Office 365 门户”页](https://www.office.com)中管理应用密码。 有关详细说明，请参阅本文中的[使用 Office 365 门户创建和删除应用密码](#create-and-delete-app-passwords-using-the-office-365-portal)。
...
1. 在“应用密码”页中，选择要删除的应用密码旁边的“删除” 。
   ...
   ![屏幕截图显示了在“应用密码”页上删除应用密码](media/multi-factor-authentication-end-user-app-passwords/mfa-app-passwords-page-delete.png)
...
1. 登录到工作或学校帐户，转到[“我的帐户”页](https://myaccount.microsoft.com)，然后选择“安全信息”。

    ![显示了“安全信息”选项卡的 Office 门户](media/multi-factor-authentication-end-user-app-passwords/mfa-security-info.png)

2. 选择“添加方法”，从下拉列表中选择“应用密码”，然后单击“添加”。

    ![“安全信息”页，其中包含“添加方法”下拉列表](media/multi-factor-authentication-end-user-app-passwords/mfa-add-method.png)

3. 为应用密码输入一个名称，然后选择“下一步”。

    ![“创建应用密码”页，其中包含应用密码的名称](media/multi-factor-authentication-end-user-app-passwords/mfa-enter-app-password-name.png)

4. 从“应用密码”页中复制密码，然后选择“完成” 。

    ![“应用密码”页，其中包含你创建的新应用密码](media/multi-factor-authentication-end-user-app-passwords/mfa-copy-app-password.png)

5. 在“安全信息”页上，确保列出了你的应用密码。

    ![“安全信息”页，其中的列表显示了新的应用密码](media/multi-factor-authentication-end-user-app-passwords/mfa-verify-app-password.png)  

6. 打开为其创建了应用密码的应用（例如，Outlook 2016），然后在系统要求时粘贴应用密码。 只需针对每个应用执行一次此操作。

### <a name="to-delete-app-passwords-using-the-security-info-page"></a>使用“安全信息”页删除应用密码

1. 在“安全信息”页中，选择要删除的应用密码旁边的“删除” 。

   ![屏幕截图显示了在“安全信息”页上删除应用密码](media/multi-factor-authentication-end-user-app-passwords/mfa-delete-app-password.png)
