...
description: Azure AD 多重身份验证借助哪些信息来对用户进行身份验证？
...
本文档介绍在需要删除 Azure 多重身份验证服务器 (MFA) 和 Azure AD MFA（基于云的）收集的用户信息时，如何查找这些信息。

[!INCLUDE [gdpr-hybrid-note](../../../includes/gdpr-hybrid-note.md)]

## <a name="information-collected"></a>收集的信息

MFA 服务器、NPS 扩展和 Windows Server 2016 Azure AD MFA AD FS 适配器收集以下信息，并将其存储 90 天。
...
更改（用于同步用户对 MFA 服务器或 Azure AD 的更改）：
...
## <a name="delete-data-from-windows-server-2016-azure-ad-mfa-ad-fs-adapter"></a>从 Windows Server 2016 Azure AD MFA AD FS 适配器删除数据
