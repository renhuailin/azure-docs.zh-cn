...
以下 HTTP POST 请求 https://graph.microsoft.com Web API 的访问令牌。 `client_id` 标识请求访问令牌的服务。
...
以下 HTTP POST 请求具有证书的 https://graph.microsoft.com Web API 的访问令牌。 `client_id` 标识请求访问令牌的服务。
