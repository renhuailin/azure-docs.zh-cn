...
如果 JSON 有效负载中的某些属性是包含属性的对象，可以使用点表示法直接引用这些对象。 点表示法不适用于 [Cosmos DB](./functions-bindings-cosmosdb-v2.md) 绑定或[表存储](./functions-bindings-storage-table-output.md)绑定。 
