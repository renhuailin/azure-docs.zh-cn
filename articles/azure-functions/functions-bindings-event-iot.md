...
本系列文章介绍如何对 IoT 中心使用 Azure Functions 绑定。 IoT 中心支持基于 [Azure 事件中心绑定](functions-bindings-event-hubs.md)。
...
| 操作 | 类型 |
|--------|------|
| 对发送到 IoT 中心事件流的事件进行响应。 | [触发器](./functions-bindings-event-iot-trigger.md) |
| 将事件写入到 IoT 事件流 | [输出绑定](./functions-bindings-event-iot-output.md) |
