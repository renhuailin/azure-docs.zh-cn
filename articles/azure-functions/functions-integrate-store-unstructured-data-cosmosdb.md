...
1. 选择“运行”并验证是否返回了 200 状态。
    ...
    :::image type="content" source="./media/functions-integrate-store-unstructured-data-cosmosdb/functions-test-function-output.png" alt-text="屏幕截图显示选择“运行”后突出显示的 HTTP 响应代码 200 状态。" border="true":::
