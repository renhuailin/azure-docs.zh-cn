...
> [!NOTE]
> 在预览版中，Kubernetes 上的事件网格功能通过 API 版本 [2020-10-15-Preview](/rest/api/eventgrid/version2020-10-15-preview/eventsubscriptions/createorupdate) 得到支持。 
...
你还可以分别为每个订阅指定重试策略限制。 有关为每个订阅方配置默认值的信息，请参阅 [API 文档](/rest/api/eventgrid/version2020-10-15-preview/eventsubscriptions/createorupdate)。 订阅级别默认值将替代 Kubernetes 上的事件网格模块级别配置。
