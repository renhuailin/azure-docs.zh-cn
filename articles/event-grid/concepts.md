...
还有另一种类型的主题：合作伙伴主题。 利用[合作伙伴事件](partner-events-overview.md)功能，第三方 SaaS 提供商可从它的服务发布事件，使这些事件可供那些能够订阅这些事件的使用者使用。 SaaS 提供商会公开一种主题类型，即订阅者用于使用事件的 **合作伙伴主题**。 它还会通过分离事件发布者和订阅者使用的资源的问题和所有权来提供干净的“发布-订阅”模型。
