---
title: Azure PowerShell - 在 Azure 事件网格中使用 Azure AD 用户保障 WebHook 传递的安全
description: 介绍如何使用 Azure 事件网格将事件传送到受 Azure AD 用户保护的 HTTPS 终结点
...
ms.locfileid: "129621209"
---
# <a name="secure-webhook-delivery-with-azure-ad-user-in-azure-event-grid"></a>在 Azure 事件网格中使用 Azure AD 用户保障 WebHook 传递的安全

此脚本提供配置来使用 Azure 事件网格将事件传送到受 Azure AD 用户保护的 HTTPS 终结点。
