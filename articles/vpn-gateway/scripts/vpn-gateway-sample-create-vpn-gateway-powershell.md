---
title: Azure PowerShell 脚本示例 - 创建 VPN 网关
...
ms.locfileid: "100385874"
---
# <a name="create-a-vpn-gateway---powershell-script-sample"></a>创建 VPN 网关 - PowerShell 脚本示例

此 PowerShell 脚本创建基于路由的 VPN 网关。
