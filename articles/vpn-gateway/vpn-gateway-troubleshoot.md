---
title: Azure VPN 网关：对配置和连接进行排除故障
...
* [使用诊断日志对 Azure VPN 网关进行故障排除](troubleshoot-vpn-with-azure-diagnostics.md)<br>使用诊断日志，可以对与多个 VPN 网关相关事件进行故障排除，其中包括配置活动、VPN 隧道连接、IPsec 日志记录、BGP 路由交换、点到站点的高级日志记录。 
