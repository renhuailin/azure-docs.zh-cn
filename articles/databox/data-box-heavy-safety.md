...
| ![通知图标](./media/data-box-heavy-safety/notice-icon.png) 注意： |指示应该给予重视但不涉及危险情况的信息。 |
...
* 检查收到的原始设备是否有损坏。 如果设备机箱受损，请联系 [Microsoft 支持部门](data-box-disk-contact-microsoft-support.md)获取更换件。 请勿尝试操作设备。 
* 设备上配备了防篡改螺丝。 如果你怀疑设备功能不正常，请联系 [Microsoft 支持部门](data-box-disk-contact-microsoft-support.md)获取更换件。 请勿尝试自行维修设备。 
...
* 根据以下电源规格提供带电力过载保护的合适电源：
    ...
    - 电流：每条电源线的最大值为 6 A 到 10 A。 提供了四条电源线。
    - 频率：50Hz 到 60Hz
...
* 仅限维修人员：如果更换的电池类型不正确，会有爆炸的风险。 请根据说明处置已用完的电池。
* 存在激光外设或装置。 为了避免受到辐射和/或人身伤害，请不要打开任何激光外设或装置的外壳。 激光外设或装置不可检修。 对于光学收发器产品，请仅使用经认证和分级的 I 类激光器件。

![通知图标](./media/data-box-heavy-safety/notice-icon.png) 注意：
...
- 设计为在以下环境中工作。 
    ...
    - 相对湿度：20% 到 85%（非冷凝） 
    - 工作海拔：经测试最高达 6,560 英尺（最高 2000 米）
