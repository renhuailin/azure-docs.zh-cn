...
2. 使用 PowerShell [Get-AZConfigurationAssignment](/powershell/module/az.maintenance/get-azconfigurationassignment) 命令检索维护配置：
    ...
    - 对于 Azure VM，请运行：
        ...
        ```
3. 使用 CLI [az maintenance assignment](/cli/azure/maintenance/assignment) 命令检索维护配置：
