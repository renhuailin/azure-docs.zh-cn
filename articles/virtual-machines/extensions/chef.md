...
可在 [Azure 快速入门库](https://github.com/Azure/azure-quickstart-templates/tree/master/application-workloads/chef/chef-json-parameters-linux-vm)中找到包含 Chef VM 扩展的示例资源管理器模板。
...
> [!NOTE]
> 如需直接与 Chef 相关的任何其他内容，请联系 [Chef 支持人员](https://www.chef.io/support/)。
