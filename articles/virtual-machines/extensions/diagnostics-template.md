...
* 有关具有诊断扩展的 Windows 虚拟机的完整示例模板，请参阅 [vm-monitoring-diagnostics-extension](https://github.com/Azure/azure-quickstart-templates/tree/master/quickstarts/microsoft.compute/vm-monitoring-diagnostics-extension)
* 使用 [Azure PowerShell](../windows/ps-template.md) 或 [Azure 命令行](../linux/create-ssh-secured-vm-from-template.md)部署资源管理器模板
* 了解有关[创作 Azure 资源管理器模板](../../azure-resource-manager/templates/syntax.md)的详细信息