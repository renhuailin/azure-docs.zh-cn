---
title: Azure VM 对 SAP NetWeaver 的高可用性 | Microsoft Docs
description: 在本文中，了解 Azure 虚拟机对 SAP NetWeaver 的高可用性。
...
本文同时涵盖 ![Windows 徽标。][Logo_Windows] Windows 和 ![Linux 徽标。][Logo_Linux] **Linux**。
...
* ![Windows 徽标。][Logo_Windows] [针对 SAP ASCS/SCS 实例使用 Windows 故障转移群集和共享磁盘，以为 SAP 高可用性准备 Azure 基础结构][sap-high-availability-infrastructure-wsfc-shared-disk]

* ![Windows 徽标。][Logo_Windows] [针对 SAP ASCS/SCS 实例使用 Windows 故障转移群集和文件共享，以为 SAP 高可用性准备 Azure 基础结构][sap-high-availability-infrastructure-wsfc-file-share]

* ![Linux 徽标。][Logo_Linux] [针对 SAP ASCS/SCS 实例使用 SUSE Linux Enterprise Server 群集框架，以为 SAP 高可用性准备 Azure 基础结构][sap-suse-ascs-ha-setting-ha-nfs]

* ![Linux 徽标。][Logo_Linux] [针对包含 Azure NetApp 文件的 SAP ASCS/SCS 实例使用 SUSE Linux Enterprise Server 群集框架，以为 SAP 高可用性准备 Azure 基础结构][sap-suse-ascs-ha-setting-ha-anf]

* ![RHEL][Logo_Linux] [为 SAP ASCS/SCS 高可用性准备 Azure 基础结构 - 在 RHEL 上安装 GlusterFS][high-availability-guide-rhel-glusterfs]

* ![RHEL][Logo_Linux] [为 SAP ASCS/SCS 高可用性准备 Azure 基础结构 - 在 RHEL 上安装 Pacemaker][high-availability-guide-rhel-pacemaker]
...
* ![Windows 徽标。][Logo_Windows] [针对 SAP ASCS/SCS 实例使用 Windows 故障转移群集和共享磁盘，以安装 SAP NetWeaver 高可用性][sap-high-availability-installation-wsfc-shared-disk]

* ![Windows 徽标。][Logo_Windows] [针对 SAP ASCS/SCS 实例使用 Windows 故障转移群集和文件共享，以安装 SAP NetWeaver 高可用性][sap-high-availability-installation-wsfc-file-share]

* ![Linux 徽标。][Logo_Linux] [针对 SAP ASCS/SCS 实例使用 SUSE Linux Enterprise Server 群集框架，以安装 SAP NetWeaver 高可用性][sap-suse-ascs-ha-sap-installation]

* ![Linux 徽标。][Logo_Linux] [针对包含 Azure NetApp 文件的 SAP ASCS/SCS 实例使用 SUSE Linux Enterprise Server 群集框架，以安装 SAP NetWeaver 高可用性][sap-suse-ascs-ha-sap-installation-anf]

* ![RHEL][Logo_Linux] [在 RHEL 上的高可用性配置中安装 SAP NetWeaver ASCS/SCS][sap-rhel-ascs-ha]

* ![RHEL][Logo_Linux] [在包含 Azure NetApp 文件的 RHEL 上的高可用性配置中安装 SAP NetWeaver ASCS/SCS][sap-rhel-ascs-ha-sap-installation-anf]
