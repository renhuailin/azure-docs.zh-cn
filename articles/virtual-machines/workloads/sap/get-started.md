...
- 03/03/2021：在 [SAP ASCS/SCS 的 HA 指南中更改了 WSFC 和 Azure NetApp 文件 (SMB) ](./high-availability-guide-windows-netapp-files-smb.md) 添加采取警告语句，以便在安装 SAP 系统的过程中，运行 SWPM 的用户需要提升的权限
