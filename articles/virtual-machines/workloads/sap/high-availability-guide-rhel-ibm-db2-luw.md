...
| [RHEL 高可用性群集的支持策略 - 群集中的 IBM Db2 for Linux、Unix 和 Windows 管理][rhel-db2-supp]
...
有关 Azure 中 Linux Pacemaker 的详细信息，请参阅[在 Azure 中的 SUSE Linux Enterprise Server 上设置 Pacemaker][rhel-pcs-azr]。
...
要为此 BM Db2 服务器创建基本 Pacemaker 群集，请参阅[在 Azure 中的 SUSE Linux Enterprise Server 上设置 Pacemaker][rhel-pcs-azr]。 
