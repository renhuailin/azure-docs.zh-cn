...
| Standard_B20ms | 20 | 1 | Intel(R) Xeon(R) CPU E5-2673 v3 或 v4| 2 | 90.6 | 1.3 |
...
## <a name="ncsv2---gpu-enabled"></a>NCSv2 - 支持 GPU
...
## <a name="nc---gpu-enabled"></a>NC - 支持 GPU
...
## <a name="nds--gpu-enabled"></a>ND - 支持 GPU
...
## <a name="nv---gpu-enabled"></a>NV - 支持 GPU
