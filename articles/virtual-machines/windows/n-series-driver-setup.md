...
如果选择手动安装 NVIDIA GPU 驱动程序，请参阅本文，其中提供了受支持的操作系统、驱动程序以及安装和验证步骤。 针对 [Linux VM](../linux/n-series-driver-setup.md) 也提供了驱动程序手动安装信息。
...
请注意，Nvidia 控制面板只能通过安装 GRID 驱动程序进行访问。 如果已安装 CUDA 驱动程序，则 Nvidia 控制面板将不可见。
