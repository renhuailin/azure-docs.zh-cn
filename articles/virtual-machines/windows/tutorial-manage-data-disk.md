...
使用 [Get-Credential](/powershell/module/microsoft.powershell.security/get-credential?view=powershell-5.1&preserve-view=true) 设置虚拟机上管理员帐户所需的用户名和密码：
