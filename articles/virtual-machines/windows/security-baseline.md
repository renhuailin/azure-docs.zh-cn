---
title: 适用于 Windows 虚拟机的 Azure 安全基线
...
ms.locfileid: "107284599"
---
# <a name="azure-security-baseline-for-windows-virtual-machines"></a>适用于 Windows 虚拟机的 Azure 安全基线

此安全基线将 [Azure 安全基准版本 1.0](../../security/benchmarks/overview-v1.md) 中的指导应用于 Windows 虚拟机。 Azure 安全基准提供有关如何在 Azure 上保护云解决方案的建议。 内容按“安全控件”分组，这些控件按适用于 Windows 虚拟机的 Azure 安全基准和相关的指导定义。

> [!NOTE]
> 排除了不适用于 Windows 虚拟机或 Microsoft 为其责任方的控件。 若要查看 Windows 虚拟机如何完全映射到 Azure 安全基准，请参阅[完整的 Windows 虚拟机安全基线映射文件](https://github.com/MicrosoftDocs/SecurityBenchmarks/blob/master/Azure%20Offer%20Security%20Baselines/1.1/windows-virtual-machines-security-baseline-v1.1.xlsx)。
...
- [如果你的组织想要保留来自虚拟机的安全事件日志数据，则可以将其存储在某个数据集合层中，此时可以在 Log Analytics 中对其进行查询。存在不同的层：“最小”、“常用”和“全部”，详见此链接](https://docs.microsoft.com/azure/security-center/security-center-enable-data-collection#data-collection-tier)
...
- [如何使用 Azure Monitor 收集平台日志和指标](https://docs.microsoft.com/azure/azure-monitor/essentials/activity-log#view-the-activity-log)
...
**指导**：Windows 虚拟机和 Azure Active Directory (Azure AD) 没有默认密码的概念。 客户对可能使用默认密码的第三方应用程序和市场服务负责。
...
- [Azure 托管磁盘的服务器端加密](/azure/virtual-machines/windows/disk-encryption)

- [适用于 Windows VM 的 Azure 磁盘加密](/azure/virtual-machines/windows/disk-encryption-overview)
...
- [如何将自定义 VM VHD 上传到 Azure](upload-generalized-managed.md)
...
- [Azure Key Vault 软删除概述](/azure/key-vault/general/overview-soft-delete)
