...
ms.locfileid: "113587852"
---
# <a name="compute-benchmark-scores-for-linux-vms"></a>Linux VM 的计算基准测试分数
以下 CoreMark 基准测试分数显示运行 Ubuntu 18.04 的 Azure 高性能 VM 产品阵容的计算性能。 此外，还提供了 [Windows VM](../windows/compute-benchmark-scores.md)的计算基准测试分数。

## <a name="azure-coremark-toc"></a>Azure (CoreMark) TOC
| 类型 | 系列 |
| ---- | -------- |
| [计算优化](#compute-optimized) | [Fsv2](#fsv2---compute--premium-storage)  |
| [常规用途](#general-purpose) | [B](#b---burstable) [Dsv3](#dsv3---general-compute--premium-storage) [Dv3](#dv3---general-compute) [DSv2](#dsv2---general-purpose--premium-storage) [Dv2](#dv2---general-compute) [Dasv4](#dasv4) [Dav4](#dav4) [DC](#dcs---confidential-compute-series) [DCv2](#dcsv2) [Ddsv4](#ddsv4) [Ddv4](#ddv4) [Dsv4](#dsv4) [Dv4](#dv4)  |
| [高性能计算](#high-performance-compute) | [HBv2](#hbrsv2) [HB](#hbs---memory-bandwidth-amd-epyc) [HC](#hcs---dense-computation-intel-xeon-platinum-8168)  |
| [内存优化](#memory-optimized) | [DSv2](#dsv2---general-purpose--premium-storage) [Dv2](#dv2---general-compute) [Esv3](#esv3---memory-optimized--premium-storage) [Ev3](#ev3---memory-optimized) [Easv4](#easv4) [Eav4](#eav4) [Edsv4](#edsv4) [Edv4](#edv4) [Esv4](#esv4) [Ev4](#ev4) [Msv2](#msv2-high-memory) [Ms](#m-series-medium-memory)  |
| [存储优化](#storage-optimized) | [Lsv2](#lsv2---storage-optimized)  |
...
### <a name="dsv2---general-purpose--premium-storage"></a>DSv2 - 常规用途 + 高级存储
...
| VM 大小 | CPU | vCPU | NUMA 节点 | Memory(GiB) | 平均分数 | 标准偏差 | StdDev% | 运行次数 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_D2as_v4 | AMD EPYC 7452 32-Core 处理器 | 2 | 1 | 8.0 | 38,230 | 313 | 0.82% | 77 |
| Standard_D4as_v4 | AMD EPYC 7452 32-Core 处理器 | 4 | 1 | 16.0 | 71,707 | 790 | 1.10% | 98 |
| Standard_D8as_v4 | AMD EPYC 7452 32-Core 处理器 | 8 | 1 | 32.0 | 151,474 | 1,599 | 1.06% | 56 |
| Standard_D16as_v4 | AMD EPYC 7452 32-Core 处理器 | 16 | 2 | 64.0 | 292,074 | 9,782 | 3.35% | 91 |
| Standard_D32as_v4 | AMD EPYC 7452 32-Core 处理器 | 32 | 4 | 128.0 | 575,465 | 14,574 | 2.53% | 98 |
| Standard_D48as_v4 | AMD EPYC 7452 32-Core 处理器 | 48 | 6 | 192.0 | 843,316 | 21,739 | 2.58% | 105 |
| Standard_D64as_v4 | AMD EPYC 7452 32-Core 处理器 | 64 | 8 | 256.0 | 1,120,467 | 30,714 | 2.74% | 7 |
...
| VM 大小 | CPU | vCPU | NUMA 节点 | Memory(GiB) | 平均分数 | 标准偏差 | StdDev% | 运行次数 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_D2a_v4 | AMD EPYC 7452 32-Core 处理器 | 2 | 1 | 8.0 | 38,061 | 1,219 | 3.20% | 119 |
| Standard_D4a_v4 | AMD EPYC 7452 32-Core 处理器 | 4 | 1 | 16.0 | 70,996 | 2,280 | 3.21% | 140 |
| Standard_D8a_v4 | AMD EPYC 7452 32-Core 处理器 | 8 | 1 | 32.0 | 151,379 | 1,946 | 1.29% | 147 |
| Standard_D16a_v4 | AMD EPYC 7452 32-Core 处理器 | 16 | 2 | 64.0 | 293,654 | 6,263 | 2.13% | 161 |
| Standard_D32a_v4 | AMD EPYC 7452 32-Core 处理器 | 32 | 4 | 128.0 | 571,897 | 16,009 | 2.80% | 147 |
| Standard_D48a_v4 | AMD EPYC 7452 32-Core 处理器 | 48 | 6 | 192.0 | 837,332 | 22,923 | 2.74% | 161 |
| Standard_D64a_v4 | AMD EPYC 7452 32-Core 处理器 | 64 | 8 | 256.0 | 1,126,793 | 29,148 | 2.59% | 21 |
| Standard_D96a_v4 | AMD EPYC 7452 32-Core 处理器 | 96 | 12 | 384.0 | 1,590,434 | 31,887 | 2.00% | 14 |

### <a name="dcs---confidential-compute-series"></a>DCS - 机密计算系列
...
## <a name="high-performance-compute"></a>高性能计算
### <a name="hbrsv2"></a>HBrsv2
(10/16/2020 PBIID:7668456)

| VM 大小 | CPU | vCPU | NUMA 节点 | Memory(GiB) | 平均分数 | 标准偏差 | StdDev% | 运行次数 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_HB120rs_v2 | AMD EPYC 7V12 64 核处理器 | 120 | 30 | 456.0 | 2,631,430 | 81,949 | 3.11% | 21 |

### <a name="hbs---memory-bandwidth-amd-epyc"></a>HBS - 内存带宽 (AMD EPYC)
(10/14/2020 PBIID:7668456)

| VM 大小 | CPU | vCPU | NUMA 节点 | Memory(GiB) | 平均分数 | 标准偏差 | StdDev% | 运行次数 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_HB60rs | AMD EPYC 7551 32-Core 处理器 | 60 | 15 | 228.0 | 986,593 | 28,102 | 2.85% | 21 |

### <a name="hcs---dense-computation-intel-xeon-platinum-8168"></a>HCS - 密集型计算 (Intel Xeon Platinum 8168)
(10/14/2020 PBIID:7668456)
...
| VM 大小 | CPU | vCPU | NUMA 节点 | Memory(GiB) | 平均分数 | 标准偏差 | StdDev% | 运行次数 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_E2as_v4 | AMD EPYC 7452 32-Core 处理器 | 2 | 1 | 16.0 | 38,155 | 432 | 1.13% | 259 |
| Standard_E4as_v4 | AMD EPYC 7452 32-Core 处理器 | 4 | 1 | 32.0 | 71,500 | 1,260 | 1.76% | 259 |
| Standard_E8as_v4 | AMD EPYC 7452 32-Core 处理器 | 8 | 1 | 64.0 | 151,201 | 3,171 | 2.10% | 259 |
| Standard_E16as_v4 | AMD EPYC 7452 32-Core 处理器 | 16 | 2 | 128.0 | 293,186 | 6,371 | 2.17% | 280 |
| Standard_E20as_v4 | AMD EPYC 7452 32-Core 处理器 | 20 | 3 | 160.0 | 363,292 | 8,744 | 2.41% | 280 |
| Standard_E32as_v4 | AMD EPYC 7452 32-Core 处理器 | 32 | 4 | 256.0 | 570,199 | 14,140 | 2.48% | 294 |
| Standard_E48as_v4 | AMD EPYC 7452 32-Core 处理器 | 48 | 6 | 384.0 | 841,547 | 21,858 | 2.60% | 301 |
| Standard_E64as_v4 | AMD EPYC 7452 32-Core 处理器 | 64 | 8 | 512.0 | 1,108,151 | 28,783 | 2.60% | 28 |
| Standard_E96as_v4 | AMD EPYC 7452 32-Core 处理器 | 96 | 12 | 672.0 | 1,578,349 | 27,080 | 1.72% | 42 |
...
| VM 大小 | CPU | vCPU | NUMA 节点 | Memory(GiB) | 平均分数 | 标准偏差 | StdDev% | 运行次数 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_E2a_v4 | AMD EPYC 7452 32-Core 处理器 | 2 | 1 | 16.0 | 38,035 | 900 | 2.37% | 196 |
| Standard_E4a_v4 | AMD EPYC 7452 32-Core 处理器 | 4 | 1 | 32.0 | 71,345 | 949 | 1.33% | 196 |
| Standard_E8a_v4 | AMD EPYC 7452 32-Core 处理器 | 8 | 1 | 64.0 | 151,511 | 1,940 | 1.28% | 189 |
| Standard_E16a_v4 | AMD EPYC 7452 32-Core 处理器 | 16 | 2 | 128.0 | 292,668 | 7,220 | 2.47% | 196 |
| Standard_E20a_v4 | AMD EPYC 7452 32-Core 处理器 | 20 | 3 | 160.0 | 361,845 | 9,332 | 2.58% | 196 |
| Standard_E32a_v4 | AMD EPYC 7452 32-Core 处理器 | 32 | 4 | 256.0 | 570,615 | 14,419 | 2.53% | 196 |
| Standard_E48a_v4 | AMD EPYC 7452 32-Core 处理器 | 48 | 6 | 384.0 | 841,419 | 26,181 | 3.11% | 196 |
| Standard_E64a_v4 | AMD EPYC 7452 32-Core 处理器 | 64 | 8 | 512.0 | 1,116,891 | 28,545 | 2.56% | 14 |
| Standard_E96a_v4 | AMD EPYC 7452 32-Core 处理器 | 96 | 12 | 672.0 | 1,592,228 | 32,515 | 2.04% | 14 |
...
### <a name="msv2-high-memory"></a>Msv2 高内存
...
### <a name="m-series-medium-memory"></a>M 系列中等内存
...
### <a name="lsv2---storage-optimized"></a>Lsv2 - 存储优化
(10/13/2020 PBIID:7668456)

| VM 大小 | CPU | vCPU | NUMA 节点 | Memory(GiB) | 平均分数 | 标准偏差 | StdDev% | 运行次数 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_L8s_v2 | AMD EPYC 7551 32-Core 处理器 | 8 | 1 | 64.0 | 102,237 | 1,320 | 1.29% | 77 |
| Standard_L16s_v2 | AMD EPYC 7551 32-Core 处理器 | 16 | 2 | 128.0 | 198,472 | 3,734 | 1.88% | 70 |
| Standard_L32s_v2 | AMD EPYC 7551 32-Core 处理器 | 32 | 4 | 256.0 | 390,015 | 10,126 | 2.60% | 77 |
| Standard_L48s_v2 | AMD EPYC 7551 32-Core 处理器 | 48 | 6 | 384.0 | 583,388 | 15,479 | 2.65% | 77 |
| Standard_L64s_v2 | AMD EPYC 7551 32-Core 处理器 | 64 | 8 | 512.0 | 774,827 | 19,205 | 2.48% | 77 |
| Standard_L80s_v2 | AMD EPYC 7551 32-Core 处理器 | 80 | 10 | 640.0 | 966,682 | 22,811 | 2.36% | 77 |
...
Linux 分数是通过在 Ubuntu 18.04 上运行 CoreMark 计算得出的。 CoreMark 中配置的线程数设置为虚拟 CPU 的数目，并发设置为 `PThreads`。 目标迭代次数已根据预期性能进行调整，提供至少 20 秒（通常更长）的运行时。 最终分数表示已完成迭代次数除以运行测试所花费的秒数。 每项测试在每个 VM 上至少运行了七次。 测试运行日期如上所示。 于当天在支持 VM 的每个 Azure 公共区域中的多个 VM 上执行测试运行。 
...
已弃用的较旧系列不会显示出来。 N 系列未显示，因为它们以 GPU 为中心，并且 Coremark 不测量 GPU 性能。  较新的系列可能尚未进行基准测试。
此文档的先前版本引用了从 Ubuntu 16.04 运行的基准，其性能略低于在 Ubuntu 18.04 上运行的当前基准。
