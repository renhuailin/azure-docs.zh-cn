---
title: 使用 Azure CLI 创建分区的 VM
description: 使用 Azure CLI 在可用性区域中创建虚拟机
author: cynthn
...
ms.locfileid: "122692091"
---
# <a name="create-a-virtual-machine-in-an-availability-zone-using-azure-cli"></a>使用 Azure CLI 在可用性区域中创建虚拟机
...
若要验证 VM 的托管磁盘是否在可用性区域中，请使用 [az vm show](/cli/azure/vm) 命令返回磁盘 ID。 在此示例中，磁盘 ID 存储在变量中，会在稍后的步骤中用到。 
