---
title: Azure VM 上非托管磁盘的备份和灾难恢复
description: 本文介绍如何规划 Azure 中的 IaaS 虚拟机和磁盘的备份与灾难恢复。 本文档介绍这两种非托管磁盘。
author: roygara
ms.service: storage
ms.topic: conceptual
ms.date: 07/19/2017
...
ms.locfileid: "123113393"
---
# <a name="backup-and-disaster-recovery-for-azure-unmanaged-disks"></a>Azure 非托管磁盘的备份和灾难恢复

适用于：:heavy_check_mark: Linux VM :heavy_check_mark: Windows VM :heavy_check_mark: 灵活规模集

本文介绍如何规划 Azure 中的 IaaS 虚拟机 (VM) 和磁盘的备份与灾难恢复 (DR)。 本文档介绍非托管磁盘或页 blob。
