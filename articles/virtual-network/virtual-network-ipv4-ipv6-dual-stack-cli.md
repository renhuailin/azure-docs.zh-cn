...
使用 [az network lb create](/cli/azure/network/lb?view=azure-cli-latest) 创建名为 **dsLB** 的基本负载均衡器，其中包含名为 **dsLbFrontEnd_v4** 的前端池以及名为 **dsLbBackEndPool_v4** 的后端池（与在上一步骤中创建的 IPv4 公共 IP 地址 **dsPublicIP_v4** 相关联）。 
