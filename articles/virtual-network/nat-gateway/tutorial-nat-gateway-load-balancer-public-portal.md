...
5. 在“创建负载均衡器”页中，输入或选择以下信息： 
    ...
    | **项目详细信息** |   |
    | 订阅               | 选择订阅。    |    
    | 资源组         | 选择 **新建** 并在文本框中输入 **TutorPubLBNAT-rg**。 </br> 选择“确定”。|
    | **实例详细信息** |   |
    ...
    | 添加一个公共 IPv6 地址 | 请选择“否”。 </br> 有关 IPv6 地址和负载均衡器的详细信息，请参阅[什么是适用于 Azure 虚拟网络的 IPv6？](../ipv6-overview.md)  |
