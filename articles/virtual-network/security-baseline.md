...
ms.locfileid: "107285524"
---
# <a name="azure-security-baseline-for-virtual-network"></a>虚拟网络的 Azure 安全基线

此安全基线将 [Azure 安全基准版本 1.0](../security/benchmarks/overview-v1.md) 中的指南应用于 Azure 虚拟网络。 Azure 安全基准提供有关如何在 Azure 上保护云解决方案的建议。 内容按“安全控制”分组，这些控制根据适用于 Azure 虚拟网络的 Azure 安全基准和相关指南进行定义。 

> [!NOTE]
> 排除了不适用于虚拟网络或 Microsoft 为其责任方的控件。 若要查看虚拟网络如何完全映射到 Azure 安全基准，请参阅 **[完整的虚拟网络安全基线映射文件](https://github.com/MicrosoftDocs/SecurityBenchmarks/raw/master/Azure%20Offer%20Security%20Baselines/1.1/virtual-network-security-baseline-v1.1.xlsx)** 。
...
- [了解并使用应用程序安全组](https://docs.microsoft.com/azure/virtual-network/network-security-groups-overview#application-security-groups)
...
指导：使用 Azure Active Directory (Azure AD) 风险和标识保护功能配置对检测到的与虚拟网络的用户标识相关的可疑操作的自动响应。 将数据引入 Azure Sentinel 以做进一步调查。
...
- [评审 Azure 内置角色](https://docs.microsoft.com/azure/role-based-access-control/built-in-roles#networking)
