...
* 在某个也可向 Azure 中的递归解析程序（虚拟 IP 为 168.63.129.16）转发查询的 VM 上的目标虚拟网络中设置 DNS 服务器。 DNS 转发器示例可在 [Azure 快速入门模板库](https://azure.microsoft.com/en-us/resources/templates/dns-forwarder/)和 [GitHub](https://github.com/Azure/azure-quickstart-templates/tree/master/demos/dns-forwarder) 中获取。
...
使用经典部署模型时，可以在 Azure 门户或[网络配置文件](/previous-versions/azure/reference/jj157100(v=azure.100))中指定虚拟网络的 DNS 服务器。 对于云服务器，可以通过[服务配置文件](/previous-versions/azure/reference/ee758710(v=azure.100))或者在 PowerShell 中使用 [New-AzureVM](/powershell/module/servicemanagement/azure.service/new-azurevm) 指定 DNS 服务器。
...
* [Azure 服务配置架构](/previous-versions/azure/reference/ee758710(v=azure.100))
* [虚拟网络配置架构](/previous-versions/azure/reference/jj157100(v=azure.100))
* [使用网络配置文件配置虚拟网络](/previous-versions/azure/virtual-network/virtual-networks-using-network-configuration-file)
