...
ms.locfileid: "113438979"
---
# <a name="create-a-public-ip-address-using-a-resource-manager-template"></a>使用资源管理器模板创建公共 IP
...
本部分的代码可创建名为“myStandardZRPublicIP”的标准区域冗余公共 IPv4 地址。
...
本部分的代码可创建名为“myStandardZonalPublicIP”的标准区域公共 IPv4 地址。 
