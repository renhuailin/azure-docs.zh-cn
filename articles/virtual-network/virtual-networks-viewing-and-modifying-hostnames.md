...
3. 按照以下格式发送请求：`https://management.core.windows.net/<subscription-id>/services/hostedservices/<service-name>?embed-detail=true`
...
[Azure 服务配置架构 (.cscfg)](/previous-versions/azure/reference/ee758710(v=azure.100))

[Azure 虚拟网络配置架构](/previous-versions/azure/reference/jj157100(v=azure.100))

[使用网络配置文件指定 DNS 设置](/previous-versions/azure/virtual-network/virtual-networks-specifying-a-dns-settings-in-a-virtual-network-configuration-file)
