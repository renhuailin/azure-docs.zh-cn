...
5. 在“子网”页中，更改以下任意设置：
    ...
    | **用户** | 可以使用内置角色或自己的自定义角色控制对子网的访问。 若要详细了解如何分配角色和用户来访问子网，请参阅 [分配 Azure 角色](../role-based-access-control/role-assignments-portal.md?toc=%2fazure%2fvirtual-network%2ftoc.json)。 |
