...
**指南**：使用 Azure Active Directory (AZURE AD) RBAC 来控制对数据和资源的访问，否则请使用特定于服务的访问控制方法。
...
- [了解 Azure 资源管理器中的数据保护](https://docs.microsoft.com/azure/azure-resource-manager/management/azure-resource-manager-security-controls#data-protection)
