...
有关完整的模板，请参阅[适用于 Azure SQL 数据库的快速入门模板](https://github.com/Azure/azure-quickstart-templates/blob/master/quickstarts/microsoft.sql/sql-database/azuredeploy.json)。
...
* 有关设置依赖项的建议，请参阅 [ARM 模板的最佳做法](./best-practices.md)。
* 若要了解如何在部署期间排查依赖项故障，请参阅[排查使用 Azure Resource Manager 时的常见 Azure 部署错误](common-deployment-errors.md)。
* 若要了解如何创建 Azure 资源管理器模板，请参阅[了解 ARM 模板的结构和语法](./syntax.md)。
