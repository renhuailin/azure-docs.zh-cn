---
title: Bicep 函数 - 对象
description: 描述在 Bicep 文件中用于处理对象的函数。
author: mumian
ms.author: jgao
ms.topic: conceptual
ms.date: 06/01/2021
...
ms.locfileid: "111025964"
---
# <a name="object-functions-for-bicep"></a>Bicep 的对象函数

资源管理器提供了一些用于处理 Bicep 文件中的对象的函数：
...
如需将某个参数值或变量包含在 JSON 对象中，可使用 [concat](./bicep-functions-string.md#concat) 函数创建要传递到此函数的字符串。
