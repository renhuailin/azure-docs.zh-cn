---
title: 管理 Azure 开发测试实验室中用于创建 VM 的公式
...
4. 在实验室的页面的左侧菜单中选择“公式(可重用的基础映像)”。
5. 在“公式”页面上，选择“+ 添加”。
   
    ![添加公式](./media/devtest-lab-create-formulas/add-formula.png)
6. 在“选择基础映像”页面上，选择要从中创建公式的基础映像（自定义映像、市场映像或共享映像库映像）。

    :::image type="content" source="./media/devtest-lab-create-formulas/select-base.png" alt-text="选择基础映像":::
1. 在“创建公式”页面的“基本设置”选项卡上，指定以下值：
    ...
    * **项目** - 选择“添加或删除项目”页面，可以从中选择并配置要添加到基本映像的项目。 有关项目的详细信息，请参阅[创建 Azure 开发测试实验室虚拟机的自定义项目](devtest-lab-artifact-author.md)。
        ...
        ![“基本设置”页](./media/devtest-lab-create-formulas/basic-settings.png)
8. 切换到“高级设置”选项卡，并指定以下值：
    ...
    - “使此计算机可索取” - 使计算机可“索取”的意思是在创建时不会为其分配所有权。 而是，实验室用户将能够在实验室的页面上取得（“索取”）计算机的所有权。  
        ...
        ![屏幕截图，显示“创建公式(可重用的基础映像)”页面的“高级设置”。](./media/devtest-lab-create-formulas/advanced-settings.png)
    - 如果选择“共享映像库映像”作为基础映像，则还会看到“映像版本”字段，使用该字段可以从库中选择要用作基础映像的映像版本。 
...
4. 在实验室的页面上，选择“公式（可重用基项）”。
    ...
    ![显示实验室页面的屏幕截图，其中已选中“公式(可重用的基础映像)”。](./media/devtest-lab-manage-formulas/lab-settings-formulas.png)
