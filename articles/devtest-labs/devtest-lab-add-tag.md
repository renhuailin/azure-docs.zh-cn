---
title: 将标记添加到实验室
description: 了解如何在 Azure DevTest Labs 中创建自定义标记并使用标记对资源进行分类。 可以在订阅中找到全部具有标记的资源。
ms.topic: how-to
ms.date: 06/26/2020
...
> [!NOTE]
> 在实验室级别创建的标记会流经该实验室在你的订阅中启动的所有付费资源。 例如，实验室级别标记流向实验室 VM 的基础计算 VM。用户可以在成本管理的上下文中使用标记。 实验室级别标记会显示在用于成本管理的标记筛选器中。
...
* 浏览 [DevTest Labs Azure Resource Manager 快速入门模板库](https://github.com/Azure/azure-devtestlab/tree/master/samples/DevTestLabs/QuickStartTemplates)。
