---
title: 在实验室中缩放配额和限制
description: 本文介绍如何在 Azure 开发测试实验室中缩放实验室。 查看使用配额和限制，并请求增加配额。
ms.topic: how-to
ms.date: 06/26/2020
...
[Azure 订阅和服务限制](../azure-resource-manager/management/azure-subscription-service-limits.md)列出了某些最常用于 Azure 资源的配额。 最常用于实验室且带配额的资源包括：VM 核心、公共 IP 地址、网络接口、托管磁盘、Azure 角色分配，以及 ExpressRoute 线路。
