---
title: 在 Azure 开发测试实验室向 VM 添加项目 | Microsoft Docs
...
以下脚本将指定的项目应用到指定的 VM。 [Invoke-AzResourceAction](/powershell/module/az.resources/invoke-azresourceaction) 命令可执行此操作。  
...
- [为实验室指定必需项目](devtest-lab-mandatory-artifacts.md)
