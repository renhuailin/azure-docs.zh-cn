...
1. 确定你希望用户可以访问但尚未接受其条款的已授权映像。 例如，你可能会看到显示“已接受条款”或“需要评审条款”状态的数据科学虚拟机。
    ...
    ![此屏幕截图显示了 Data Science Virtual Machine 映像，其产品/服务状态为“已接受条款”和“需要评审条款”](./media/devtest-lab-create-custom-image-from-licensed-image/devtest-lab-licensed-images.png)
