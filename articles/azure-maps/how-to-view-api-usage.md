---
title: 查看 Azure Maps API 使用指标 | Microsoft Azure Maps
description: 了解如何查看 Azure Maps API 使用指标，例如请求总数、错误总数和可用性。 请参阅如何筛选数据和拆分结果。
author: anastasia-ms
ms.author: v-stharr
ms.date: 08/06/2018
ms.topic: how-to
...
本文介绍如何在 [Azure 门户](https://portal.azure.com)中查看 Azure Maps 帐户的 API 使用指标。 指标以便捷的图形形式显示，可自定义时间段。

## <a name="view-metric-snapshot"></a>查看指标快照

可在 Maps 帐户的“概述”页中查看部分常见指标。 当前，它可显示所选时间段的“请求总数”、“错误总数”和“可用性”。

![Azure Maps 使用指标概述](media/how-to-view-api-usage/portal-overview.png)
...
4. 在“指标”窗格中，选择以下选项之一：
   ...
   2. 使用情况 - 显示帐户的使用量计算情况。
      ...
      ![Azure Maps 使用指标窗格](media/how-to-view-api-usage/portal-metrics.png)
...
6. 添加指标后，可以从与该指标相关的属性中“添加筛选器”。 然后，选择要显示在图上的属性值。

    ![Azure Maps 使用指标筛选器](media/how-to-view-api-usage/filter.png)

7. 此外，还可以根据所选的指标属性，对指标“应用拆分”。 对于该属性的每个值，它允许将该图分为多个图。 在下图中，每个图的颜色对应图底部所示的属性值。

    ![Azure Maps 使用指标拆分](media/how-to-view-api-usage/splitting.png)
...
> [Azure Maps Web SDK 操作说明](how-to-use-map-control.md)

> [!div class="nextstepaction"] 
> [Azure Maps Android SDK 操作说明](how-to-use-android-map-control-library.md)
