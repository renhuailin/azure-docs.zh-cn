...
>[!NOTE]
> 可以使用作为[空间锚点示例应用](https://github.com/Azure/azure-spatial-anchors-samples)的一部分提供的[服务示例](https://github.com/Azure/azure-spatial-anchors-samples/tree/master/Sharing/SharingServiceSample)。
