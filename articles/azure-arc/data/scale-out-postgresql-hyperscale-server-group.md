...
本文档介绍如何横向扩展已启用 Azure Arc 的超大规模 PostgreSQL 服务器组。 本文档通过讲解一种方案来实现此目的。 如果不想浏览方案，只是希望阅读如何横向扩展，请跳转到“[横向扩展](#scale-out)”段落。
...
```
> [!NOTE]
> 如果创建了 PostgreSQL 版本 11 的服务器组，而不是 12，请改为运行以下命令：kubectl get postgresql-11
