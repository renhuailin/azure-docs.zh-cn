...
ms.locfileid: "123307484"
---
# <a name="azure-resource-graph-sample-queries-for-azure-arc"></a>针对 Azure Arc 的 Azure Resource Graph 示例查询

本页是针对 Azure Arc 的 [Azure Resource Graph](../governance/resource-graph/overview.md) 示例查询的集合。有关 Azure Resource Graph 示例的完整列表，请参阅[按类别的 Resource Graph 示例](../governance/resource-graph/samples/samples-by-category.md)和[按表的 Resource Graph 示例](../governance/resource-graph/samples/samples-by-table.md)。
