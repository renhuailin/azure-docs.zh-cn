---
title: 取消注册 VMM 服务器脚本
description: 本文介绍了 VMM 服务器上的清理脚本
manager: evansma
...
ms.locfileid: "112026212"
---
# <a name="cleanup-script-on-a-vmm-server"></a>在 VMM 服务器上清理脚本
如果 VMM 服务器处于“已断开连接”状态，请对 VMM 服务器下载并运行清理脚本。
