...
|||
20.04 LTS |[9.42](https://support.microsoft.com/en-us/topic/update-rollup-55-for-azure-site-recovery-kb5003408-b19c8190-5f88-43ea-85b1-d9e0cc5ca7e8)| 5.4.0-26-generic 到 5.4.0-60-generic </br> 5.4.0-1010-azure 到 5.4.0-1043-azure </br> 5.4.0-1047-azure </br> 5.4.0-73-generic </br> 5.4.0-1048-azure </br> 5.4.0-74-generic |
...
20.04 LTS |[9.40](https://support.microsoft.com/en-us/topic/update-rollup-53-for-azure-site-recovery-060268ef-5835-bb49-7cbc-e8c1e6c6e12a)| 5.4.0-26-generic 到 5.4.0-59-generic </br> 5.4.0-1010-azure 到 5.4.0-1035-azure </br> 5.4.0-1036-azure、5.4.0-60-generic、5.4.0-62-generic、5.4.0-1039-azure、5.4.0-64-generic、5.4.0-65-generic |
20.04 LTS |[9.39](https://support.microsoft.com/help/4597409/) | 5.4.0-26-generic 到 5.4.0-53-generic </br> 5.4.0-1010-azure 到 5.4.0-1031-azure </br> 通过 9.39 热修补程序修复 5.4.0-54-generic、5.4.0-1032-azure、5.4.0-56-generic、5.4.0-58-generic、5.4.0-1034-azure** |
20.04 LTS |[9.38](https://support.microsoft.com/help/4590304/) | 5.4.0-26-generic 到 5.4.0-48-generic </br> 5.4.0-1010-azure 到 5.4.0-1026-azure </br> 通过 9.38 热修补程序修复 5.4.0-51-generic、5.4.0-52-generic、5.4.0-1031-azure** |

**注意：为支持 15 天内发布的最新 Linux 内核，Azure Site Recovery 推出了基于最新移动代理版本的热修补程序。 此修补程序是在两个主要版本之间推出的。 若要更新到移动代理的最新版本（包括热修补程序），请按照[本文](service-updates-how-to.md#azure-vm-disaster-recovery-to-azure)中提及的步骤进行操作。 此修补程序当前是针对 Azure 到 Azure DR 方案中使用的移动代理推出的。

**注意：对于 Ubuntu 20.04，我们最初推出了适用于内核 5.8 的支持。* 但此后我们发现了对该内核的支持存在问题，因此暂时在我们的支持声明中修订了这些内核。 
...
磁盘订阅限制 | 每个订阅最多 3,000 个受保护磁盘 | 确保源订阅或目标订阅的 ASR 受保护磁盘（包括数据和操作系统）不超过 3,000 个。 
标准 SSD | 支持 |
