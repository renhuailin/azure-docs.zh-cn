...
6. 如果 VMM 服务器处于“已断开连接”状态，请在 VMM 服务器上下载并运行以下清理脚本。 使用“以管理员身份运行”选项打开 PowerShell，以更改默认 (LocalMachine) 范围的执行策略。 在脚本中，指定要删除的 VMM 服务器的 ID。 脚本会从服务器中删除注册和云配对信息。
