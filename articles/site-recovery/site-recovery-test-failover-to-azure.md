...
![Azure 门户中“测试故障转移”页面屏幕截图。](./media/site-recovery-test-failover-to-azure/TestFailover.png)
...
![“测试故障转移作业”选项卡屏幕截图。](./media/site-recovery-test-failover-to-azure/TestFailoverJob.png)
