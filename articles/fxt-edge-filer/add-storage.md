...
在开始配置群集 VServer 之前，请阅读链接文档并咨询 Microsoft 代表，以获取理解命名空间和 VServer 的帮助。 如果使用 VLAN，则在创建 VServer 之前[创建 VLAN](configure-network.md#adjust-network-settings)。
...
> [配置群集的网络设置](configure-network.md)
