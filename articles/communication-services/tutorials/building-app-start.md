...
- [nvm 和 npm](https://docs.microsoft.com/windows/nodejs/setup-on-windows)，用于处理版本控制。
- 适用于 Visual Studio Code 的 [Azure 存储扩展](https://marketplace.visualstudio.com/items?itemName=ms-azuretools.vscode-azurestorage)。 若要在 Azure 存储中发布应用程序，则需要使用此扩展。 [详细了解如何在 Azure 存储中托管静态网站](https://docs.microsoft.com/azure/storage/blobs/storage-blob-static-website)
...
- 用户访问令牌。 有关说明，请参阅[访问令牌快速入门](https://docs.microsoft.com/azure/communication-services/quickstarts/access-tokens?pivots=programming-language-javascript)或[受信任的服务](https://docs.microsoft.com/azure/communication-services/tutorials/trusted-service-tutorial)教程。
...
Windows 开发人员可按照[此 NodeJS 教程](https://docs.microsoft.com/windows/nodejs/setup-on-windows)来配置 Node、nvm 和 npm。 
