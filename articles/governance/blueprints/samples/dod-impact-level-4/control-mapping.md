...
ms.locfileid: "108757594"
---
# <a name="control-mapping-of-the-dod-impact-level-4-blueprint-sample"></a>DoD 影响级别 4 蓝图示例的控制映射

以下文章详细介绍了 Azure 蓝图国防部影响级别 4 (DoD IL4) 蓝图示例如何映射到 DoD 影响级别 4 控制。 有关控制的详细信息，请参阅 [DoD 云计算安全要求指南 (SRG)](https://dl.dod.cyber.mil/wp-content/uploads/cloud/pdf/Cloud_Computing_SRG_v1r3.pdf)。
