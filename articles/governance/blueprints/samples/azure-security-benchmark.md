...
ms.locfileid: "98919233"
---
# <a name="azure-security-benchmark-blueprint-sample"></a>Azure 安全基准蓝图示例

Azure 安全基准蓝图示例提供了监管防护措施，其中使用 [Azure Policy](../../policy/overview.md) 来帮助评估特定的 [Azure 安全基准 v1](../../../security/benchmarks/overview.md) 控制要求。 此蓝图帮助客户部署了一组核心策略，以用于客户要在其中实现 Azure 安全基准控制要求的、由 Azure 部署的任何体系结构。
...
1. 在“其他示例”下找到“Azure 安全基准 v1”蓝图示例，然后选择名称来选中此示例。
