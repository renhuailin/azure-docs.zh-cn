...
ms.locfileid: "128632113"
---
# <a name="iso-27001-blueprint-sample"></a>ISO 27001 蓝图示例

ISO 27001 蓝图示例使用 [Azure Policy](../../policy/overview.md) 提供治理防护措施，帮助你评估特定 ISO 27001 控制要求。 对于 Azure 部署的任何必须实现 ISO 27001 控制要求的体系结构，此蓝图可帮助客户为其部署一组核心策略。
