...
ms.locfileid: "96745615"
---
# <a name="recover-a-deleted-dashboard-in-the-azure-portal"></a>在 Azure 门户中恢复删除的仪表板

如果你在公共 Azure 云中，并在 Azure 门户中删除 _已发布_ 的仪表板，则可以在删除的14天内恢复该仪表板。 如果你使用的是 Azure 政府版云或仪表板未发布，则无法恢复它，你必须重新生成它。 有关发布仪表板的详细信息，请参阅[发布仪表板](azure-portal-dashboard-share-access.md#publish-dashboard)。 请按照以下步骤恢复已发布的仪表板：
