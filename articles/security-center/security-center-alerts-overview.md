...
---
# <a name="security-alerts-and-incidents-in-azure-security-center"></a>Azure 安全中心内的安全警报和事件
...
“安全事件”是相关警报的集合，而不是单独列出每个警报。 安全中心使用[云智能警报关联](#cloud-smart-alert-correlation-in-azure-security-center-incidents)将不同警报和低保真信号关联到安全事件。
...
要管理安全事件，请参阅[如何管理 Azure 安全中心中的安全事件](security-center-incident.md)。

## <a name="next-steps"></a>后续步骤

本文介绍了安全中心的各类警报。 有关详细信息，请参阅：

- [Azure 活动日志中的安全警报](https://go.microsoft.com/fwlink/?linkid=2114113) - 安全警报和事件除了在 Azure 门户中或以编程方式提供之外，还会作为 Azure 活动日志中的事件进行审核
