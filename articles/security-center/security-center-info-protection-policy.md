...
> [!IMPORTANT]
> 要自定义 Azure 租户的信息保护策略，需要拥有租户根管理组的管理权限。 有关详细信息，请参阅[授予和请求租户范围的可见性](tenant-wide-permissions-management.md)。

:::image type="content" source="./media/security-center-info-protection-policy/sql-information-protection-policy-page.png" alt-text="该页显示 SQL 信息保护策略":::
