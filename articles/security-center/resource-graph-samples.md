...
ms.locfileid: "114669872"
---
# <a name="azure-resource-graph-sample-queries-for-azure-security-center"></a>适用于 Azure 安全中心 的 Azure Resource Graph 示例查询

此页面是适用于 Azure 安全中心的 [Azure Resource Graph](../governance/resource-graph/overview.md) 示例查询的集合。 有关 Azure Resource Graph 示例的完整列表，请参阅 [Resource Graph 示例（按类别）](../governance/resource-graph/samples/samples-by-category.md)和 [Resource Graph 示例（按表）](../governance/resource-graph/samples/samples-by-table.md)。
