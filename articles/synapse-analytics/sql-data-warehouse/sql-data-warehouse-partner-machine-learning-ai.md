...
本文重点介绍具有机器学习和人工智能工具并且其解决方案支持 Azure Synapse Analytics 的 Microsoft 合作伙伴。

## <a name="machine-learning-and-ai-partners"></a>机器学习和 AI 合作伙伴
| Partner | 说明 | 网站/产品链接 |
| ------- | ----------- | -------------------- |
| ![Dataiku](./media/sql-data-warehouse-partner-machine-learning-and-ai/dataiku-logo.png) |**Dataiku**<br>Dataiku 是一个集中式数据平台，可推动从大规模分析到企业 AI 的企业数据迁移之旅，为自助式分析提供支持，同时确保机器学习模型可在生产环境中操作。 |[产品页面](https://www.dataiku.com/partners/microsoft/)<br> [Azure 市场](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/dataiku.dataiku-data-science-studio)<br> |
| ![MATLAB](./media/sql-data-warehouse-partner-machine-learning-and-ai/mathworks-logo.png) |**Matlab**<br>MATLAB® 是一个面向工程师和科学家的编程平台。 它将针对迭代分析和设计过程进行优化的桌面环境与直接表示矩阵和数组数学的编程语言组合在一起。 全球数以百万计的人将 MATLAB 用于一系列应用程序，其中包括机器学习、深度学习、信号和图像处理、控制系统和计算金融。 |[产品页面](https://www.mathworks.com/products/database.html)<br> [Azure 市场](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/mathworks-inc.matlab-byol?tab=Overview)<br> |
