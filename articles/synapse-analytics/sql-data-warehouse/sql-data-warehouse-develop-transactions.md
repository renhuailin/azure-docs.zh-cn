...
若要了解有关优化事务的详细信息，请参阅[事务最佳做法](sql-data-warehouse-develop-best-practices-transactions.md)。 若要了解其他 SQL 池最佳做法，请参阅 [SQL 池最佳做法](../sql/best-practices-dedicated-sql-pool.md)。