...
有关使用 Visual Studio 连接项目的详细信息，请参阅[在团队资源管理器中连接到项目](/visualstudio/ide/connect-team-project?view=vs-2019&preserve-view=true)。 有关使用 Visual Studio 克隆存储库的指南，请查看[克隆现有 Git 存储库](/azure/devops/repos/git/clone?tabs=visual-studio)一文。 
