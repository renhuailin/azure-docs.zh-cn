---
title: 适用于 Apache Spark 2.4 的 Azure Synapse 运行时
description: Apache Spark 2.4 支持的 Spark、Scala、Python 和 .NET 版本。
...
ms.locfileid: "122429242"
---
# <a name="azure-synapse-runtime-for-apache-spark-24"></a>适用于 Apache Spark 2.4 的 Azure Synapse 运行时

Azure Synapse Analytics 支持 Apache Spark 的多个运行时。 本文档将介绍适用于 Apache Spark 2.4 的 Azure Synapse 运行时的运行时组件和版本。
