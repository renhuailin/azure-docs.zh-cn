---
title: 适用于 Apache Spark 3.1 的 Azure Synapse 运行时
description: Apache Spark 3.1 支持的 Spark、Scala、Python 和 .NET 版本。
...
ms.locfileid: "128583523"
---
# <a name="azure-synapse-runtime-for-apache-spark-31"></a>适用于 Apache Spark 3.1 的 Azure Synapse 运行时 

Azure Synapse Analytics 支持 Apache Spark 的多个运行时。 本文档将介绍适用于 Apache Spark 3.1 的 Azure Synapse 运行时的运行时组件和版本。 
