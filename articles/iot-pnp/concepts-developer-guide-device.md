...
本指南介绍了创建遵循 [IoT 即插即用约定](../iot-pnp/concepts-convention.md)的设备、模块或 IoT Edge 模块所需的基本步骤。
...
在设备或模块实现就绪后，使用 [Azure IoT 资源管理器](howto-use-iot-explorer.md)来验证设备是否遵循 IoT 即插即用约定。
