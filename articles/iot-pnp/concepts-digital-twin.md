...
数字孪生体 API 包括“获取数字孪生体”、“更新数字孪生体”、“调用组件命令”和“调用命令”等用于管理数字孪生体的操作。 你可以直接使用 [REST API](/rest/api/iothub/service/digitaltwin)，也可以通过[服务 SDK](../iot-pnp/libraries-sdks.md) 使用它。
...
- [IoT 数字孪生体 REST API](/rest/api/iothub/service/digitaltwin)
