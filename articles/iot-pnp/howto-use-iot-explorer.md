...
对于设备，你可以连接你自己的设备，也可以使用其中一个示例模拟设备。 有关使用不同语言编写的一些模拟设备示例，请参阅[将示例 IoT 即插即用设备应用程序连接到 IoT 中心](quickstart-connect-device.md)快速入门。
...
本操作说明文章介绍如何安装和使用 Azure IoT 资源管理器，以便与 IoT 即插即用设备交互。 建议的下一步是了解如何[安装和使用 DTDL 创作工具](howto-use-dtdl-authoring-tools.md)。
