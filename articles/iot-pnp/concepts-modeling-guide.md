...
[适用于 Visual Studio Code 的 DTDL 编辑器](https://marketplace.visualstudio.com/items?itemName=vsciot-vscode.vscode-dtdl)提供了一个基于文本的编辑环境，其中包含语法验证和自动完成功能，以便更精细地控制模型创作体验。
...
IoT Central 实现了更多设备模型版本控制规则。 如果在 IoT Central 中对设备模板及其模型进行版本控制，则可以将设备从以前的版本迁移到更高版本。 但是，在没有固件升级的情况下，已迁移设备不能使用新功能。 若要了解详细信息，请参阅[创建新的设备模板版本](../iot-central/core/howto-version-device-template.md)。
...
- [安装和使用 DTDL 创作工具](howto-use-dtdl-authoring-tools.md)
