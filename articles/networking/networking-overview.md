...
客户可以选择部署[具有应用程序网关的 Azure WAF](../web-application-firewall/ag/ag-overview.md)，以便为公共和专用地址空间中的实体提供区域性保护。 客户还可以选择部署 [具有前门的 AZURE WAF](../web-application-firewall/afds/afds-overview.md) ，它提供网络边缘到公共终结点的保护。
