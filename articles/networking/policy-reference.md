...
description: 列出 Azure 网络服务的 Azure 策略内置策略定义。 这些内置的策略定义提供了管理 Azure 资源的常用方法。
ms.date: 02/04/2021
ms.topic: reference
author: KumudD
ms.author: kumud
...
ms.locfileid: "99559211"
---
# <a name="azure-policy-built-in-definitions-for-azure-networking-services"></a>适用于 Azure 网络服务的 azure 策略内置定义

此页是 azure 服务的 [Azure 策略](../governance/policy/overview.md) 内置策略定义的索引。 有关其他服务的其他 Azure Policy 内置定义，请参阅 [Azure Policy 内置定义](../governance/policy/samples/built-in-policies.md)。
