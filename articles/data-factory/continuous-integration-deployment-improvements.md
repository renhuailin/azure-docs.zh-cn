...
:::image type="content" source="media/continuous-integration-deployment-improvements/current-ci-cd-flow.png" alt-text="显示当前 CI/CD 流的关系图。":::
...
:::image type="content" source="media/continuous-integration-deployment-improvements/new-ci-cd-flow.png" alt-text="显示新的 CI/CD 流的关系图。":::
...
1. 打开 Azure DevOps 项目，然后转到“管道”。 选择“新建管道”。
   ...
   :::image type="content" source="media/continuous-integration-deployment-improvements/new-pipeline.png" alt-text="显示“新管道”按钮的屏幕截图。":::
...
3. 选择“初学者管道”。 如果已上传或合并 YAML 文件（如以下示例中所示），也可以直接指向该文件并对其进行编辑。
   ...
   :::image type="content" source="media/continuous-integration-deployment-improvements/starter-pipeline.png" alt-text="显示“初学者管道”的屏幕截图。":::
