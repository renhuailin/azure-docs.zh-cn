...
## <a name="create-a-linked-service-to-xero-using-ui"></a>使用 UI 创建一个到 Xero 的链接服务
...
2. 搜索 Xero 并选择 Xero 连接器。

   :::image type="content" source="media/connector-xero/xero-connector.png" alt-text="选择 Xero 连接器。":::    


1. 配置服务详细信息，测试连接，然后创建新的链接服务。

   :::image type="content" source="media/connector-xero/configure-xero-linked-service.png" alt-text="配置到 Xero 的链接服务。":::
