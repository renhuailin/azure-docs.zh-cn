...
| &nbsp; |[Azure SQL 数据库托管实例](../../azure-sql/managed-instance/sql-managed-instance-paas-overview.md) |
...
| &nbsp; |[泛型 HTTP](../connector-http.md)|
| &nbsp; |[Oracle 云存储](../connector-oracle-cloud-storage.md) |
| &nbsp; |[SFTP](../connector-sftp.md) |
| **通用协议** |[泛型 OData](../connector-odata.md) |
