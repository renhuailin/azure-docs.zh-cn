...
有关 Azure 存储身份验证的常规信息，请参阅[使用 Azure Active Directory 验证对 Azure 存储的访问权限](../storage/blobs/authorize-access-azure-active-directory.md)。 若要使用用户分配的托管标识身份验证，请执行以下步骤：
