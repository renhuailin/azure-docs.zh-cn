...
>[!TIP]
>还可以使用此连接器从 **Dynamics 365 Finance and Operations** 复制数据。 请参阅 Dynamics 365 的 [OData 支持](/dynamics365/unified-operations/dev-itpro/data-entities/odata)和[身份验证方法](/dynamics365/unified-operations/dev-itpro/data-entities/services-home-page#authentication)。

## <a name="get-started"></a>入门

[!INCLUDE [data-factory-v2-connector-get-started](includes/data-factory-v2-connector-get-started.md)]

## <a name="create-a-linked-service-to-dynamics-ax-using-ui"></a>使用 UI 创建一个到 Dynamics AX 的链接服务
...
2. 搜索 Dynamics 并选择 Dynamics AX 连接器。
    ...
    :::image type="content" source="media/connector-dynamics-ax/dynamics-ax-connector.png" alt-text="选择 Dynamics AX 连接器。":::    

1. 配置服务详细信息，测试连接，然后创建新的链接服务。

    :::image type="content" source="media/connector-dynamics-ax/configure-dynamics-ax-linked-service.png" alt-text="配置到 Dynamics AX 的链接服务。":::
