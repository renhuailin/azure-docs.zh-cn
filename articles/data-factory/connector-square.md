...
## <a name="create-a-linked-service-to-square-using-ui"></a>使用 UI 创建一个到 Square 的链接服务

使用以下步骤在 Azure 门户 UI 中创建一个到 Square 的链接服务。
...
2. 搜索 Square 并选择 Square 连接器。

   :::image type="content" source="media/connector-square/square-connector.png" alt-text="Square 连接器的屏幕截图。":::    


1. 配置服务详细信息，测试连接，然后创建新的链接服务。

   :::image type="content" source="media/connector-square/configure-square-linked-service.png" alt-text="Square 的链接服务配置的屏幕截图。":::
