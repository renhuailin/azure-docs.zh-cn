---
title: 从 Couchbase 复制数据（预览版）
description: 了解如何通过在 Azure 数据工厂或 Synapse Analytics 管道中使用复制活动，将数据从 Couchbase 复制到支持的接收器数据存储。
...
ms.locfileid: "124811759"
---
# <a name="copy-data-from-couchbase-using-azure-data-factory-preview"></a>使用 Azure 数据工厂（预览版）从 Couchbase 复制数据
[!INCLUDE[appliesto-adf-asa-md](includes/appliesto-adf-asa-md.md)]
本文概述如何使用 Azure 数据工厂或 Synapse Analytics 管道中的复制活动从 Couchbase 复制数据。 它是基于概述复制活动总体的[复制活动概述](copy-activity-overview.md)一文。
...
## <a name="create-a-linked-service-to-couchbase-using-ui"></a>使用 UI 创建到 Couchbase 的链接服务

使用以下步骤在 Azure 门户 UI 中创建一个到 Couchbase 的链接服务。
...
2. 搜索“Couchbase”并选择 Couchbase 连接器。

   :::image type="content" source="media/connector-couchbase/couchbase-connector.png" alt-text="Couchbase 连接器的屏幕截图。":::    


1. 配置服务详细信息，测试连接，然后创建新的链接服务。

   :::image type="content" source="media/connector-couchbase/configure-couchbase-linked-service.png" alt-text="Couchbase 的链接服务配置的屏幕截图。":::
