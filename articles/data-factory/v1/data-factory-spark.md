...
1. 在数据工厂编辑器中，选择 "**更多**  >  **新计算**" "  >  **HDInsight 群集**"。
...
1. 转到，启动 HDInsight Spark 群集的 Jupyter Notebook `https://CLUSTERNAME.azurehdinsight.net/jupyter` 。 也可以打开 HDInsight Spark 群集的群集仪表板，然后启动 Jupyter Notebook。

1. 选择 "**新建**  >  **PySpark** " 以启动新笔记本。
