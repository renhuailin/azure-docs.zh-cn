...
请参阅[自定义日期和时间格式字符串](/dotnet/standard/base-types/custom-date-and-time-format-strings)主题，其中介绍了可用的不同格式设置选项（例如：ay 和 yyyy）。 
...
请参阅[自定义日期和时间格式字符串](/dotnet/standard/base-types/custom-date-and-time-format-strings)主题，其中介绍了可用的不同格式设置选项（例如：yy 和 yyyy）。