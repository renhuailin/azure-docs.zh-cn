...
:::image type="content" source="./media/data-factory-copy-wizard/copy-data-wizard.png" alt-text="复制向导":::
...
:::image type="content" source="./media/data-factory-copy-wizard/select-data-source-page.png" alt-text="选择数据源":::
...
:::image type="content" source="./media/data-factory-copy-wizard/file-format-settings.png" alt-text="文件格式设置":::
...
:::image type="content" source="./media/data-factory-copy-wizard/schema-mapping.png" alt-text="架构映射":::
...
:::image type="content" source="./media/data-factory-copy-wizard/validate-expressions.png" alt-text="验证表达式":::
...
单击“文件或文件夹”的“浏览”按钮，找到其中一个文件夹（例如，2016-> 03-> 01-> 02），并单击“选择”。 应该会在文本框中看到 `2016/03/01/02`。 现在，请将“2016”替换为 {year}，将“03”替换为 {month}，将“01”替换为 {day}，将“02”替换为 {hour}，然后按 Tab 键。你应该看到可供选择这四个变量的格式的下拉列表：

:::image type="content" source="./media/data-factory-copy-wizard/blob-standard-variables-in-folder-path.png" alt-text="使用系统变量":::   
...
:::image type="content" source="./media/data-factory-copy-wizard/blob-custom-variables-in-folder-path.png" alt-text="使用自定义变量":::

## <a name="support-for-diverse-data-and-object-types"></a>支持多种不同的数据和对象类型
利用复制向导，可以高效移动数百个文件夹、文件或表。

:::image type="content" source="./media/data-factory-copy-wizard/select-tables-to-copy-data.png" alt-text="选择要从其中复制数据的表":::
...
:::image type="content" source="./media/data-factory-copy-wizard/scheduling-properties.png" alt-text="计划属性":::
