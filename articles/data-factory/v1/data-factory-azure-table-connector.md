...
将数据移入和移出 Azure 表时，[Azure 表服务定义的以下映射](/rest/api/storageservices/Understanding-the-Table-Service-Data-Model)将从 Azure 表 OData 类型转换为 .NET 类型，反之亦然。
