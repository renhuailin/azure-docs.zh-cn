---
title: 从/向 ODBC 数据存储复制数据
titleSuffix: Azure Data Factory & Azure Synapse
description: 了解如何通过在 Azure 数据工厂或 Synapse Analytics 管道中使用复制活动，从/向 ODBC 数据存储复制数据。
author: jianleishen
...
ms.locfileid: "124787824"
---
# <a name="copy-data-from-and-to-odbc-data-stores-using-azure-data-factory-or-synapse-analytics"></a>使用 Azure 数据工厂或 Synapse Analytics 从/向 ODBC 数据存储复制数据
...
## <a name="create-a-linked-service-to-an-odbc-data-store-using-ui"></a>使用 UI 创建一个到 ODBC 数据存储的链接服务
...
2. 搜索 ODBC 并选择 ODBC 连接器。
    ...
    :::image type="content" source="media/connector-odbc/odbc-connector.png" alt-text="ODBC 连接器的屏幕截图。":::    

1. 配置服务详细信息，测试连接，然后创建新的链接服务。

    :::image type="content" source="media/connector-odbc/configure-odbc-linked-service.png" alt-text="ODBC 数据存储的链接服务配置的屏幕截图。":::
