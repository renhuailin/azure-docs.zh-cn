---
title: 从 Drill 复制数据
description: 了解如何通过在 Azure 数据工厂或 Synapse Analytics 管道中使用复制活动，将数据从 Drill 复制到支持的接收器数据存储。
...
ms.locfileid: "124778013"
---
# <a name="copy-data-from-drill-using-azure-data-factory-or-synapse-analytics"></a>使用 Azure 数据工厂或 Synapse Analytics 从 Drill 复制数据

[!INCLUDE[appliesto-adf-asa-md](includes/appliesto-adf-asa-md.md)]

本文概述如何使用 Azure 数据工厂或 Synapse Analytics 管道中的复制活动从 Drill 复制数据。 它是基于概述复制活动总体的[复制活动概述](copy-activity-overview.md)一文。
...
## <a name="create-a-linked-service-to-drill-using-ui"></a>使用 UI 创建一个到 Drill 的链接服务
...
2. 搜索 Drill 并选择 Drill 连接线。
   ...
   :::image type="content" source="media/connector-drill/drill-connector.png" alt-text="Drill 连接器的屏幕截图。":::    


1. 配置服务详细信息，测试连接，然后创建新的链接服务。

   :::image type="content" source="media/connector-drill/configure-drill-linked-service.png" alt-text="Drill 的链接服务配置的屏幕截图。":::
...
| 属性 | 说明 | 必需 |
|:--- |:--- |:--- |
| type | 数据集的类型属性必须设置为：DrillTable | 是 |
