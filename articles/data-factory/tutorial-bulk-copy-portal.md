...
* **Azure Synapse Analytics**。 此数据仓库包含从 SQL 数据库复制的数据。 如果没有 Azure Synapse Analytics 工作区，请参阅 [Azure Synapse Analytics 入门](..\synapse-analytics\get-started.md)一文了解创建步骤。
