...
:::image type="content" source="media/azure-ssis-integration-runtime-package-store/ssms-package-store-connect.png" alt-text="连接到 Azure-SSIS IR":::
...
:::image type="content" source="media/azure-ssis-integration-runtime-package-store/ssms-package-store-connect2.png" alt-text="连接到 Azure SQL 托管实例":::

## <a name="manage-folders-and-packages"></a>管理文件夹和包

连接到 SSMS 上的 Azure-SSIS IR 后，可以右键单击任何包存储、文件夹或包以弹出菜单，并选择“新文件夹”、“导入包”、“导出包”、“删除”或“刷新”    。

   :::image type="content" source="media/azure-ssis-integration-runtime-package-store/ssms-package-store-manage.png" alt-text="管理文件夹和包":::

   *  选择“新建文件夹”可为导入的包创建一个新文件夹。

   *  选择“导入包”可将包从“文件系统”、“SQL Server (MSDB)”或旧版“SSIS 包存储”导入到你的包存储中。

      :::image type="content" source="media/azure-ssis-integration-runtime-package-store/ssms-package-store-import.png" alt-text="导入包":::
   ...
   *  选择“导出包”可将包从你的包存储导出到“文件系统”、“SQL Server (MSDB)”或旧版“SSIS 包存储”中。
      ...
      :::image type="content" source="media/azure-ssis-integration-runtime-package-store/ssms-package-store-export.png" alt-text="导出包":::
...
:::image type="content" source="media/azure-ssis-integration-runtime-package-store/ssms-package-store-execute.png" alt-text="执行包实用工具页面 1 和 2":::

:::image type="content" source="media/azure-ssis-integration-runtime-package-store/ssms-package-store-execute2.png" alt-text="执行包实用工具页面 3 和 4":::
...
:::image type="content" source="media/azure-ssis-integration-runtime-package-store/ssms-package-store-execute3.png" alt-text="“执行包实用工具”按钮":::

:::image type="content" source="media/azure-ssis-integration-runtime-package-store/ssis-activity-package-store.png" alt-text="执行 SSIS 包活动":::
...
连接到 SSMS 上的 Azure-SSIS IR 后，可以展开“正在运行的包”节点，以查看当前正在运行的包。  右键单击其中任何一个包以弹出菜单，然后选择“停止”或“刷新”。
   ...
   :::image type="content" source="media/azure-ssis-integration-runtime-package-store/ssms-package-store-monitor.png" alt-text="监视和停止正在运行的包":::
...
连接到 SSMS 上的 Azure-SSIS IR 后，可以右键单击它以弹出菜单，并选择“转到 Azure 数据工厂门户”或“刷新” 。
   ...
   :::image type="content" source="media/azure-ssis-integration-runtime-package-store/ssms-package-store-monitor2.png" alt-text="转到 ADF 门户":::
   ...
   *  选择“转到 Azure 数据工厂门户”以打开 ADF 监视中心的“集成运行时”页面，你可以在其中监视 Azure-SSIS IR。 在“包存储”磁贴上，可以看到附加到 Azure-SSIS IR 的包存储的数量。  选择该数字会弹出一个窗口，你可在其中编辑存储着包存储访问信息的 ADF 链接服务。
      ...
      :::image type="content" source="media/azure-ssis-integration-runtime-package-store/ssms-package-store-monitor3.png" alt-text="编辑包存储":::
...
:::image type="content" source="media/azure-ssis-integration-runtime-package-store/sql-server-msdb-to-sql-mi-msdb.png" alt-text="生成 dtutil 命令行":::
