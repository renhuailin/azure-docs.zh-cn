...
description: 了解如何通过在 Azure 数据工厂或 Synapse Analytics 管道中使用复制活动，从/向 Microsoft Access 复制数据。
...
ms.locfileid: "124743993"
---
# <a name="copy-data-from-and-to-microsoft-access-using-azure-data-factory-or-synapse-analytics"></a>使用 Azure 数据工厂或 Synapse Analytics 从/向 Microsoft Access 数据存储复制数据
[!INCLUDE[appliesto-adf-asa-md](includes/appliesto-adf-asa-md.md)]

本文概述如何使用 Azure 数据工厂和 Synapse Analytics 管道中的复制活动从 Microsoft Access 数据存储复制数据。 它是基于概述复制活动总体的[复制活动概述](copy-activity-overview.md)一文。
...
>[!NOTE]
>Microsoft Access 2016 版 ODBC 驱动程序不适用于此连接器。 改为使用 Microsoft Access 2013 或 2010 版的 ODBC 驱动程序。

## <a name="getting-started"></a>入门

[!INCLUDE [data-factory-v2-connector-get-started](includes/data-factory-v2-connector-get-started.md)]

## <a name="create-a-linked-service-to-microsoft-access-using-ui"></a>使用 UI 创建到 Microsoft Access 的链接服务

使用以下步骤在 Azure 门户 UI 中创建一个到 Microsoft Access 的链接服务。
...
2. 搜索 Access，然后选择 Microsoft Access 连接器。

   :::image type="content" source="media/connector-microsoft-access/microsoft-access-connector.png" alt-text="选择 Microsoft Access 连接器。":::    


1. 配置服务详细信息、测试连接并创建新的链接服务。

   :::image type="content" source="media/connector-microsoft-access/configure-microsoft-access-linked-service.png" alt-text="配置到 Microsoft Access 的链接服务。":::
