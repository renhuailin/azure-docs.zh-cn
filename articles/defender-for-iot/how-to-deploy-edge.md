...
1. 选择 IoT 中心的 Azure 订阅，然后选择“IoT 中心” 。<br>选择“部署到设备”以面向单个设备，或选择“大规模部署”以面向多个设备，然后单击“创建”  。 有关大规模部署的详细信息，请参阅[如何部署](../iot-edge/how-to-deploy-at-scale.md)。
