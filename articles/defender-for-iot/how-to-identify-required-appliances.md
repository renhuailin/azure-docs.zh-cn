...
本文还提供了本地管理控制台设备的规范。 本地管理控制台不作为预配置设备提供。
...
| 监视端口 | 多达 15 个 RJ45 或 8 个 OPT | 多达 8 个 RJ45 或 6 个 OPT | 4 个 RJ45 | 多达 5 个 |
...
|--|--|
| 建筑 | 铝质，无风扇和防灰尘设计 |
| 尺寸（高 x 宽 x 深） | 200.5mm (7.9”) 高 x 232mm (9.14”) 宽 x 100mm (3.9”) 深 |
| 重量 | 4.91 KG (10.83 lbs.) |
| CPU | Intel Core i7-8650U (1.9GHz/4-core/15W) |
| 芯片组 | Intel® Q170 平台控制器中心 |
| 内存 | 8GB DDR4 2133MHz 宽温 SODIMM |
| 存储 | 128GB 3ME3 宽温 mSATA SSD |
...
| 工作温度 | 0C 到 +70C  |
| 湿度 | 10%~90%，非冷凝 |
| 振动 | 0.3 grms 10Hz 至 300Hz，每轴 15 分钟 - 德标导轨   |
| 撞击 | 10G 10ms，半正弦，每轴三次。 （正脉冲和负脉冲）- 德标导轨 |
