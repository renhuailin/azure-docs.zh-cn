...
ms.locfileid: "104778944"
---
# <a name="connect-your-data-from-defender-for-iot-to-azure-sentinel"></a>将数据从 Defender for IoT 连接到 Azure Sentinel 
...
- 了解如何使用 Azure Sentinel [洞察数据和潜在威胁](../sentinel/quickstart-get-visibility.md)。
