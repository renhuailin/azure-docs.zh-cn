...
有关接收头文件和其他资源的信息，请联系 <support@cyberx-labs.com>。
...
| 参数标签 | 说明 |
|-----------------|--------|
| allow lists | 用户可以为协议值编制索引，并在数据挖掘报表中显示它们。 这些报表反映网络基线。 :::image type="content" source="media/references-horizon-sdk/data-mining.png" alt-text="数据挖掘视图的示例。"::: <br /> 有关详细信息，请参阅“[连接到索引服务（基线）](#connect-to-an-indexing-service-baseline)”。 |
...
| 警告 | 数据包与结构和规范匹配，但基于插件警告配置检测到了意外行为。 |
