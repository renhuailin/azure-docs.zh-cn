...
> [!NOTE]
> “标准 SKU 公共 IP 地址”和“公共 IP 地址前缀”资源类型也具有“无区域”选项。  这样，客户可使用标准 SKU 公共 IP（并将其关联到仅允许标准 SKU 的资源），但它不保证实现冗余。  （从基本 SKU [升级](../virtual-network/public-ip-upgrade-portal.md)到标准 SKU 的所有公共 IP 地址都属于“无区域”类型。）
