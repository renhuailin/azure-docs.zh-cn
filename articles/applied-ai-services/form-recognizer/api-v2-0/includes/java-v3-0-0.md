---
title: 参考：适用于 Java 的表单识别器 3.1.1 客户端库
description: 使用适用于 Java 的表单识别器客户端库创建一个表单处理应用，Docs Authoring Pack for VS Code 中的 Docs Markdown 扩展会从自定义文档中提取键值对和表数据。
