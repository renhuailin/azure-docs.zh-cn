...
|<font size=5>EY</font>| [EY](https://ey.com/) 组织致力于创造更好的工作环境，帮助为客户、人们和社会创造长期价值，并在资本市场建立信任。 在数据和技术的支持下，分布在 150 多个国家/地区的各个 EY 团队提供保险来获取信任，帮助客户成长、转型和运营。 EY 团队涉足于保险、咨询、法律、战略、税务和交易，提出更睿智的问题，为当今世界所面临的复杂问题寻求新的答案。 EY 技术团队与 Microsoft 协作，构建了一个平台来加快发票提取和合同比较流程。 通过使用 Azure 表单识别器（表单识别器）和 Azure 自定义视觉 API（视觉），EY 团队已经能够为其咨询、税务、审计和交易服务客户自动执行光学字符识别 (OCR) 和文档处理流程，并对这些流程进行改进。 | [客户案例](https://customers.microsoft.com/en-us/story/1404985164224935715-ey-professional-services-azure-form-recognizer)|
