...
有关 ADO.NET 中事务的详细信息，请参阅 [ADO.NET 中的本地事务](/dotnet/framework/data/adonet/local-transactions)。
...
有关表值参数的详细信息，请参阅[表值参数](/sql/relational-databases/tables/use-table-valued-parameters-database-engine)。
...
在某些情况下，批量复制的效果好于表值参数。 请参阅文章[表值参数](/sql/relational-databases/tables/use-table-valued-parameters-database-engine)中“表值参数与 BULK INSERT 操作的对比表”。
...
[Entity Framework Core](/ef/efcore-and-ef6/#saving-data) 支持批处理。
