...
对于使用许多资源的大容量应用场景，可以使用 [Azure Monitor 日志](./saas-dbpertenant-log-analytics.md)。 这是一项单独的 Azure 服务，可对 Log Analytics 工作区中收集的已发出日志进行分析。 Azure Monitor 日志可收集多个服务的遥测，并可用于查询和设置警报。
...
* [Azure Monitor 日志](./saas-dbpertenant-log-analytics.md) - Azure Monitor 日志的设置和使用教程