...
智能见解性能日志可与 [Azure Monitor 日志]( https://docs.microsoft.com/azure/log-analytics/log-analytics-azure-sql)或第三方解决方案结合使用，用于自定义 DevOps 警报和报告功能。
...
- 了解如何[使用 Azure SQL Analytics 监视性能问题](../../azure-monitor/insights/azure-sql.md)。
