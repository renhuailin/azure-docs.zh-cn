...
在对每个区域中可用的网关进行任何更改之前，将通过服务运行状况通知提前通知客户。 客户可以 [使用 Azure 门户来设置活动日志警报](../../service-health/alerts-activity-log-service-notifications-portal.md)。
