...
- [2. 专场目标，0:03:11](#anchor-image-wtip-min00311)
...
- [10. 池对于不可预测的工作负载来说是经济高效的，0:19:36](#anchor-image-wtip-min01936)
...
- [23. 预配租户和加入，0:57:44](#anchor-image-wtip-min05744)
- [24. 预配租户和应用程序连接，0:58:58](#anchor-image-wtip-min05858)
- [25. 预配单个租户的管理脚本演示，0:59:43](#anchor-image-wtip-min05943)
- [26. 用于预配和编录的 PowerShell，1:00:02](#anchor-image-wtip-min10002)
...
- [35. 将租户数据提取到 Azure Synapse Analytics 中，1:16:32](#anchor-image-wtip-min11632)
- [36. 日销售分配图，1:16:48](#anchor-image-wtip-min11648)
- [37. 总结和行动号召，1:19:52](#anchor-image-wtip-min11952)
- [38. 提供详细信息的资源，1:20:42](#anchor-image-wtip-min12042)
...
#### <a name="10-pools-are-cost-effective-for-unpredictable-workloads-01749"></a>10. 池对于不可预测的工作负载来说是经济高效的，0:17:49
...
#### <a name="23-provisioning-tenants-and-onboarding-05619"></a>23. 预配租户和加入，0:56:19
...
#### <a name="26-powershell-to-provision-and-catalog-05956"></a>26. 用于预配和编录的 PowerShell，0:59:56
...
#### <a name="35-extract-tenant-data-into-azure-synapse-analytics-11546"></a>35. 将租户数据提取到 Azure Synapse Analytics 中，1:15:46
[![将租户数据提取到 Azure Synapse Analytics 中][image-wtip-min11632-extract-tenant-data-sql-dw]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=4546)
...
#### <a name="38-resources-for-more-information-12035"></a>38. 提供详细信息的资源，1:20:35
...
[image-wtip-min11632-extract-tenant-data-sql-dw]: media/saas-tenancy-video-index-wingtip-brk3120-20171011/wingtip-20171011-min11632-extract-tenant-data-analytics-db-dw.png "将租户数据提取到 Azure Synapse Analytics 中"
