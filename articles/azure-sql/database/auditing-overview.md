...
- **Azure SYNAPSE SQL 池** 的审核 **仅** 支持默认的审核操作组。
...
- [管理服务器的审核策略](/cli/azure/sql/server/audit-policy?view=azure-cli-latest)
- [管理数据库的审核策略](/cli/azure/sql/db/audit-policy?view=azure-cli-latest)
