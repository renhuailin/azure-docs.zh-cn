...
ms.locfileid: "123318289"
---
# <a name="azure-resource-graph-sample-queries-for-azure-sql-database"></a>针对 Azure SQL 数据库的 Azure Resource Graph 示例查询

此页面是针对 Azure SQL 数据库的 [Azure Resource Graph](../../governance/resource-graph/overview.md) 示例查询的集合。 有关 Azure Resource Graph 示例的完整列表，请参阅 [Resource Graph 示例（按类别）](../../governance/resource-graph/samples/samples-by-category.md)和 [Resource Graph 示例（按表）](../../governance/resource-graph/samples/samples-by-table.md)。
