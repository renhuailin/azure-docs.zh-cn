...
有关存储和性能的详细信息，请参阅 [Azure 虚拟机上 SQL Server 的存储配置准则](/archive/blogs/sqlserverstorageengine/storage-configuration-guidelines-for-sql-server-on-azure-vm)
