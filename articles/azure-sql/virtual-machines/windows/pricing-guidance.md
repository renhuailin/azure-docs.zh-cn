...
> [!TIP]
> 如果只需了解由 SQL Server 版本和虚拟机 (VM) 大小组成的特定组合的成本估算，请参阅适用于 [Windows](https://azure.microsoft.com/pricing/details/virtual-machines/windows) 或 [Linux](https://azure.microsoft.com/pricing/details/virtual-machines/linux) 的定价页。 从“OS/软件”列表中选择平台和 SQL Server 版本。
>
