...
| **Batch JavaScript** |[用于 JavaScript 的 Azure SDK - Docs](/javascript/api/overview/azure/batch/client) |[npm](https://www.npmjs.com/package/@azure/batch) |[教程](batch-js-get-started.md) |- | [自述文件](https://github.com/Azure/azure-sdk-for-js/tree/main/sdk/batch/batch) |
