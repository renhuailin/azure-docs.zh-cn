---
title: PowerShell 脚本：向 Azure Data Share 添加 blob 数据集
description: 该 PowerShell 脚本可以将 blob 数据集添加到现有共享。
services: data-share
author: joannapea
ms.author: joanpo
...
| 命令 | 说明 |
|---|---|
| [New-AzDataShareDataSet](/powershell/module/az.datashare/new-azdatasharedataset) | 将数据集添加到数据共享。 |
|||
