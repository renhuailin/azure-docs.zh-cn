...
4. 在“基本”选项卡上，输入下列信息： 
    ...
    高可用性| 默认 | 对于生产服务器，强烈建议使用区域冗余高可用性 (HA) 来实现业务连续性，并防范区域故障|
    ...
    计算 + 存储 | “可突发”、“Standard_B1ms”、“10 GiB”、“100 IOPS”和“7 天”     | 新服务器的计算、存储、IOPS 和备份配置。 选择“配置服务器”。 “可突发”、“Standard_B1ms”、“10 GiB”、“100 IOPS”和“7 天”分别是“计算层”、“计算大小”、“存储大小”、“IOPS”和“备份保持期”的默认值          。 可按原样保留这些值，也可对其进行调整。 为了在迁移过程中更快地加载数据，建议将 IOPS 增加到计算大小所支持的最大大小，然后再将其调整回原来的大家，以节省成本。 若要保存此计算和存储选择，请选择“保存”继续进行配置。 下面的屏幕截图显示了计算和存储选项。|
