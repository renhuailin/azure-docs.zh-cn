...
description: 了解有关高级威胁防护的概念，高级威胁防护可检测异常的数据库活动，这些活动意味着可能存在对数据库的安全威胁。
author: savjani
ms.author: pariks
ms.service: mysql
ms.topic: conceptual
...
高级威胁防护包含在高级数据安全产品/服务中，是一个针对高级安全功能的统一软件包。 可通过 [Azure 门户](https://portal.azure.com)或使用 [REST API](/rest/api/mysql) 来访问和管理高级威胁防护。 此功能可用于常规用途和内存优化服务器。
