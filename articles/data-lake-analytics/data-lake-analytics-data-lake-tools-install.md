...
了解如何使用 Visual Studio 创建 Azure Data Lake Analytics 帐户。 可以使用 [U-SQL](data-lake-analytics-u-sql-get-started.md) 定义作业，并将作业提交到 Data Lake Analytics 服务。 有关 Data Lake Analytics 的详细信息，请参阅 [Azure Data Lake Analytics 概述](data-lake-analytics-overview.md)。
...
## <a name="install-azure-data-lake-tools-for-visual-studio-2017-or-visual-studio-2019"></a>安装针对 Visual Studio 2017 或 Visual Studio 2019 的 Azure Data Lake 工具

Visual Studio 2017 15.3 或更高版本支持针对 Visual Studio 的 Azure Data Lake 工具。 数据存储和处理以及 Azure 开发工作负载包含此工具 。 在 Visual Studio 安装过程中，启用这两个工作负载中的任何一个。
...
![选择“Azure 开发”工作负载](./media/data-lake-analytics-data-lake-tools-get-started/data-lake-tools-for-vs-2019-install-02.png)
