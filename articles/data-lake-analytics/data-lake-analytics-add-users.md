...
description: 了解如何使用添加用户向导和 Azure PowerShell 将用户正确添加到 Data Lake Analytics 帐户。
...
5. 在“选择目录权限”步骤中，选择用户需要访问的任何其他数据库。 若要提交作业，需要对被称为“master”的默认静态数据库具有读取和写入权限。 完成后，请单击“确定”  。
