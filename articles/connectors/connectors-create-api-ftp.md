...
* 如果你有本地 FTP 服务器，请考虑创建[集成服务环境 (ISE)](../logic-apps/connect-virtual-network-vnet-isolated-environment-overview.md) 或使用 [Azure 应用服务混合连接](../app-service/app-service-hybrid-connections.md)，这能让你在不使用本地数据网关的情况下访问本地数据源。
