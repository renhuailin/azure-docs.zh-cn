...
![图中显示了源硬件、源网络硬件以及到 Data Lake Storage Gen1 的网络连接可能会成为瓶颈。](./media/data-lake-store-performance-tuning-guidance/bottleneck.png)
...
在解决了源硬件和网络连接方面的瓶颈后，即可开始配置引入工具。 下表概述了几种常用引入工具的关键设置，并提供了关于这些工具的详尽性能优化文章。 若要深入了解方案应使用何种工具，请参阅这篇[文章](./data-lake-store-data-scenarios.md)。
...
![图中显示使用了更多的 YARN 容器。](./media/data-lake-store-performance-tuning-guidance/VM.png)
...
![图中显示使用了较小的 YARN 容器。](./media/data-lake-store-performance-tuning-guidance/small-containers.png)
...
![图中显示了使用所有可用容器。](./media/data-lake-store-performance-tuning-guidance/use-containers.png)
