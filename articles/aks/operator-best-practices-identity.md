...
> * 使用 Kubernetes 的基于角色的访问控制 (Kubernetes RBAC) 控制对资源的访问
...
使用 AKS 中与 Azure AD 集成的群集，创建角色或群集角色用于定义对资源的访问权限。  然后，从 Azure AD 将角色绑定到用户或组。 下一节将讨论这些 Kubernetes 基于角色的访问控制 (Kubernetes RBAC) 。 下图显示了 Azure AD 集成，以及如何控制对资源的访问：
...
1. Kubernetes 基于角色的访问控制 (Kubernetes RBAC) 和群集策略已应用。
...
若要了解如何使用 Azure AD 组来控制使用 Kubernetes RBAC 对 Kubernetes 资源的访问权限，请参阅 [使用 AKS 中的基于角色的访问控制和 Azure Active Directory 标识控制对群集资源的访问][azure-ad-rbac]。
