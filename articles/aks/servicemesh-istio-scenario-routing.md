...
![此图显示了通过 Istio 入口网关为入站请求提供服务的所有组件的 1.0 版本。](media/servicemesh/istio/scenario-routing-components-01.png)
...
![此图显示只有 1.1 版投票分析组件有从投票应用组件路由的流量。](media/servicemesh/istio/scenario-routing-components-02.png)
...
![此图演示了本部分结束时将要运行的内容。](media/servicemesh/istio/scenario-routing-components-03.png)
...
![此图显示无论是否设置了功能标志，用户都会看到应用程序的 2.0 版本。](media/servicemesh/istio/scenario-routing-components-04.png)
