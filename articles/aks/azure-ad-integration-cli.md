...
> [!WARNING]
> **将于 2024 年 2 月 29 日弃用本文档中所述的功能 - Azure AD 集成（旧版）。
>
...
* 请确保在计算机上一次仅安装一个版本的 kubectl。 版本冲突可能导致授权过程中出现问题。 若要安装最新版本，请使用[az aks install-cli][az-aks-install-cli]。
