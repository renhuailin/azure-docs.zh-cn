---
title: 查找标识对象 Id 进行身份验证-Azure API for FHIR
description: 本文介绍如何查找为用于 FHIR 的 Azure API 配置身份验证所需的标识对象 Id
...
ms.locfileid: "103017606"
---
# <a name="find-identity-object-ids-for-authentication-configuration"></a>查找身份验证配置的标识对象 Id
