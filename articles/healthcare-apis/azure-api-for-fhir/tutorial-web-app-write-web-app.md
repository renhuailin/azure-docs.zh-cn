---
title: Web 应用教程 - 编写 Web 应用程序 - Azure API for FHIR
...
ms.locfileid: "121782238"
---
# <a name="write-azure-web-application-to-read-fhir-data-in-azure-api-for-fhir"></a>编写 Azure Web 应用程序以读取数据中的 FHIR Azure API for FHIR
