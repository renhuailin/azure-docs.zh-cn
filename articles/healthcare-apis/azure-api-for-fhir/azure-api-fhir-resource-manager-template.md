...
本快速入门中使用的模板来自 [Azure 快速启动模板](https://azure.microsoft.com/resources/templates/azure-api-for-fhir/)。
...
4. 输入新的服务名称，然后选择 Azure API for FHIR 所在的位置。 该位置可以与资源组所在的区域相同，也可以与资源组所在的区域不同。
   ...
   [![使用Azure API for FHIR中的 ARM 模板部署Azure 门户。 ](media/fhir-resource-manager-template/deploy-azure-api-fhir.png) ](media/fhir-resource-manager-template/deploy-azure-api-fhir.png#lightbox)
