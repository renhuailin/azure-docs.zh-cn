---
title: 使用 Azure DevOps Starter 将 ASP.NET Core 应用部署到 Azure Kubernetes 服务
description: 可以通过 Azure DevOps Starter 轻松地完成 Azure 入门。 使用 DevOps Starter，可通过几个快速步骤将 ASP.NET Core 应用部署到 Azure Kubernetes 服务 (AKS)。
ms.author: mlearned
ms.manager: gwallace
ms.prod: devops
