...
这些阻碍的原因在于“中国防火长城（中国国家防火墙）”，它会保护 Internet 上的中国网段部分，并筛选发往中国的流量。 从中华人民共和国发往外界（香港和澳门等特别行政区除外）的几乎所有流量都要流经防火长城。 流经香港和澳门的流量不会强力进入防火长城，而是由防火长城的一部分机制进行处理。

:::image type="content" source="./media/interconnect-china/provider.png" alt-text="该图显示了提供商的互连。":::
...
随着中国和香港特别行政区之间互连互通的最新变化，上述大多数网络提供商在中国和香港特别行政区之间建立了 MPLS 网桥。

你可以看到，中国国内的站点到站点 VPN 连接是被允许的，并且大多很稳定的。 这同样适用于世界上其他分支之间的站点到站点连接。 现在，提供商在两端创建 VPN/SDWAN 聚合，并通过 MPLS 在两者之间建立桥梁。

:::image type="content" source="./media/interconnect-china/china-mpls-bridge.png" alt-text="该关系图显示了中国 MPLS 网桥。":::
...
:::image type="content" source="./media/interconnect-china/multi-branch.png" alt-text="该关系图显示了多个分支。":::
...
:::image type="content" source="./media/interconnect-china/sample.png" alt-text="该关系图显示了示例 WAN。":::
...
:::image type="content" source="./media/interconnect-china/global.png" alt-text="该关系图显示了 Global Reach。":::

## <a name="secure-internet-breakout-for-microsoft-365"></a><a name="secure"></a>适用于 Microsoft 365 的安全 Internet 接入点
...
:::image type="content" source="./media/interconnect-china/internet.png" alt-text="该关系图显示了适用于 Web 和 Microsoft 服务流量的 Internet 接入点。":::
...
:::image type="content" source="./media/interconnect-china/china-traffic.png" alt-text="该关系图显示了中国到香港特别行政区的流量。":::
...
:::image type="content" source="./media/interconnect-china/expressroute.png" alt-text="该关系图显示了中国到香港特别行政区的流量 - ExpressRoute。":::
...
:::image type="content" source="./media/interconnect-china/expressroute-virtual.png" alt-text="该关系图显示 ExpressRoute Global Reach。":::
