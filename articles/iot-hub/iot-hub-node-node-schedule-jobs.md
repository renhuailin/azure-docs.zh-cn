...
* 直接方法：[IoT 中心开发人员指南 - 直接方法](iot-hub-devguide-direct-methods.md)和[快速入门：直接方法和教程：直接方法](./quickstart-control-device.md?pivots=programming-language-nodejs)
