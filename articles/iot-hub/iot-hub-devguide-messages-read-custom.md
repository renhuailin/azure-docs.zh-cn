...
IoT 中心具有默认的[内置终结点](iot-hub-devguide-messages-read-builtin.md)。 将你在订阅中拥有的其他服务链接到中心可创建自定义终结点来路由消息。 IoT 中心目前支持将 Azure 存储容器、事件中心、服务总线队列和服务总线主题用作自定义终结点。
...
> * 在 Azure 门户中，只能为与中心位于同一订阅中的 Azure 资源创建自定义路由终结点。 可以向你所拥有的其他订阅中的资源创建自定义终结点，但必须使用与 Azure 门户不同的方法来配置自定义终结点。
