---
title: 快速入门 - 有关向 Azure IoT 中心发送遥测数据的快速入门 (Android) | Microsoft Docs
...
在本部分，将使用具有 [IoT 扩展](/cli/azure/ext/azure-iot/iot?view=azure-cli-latest&preserve-view=true)的 Azure Cloud Shell 监视 Android 设备发送的设备消息。
