...
* 要将公司从一个区域迁移到另一个区域（例如，从欧洲到北美，或反之），并希望自己的资源和数据在地理上靠近新位置，需要迁移中心。
...
1. 使用此页面上的 IoT C# 示例：[适用于 C# 的 Azure IoT 示例](https://azure.microsoft.com/resources/samples/azure-iot-samples-csharp/)。 下载 zip 文件并将其解压缩到计算机。 
