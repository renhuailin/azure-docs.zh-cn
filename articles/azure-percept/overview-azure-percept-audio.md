...
使用 Azure Percept 语音助手模板在[Azure Percept Studio](https://go.microsoft.com/fwlink/?linkid=2135819)中生成[无代码语音解决方案](./tutorial-no-code-speech.md)，用于宾馆、医疗保健、库存和汽车方案。
