...
ms.locfileid: "128709095"
---
# <a name="geo-code-mapping"></a>地理代码映射

此示例 XML 提供有关与相应区域映射的地理代码的见解。 使用这些地理代码为恢复服务保管库的专用端点创建和添加自定义 DNS 区域。

## <a name="mapping-details"></a>映射详细信息
...
[了解如何](/azure/backup/private-endpoints)使用地理代码为 Azure 备份专用终结点创建和添加 DNS 区域。