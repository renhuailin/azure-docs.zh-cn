...
用户需要通过 RBAC 向保管库（保管库 MSI 表示）、相关磁盘和/或磁盘 RG 分配少量权限。 可以通过门户或 PowerShell 执行上述操作。 [本部分](backup-managed-disks.md#configure-backup)第 1、2、3 点详细介绍了所有相关权限。
