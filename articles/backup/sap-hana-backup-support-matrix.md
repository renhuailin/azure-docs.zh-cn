...
| **OS 版本**            | 带 SP2、SP3、SP4 和 SP5 的 SLES 12；带 SP0、SP1 和 SP2 的 SLES 15 <br><br>  RHEL 7.4、7.6、7.7、8.1 和 8.2                |                                             |
| **HANA 版本**          | SDC on HANA 1.x、MDC on HANA 2.x SPS04、SPS05 Rev <= 53（对启用了加密的方案也进行了验证）      |                                                            |
