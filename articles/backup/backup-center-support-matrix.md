...
| 操作 | 配置备份 | <li> Azure 虚拟机 <br><br> <li> Azure Database for PostgreSQL 服务器 <br><br> <li> Azure VM 中的 SQL <br><br> <li> Azure VM 中的 SAP HANA <br><br> <li> Azure 文件<br/><br/> <li>Azure Blob<br/><br/> <li>Azure 托管磁盘 | 请参阅 [Azure VM 备份](./backup-support-matrix-iaas.md)和 [Azure Database for PostgreSQL 服务器备份](backup-azure-database-postgresql-overview.md#support-matrix)的支持矩阵 |
| 操作 | 还原备份实例 | <li> Azure 虚拟机 <br><br> <li> Azure Database for PostgreSQL 服务器 <br><br> <li> Azure VM 中的 SQL <br><br> <li> Azure VM 中的 SAP HANA <br><br> <li> Azure 文件<br/><br/> <li>Azure Blob<br/><br/> <li>Azure 托管磁盘 | 请参阅 [Azure VM 备份](./backup-support-matrix-iaas.md)和 [Azure Database for PostgreSQL 服务器备份](backup-azure-database-postgresql-overview.md#support-matrix)的支持矩阵 |
...
| 操作 | 为备份实例执行按需备份 | <li> Azure 虚拟机 <br><br> <li> Azure Database for PostgreSQL 服务器 <br><br> <li> Azure VM 中的 SQL <br><br> <li> Azure VM 中的 SAP HANA <br><br> <li> Azure 文件<br/><br/> <li>Azure Blob<br/><br/> <li>Azure 托管磁盘 | 请参阅 [Azure VM 备份](./backup-support-matrix-iaas.md)和 [Azure Database for PostgreSQL 服务器备份](backup-azure-database-postgresql-overview.md#support-matrix)的支持矩阵 |
| 操作 | 停止为备份实例备份 | <li> Azure 虚拟机 <br><br> <li> Azure Database for PostgreSQL 服务器 <br><br> <li> Azure VM 中的 SQL <br><br> <li> Azure VM 中的 SAP HANA <br><br> <li> Azure 文件<br/><br/> <li>Azure Blob<br/><br/> <li>Azure 托管磁盘 | 请参阅 [Azure VM 备份](./backup-support-matrix-iaas.md)和 [Azure Database for PostgreSQL 服务器备份](backup-azure-database-postgresql-overview.md#support-matrix)的支持矩阵 |
