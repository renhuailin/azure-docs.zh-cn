...
| **类别** | **方案**  | **支持的工作负荷**  | **限制** |
| -------------| ------------- | ----------------------- |------------|
| 监视   | 查看所有作业 | <li> Azure 虚拟机 <br><br> <li> Azure Database for PostgreSQL 服务器 <br><br> <li> Azure VM 中的 SQL <br><br> <li> Azure VM 中的 SAP HANA <br><br> <li> Azure 文件<br/><br/> <li>Azure Blob<br/><br/> <li>Azure 托管磁盘 | <li> 提供7天的可用作业。 <br> <li> 每个筛选器/下拉最多支持1000项。 因此，可以使用备份中心跨租户监视最多1000个订阅和1000个保管库。 |
...
| 操作 | 执行备份实例的按需备份 | <li> Azure 虚拟机 <br><br> <li> Azure Database for PostgreSQL 服务器 <br><br> <li> Azure VM 中的 SQL <br><br> <li> Azure VM 中的 SAP HANA <br><br> <li> Azure 文件<br/><br/> <li>Azure Blob<br/><br/> <li>Azure 托管磁盘 | 请参阅[AZURE VM 备份](./backup-support-matrix-iaas.md)和[Azure Database for PostgreSQL 服务器备份](backup-azure-database-postgresql.md#support-matrix)的支持矩阵 |
| 操作 | 停止备份实例备份 | <li> Azure 虚拟机 <br><br> <li> Azure Database for PostgreSQL 服务器 <br><br> <li> Azure VM 中的 SQL <br><br> <li> Azure VM 中的 SAP HANA <br><br> <li> Azure 文件<br/><br/> <li>Azure Blob<br/><br/> <li>Azure 托管磁盘 | 请参阅[AZURE VM 备份](./backup-support-matrix-iaas.md)和[Azure Database for PostgreSQL 服务器备份](backup-azure-database-postgresql.md#support-matrix)的支持矩阵 |
