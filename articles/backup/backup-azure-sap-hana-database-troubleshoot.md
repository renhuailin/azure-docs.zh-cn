...
| **错误消息**      | <span style="font-weight:normal">当 Backint 配置更新不正确时，备份将失败并出现此错误。</span>                       |
| ------------------ | ------------------------------------------------------------ |
...
|**错误消息**  | <span style="font-weight:normal">还原的源系统和目标系统不兼容。</span>  |
|---------|---------|
...
**错误消息** | <span style="font-weight:normal">为备份配置的数据库不存在。</span>
--------- | --------------------------------
...
**错误消息** | <span style="font-weight:normal">Azure 备份没有足够的特权执行备份和还原操作。</span>
---------- | ---------
