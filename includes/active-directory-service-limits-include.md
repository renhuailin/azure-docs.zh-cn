...
| 应用程序 | <ul><li>最多有 100 位用户可以是单一应用程序的所有者。</li><li>基于密码的 SSO 应用仅限 48 位用户使用，这意味着每个应用的用户名/密码对仅限 48 个密钥。 若要添加额外的用户，请参阅[排查 Azure AD 中基于密码的单一登录](../articles/active-directory/manage-apps/troubleshoot-password-based-sso.md#i-cant-add-another-user-to-my-password-based-sso-app)中的疑难解答说明。</li></ul> |
