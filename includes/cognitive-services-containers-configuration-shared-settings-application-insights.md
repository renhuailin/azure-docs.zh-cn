...
|必须| 名称 | 数据类型 | 说明 |
|--|------|-----------|-------------|
|否| `InstrumentationKey` | 字符串 | 容器遥测数据要发送到的 Application Insights 实例的检测密钥。 有关详细信息，请参阅[适用于 ASP.NET Core 的 Application Insights](../articles/azure-monitor/app/asp-net-core.md)。 <br><br>示例：<br>`InstrumentationKey=123456789`|