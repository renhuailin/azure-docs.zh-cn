...
1. 下载和安装最新版本的 Azure 服务管理 (SM) PowerShell cmdlet。 大多数人在本地安装了资源管理器模块，但未安装服务管理模块。 服务管理模块是旧版的，必须单独安装。 有关详细信息，请参阅[安装服务管理 cmdlet](/powershell/azure/servicemanagement/install-azure-ps)。
