...
| 全球分布 | 具有一个高可用性的可选可读辅助读取区域的单一区域，支持自动和手动帐户故障转移。 | 从 1 个到 30 多个区域进行[统包式全局分发](../articles/cosmos-db/distribute-data-globally.md)。 支持在全球各地随时[自动和手动故障转移](../articles/cosmos-db/high-availability.md)。 |
