...
| `Port` | 整数 | Fluentd 服务器的端口。<br/> 默认值为 24224。 |
...
| `TlsConnectionEstablishmentTimeoutMs` | 整数 | 与 Fluentd 服务器建立 SSL/TLS 连接的超时值，以毫秒为单位。 默认值为 10000 毫秒（10 秒）。<br/> 如果 `UseTLS` 设置为 false，则会忽略此值。 |
