...
3. 将数据库、应用程序和站点集合从 SharePoint 2010 场移到新的 SharePoint 2013 场。 有关说明，请转到 [SharePoint 2013 升级过程概述](/SharePoint/upgrade-and-update/overview-of-the-upgrade-process)。
