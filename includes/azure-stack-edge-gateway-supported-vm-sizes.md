...
有关详细信息，请参阅 [针对 GPU 优化 VM 大小的 NCasT4_v3 系列](../articles/virtual-machines/nct4-v3-series.md)。
...
有关详细信息，请参阅 [Fsv2 系列的计算优化 VM 大小](../articles/virtual-machines/fsv2-series.md)。
