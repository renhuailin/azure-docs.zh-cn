...
|[服务总线高级命名空间应使用客户托管的密钥进行加密](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F295fc8b1-dc9f-4f53-9c61-3f313ceab40a) |Azure 服务总线支持对静态数据和 Microsoft 托管的密钥进行加密， (默认) 或客户管理的密钥。 如果选择使用客户管理的密钥加密数据，则可以分配、旋转、禁用和撤消对服务总线将用于加密命名空间中的数据的密钥的访问权限。 请注意，服务总线仅支持对高级命名空间的客户托管密钥进行加密。 |Audit、Disabled |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Service%20Bus/ServiceBus_CustomerManagedKeyEnabled_Audit.json) |
