...
ms.locfileid: "98045730"
---
|名称<br /><sub>（Azure 门户）</sub> |说明 |效果 |版本<br /><sub>(GitHub)</sub> |
|---|---|---|---|
|[Azure Batch 帐户应使用客户管理的密钥来加密数据](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F99e9ccd8-3db9-4592-b0d1-14b1715a4d8a) |使用客户管理的密钥 (Cmk) 管理 Batch 帐户数据的静态加密。 默认情况下，使用服务托管密钥对客户数据进行加密，但 Cmk 通常需要满足法规遵从性标准。 Cmk 允许使用由你创建并拥有的 Azure Key Vault 密钥对数据进行加密。 你可以完全控制并负责关键生命周期，包括轮换和管理。 在上了解有关 CMK 加密的详细信息 [https://aka.ms/Batch-CMK](https://aka.ms/Batch-CMK) 。 |Audit、Deny、Disabled |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Azure%20Batch/Batch_CustomerManagedKey_Audit.json) |
