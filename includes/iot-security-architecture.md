...
体系结构图中的所有元素都受限于各种威胁；这对这些威胁，本文介绍 STRIDE 助记键。 请阅读 [Threat Modeling Again, STRIDE](/archive/blogs/larryosterman/threat-modeling-again-stride)（再次威胁建模 STRIDE）以详细了解 STRIDE 元素。
