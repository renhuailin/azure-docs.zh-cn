...
ms.locfileid: "114732100"
---
 本快速入门使用两个 Python 应用程序：一个是模拟设备应用程序，用于响应从后端应用程序调用的直接方法；另一个是后端应用程序，用于在模拟设备上调用直接方法。
...
如果已完成上一[快速入门：将遥测数据从设备发送到 IoT 中心](../articles/iot-develop/quickstart-send-telemetry-iot-hub.md?pivots=programming-language-python)，则可以跳过此步骤。
